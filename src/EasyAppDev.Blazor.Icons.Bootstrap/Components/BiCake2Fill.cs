...
{
    /// <summary>
    /// BiCake2Fill icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class BiCake2Fill : ComponentBase
    {
        /// <summary>
