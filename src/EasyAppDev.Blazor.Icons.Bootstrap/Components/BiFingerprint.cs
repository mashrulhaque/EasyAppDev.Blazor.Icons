...
{
    /// <summary>
    /// BiFingerprint icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class BiFingerprint : ComponentBase
    {
        /// <summary>
