...
{
    /// <summary>
    /// BiTextIndentRight icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class BiTextIndentRight : ComponentBase
    {
        /// <summary>
