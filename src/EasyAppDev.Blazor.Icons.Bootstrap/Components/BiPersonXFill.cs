...
{
    /// <summary>
    /// BiPersonXFill icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class BiPersonXFill : ComponentBase
    {
        /// <summary>
