...
{
    /// <summary>
    /// BiNoiseReduction icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class BiNoiseReduction : ComponentBase
    {
        /// <summary>
