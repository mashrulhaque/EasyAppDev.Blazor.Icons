...
{
    /// <summary>
    /// BiBrightnessAltLow icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class BiBrightnessAltLow : ComponentBase
    {
        /// <summary>
