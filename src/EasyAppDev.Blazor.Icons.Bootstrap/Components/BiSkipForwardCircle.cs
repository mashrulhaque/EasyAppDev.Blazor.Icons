...
{
    /// <summary>
    /// BiSkipForwardCircle icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class BiSkipForwardCircle : ComponentBase
    {
        /// <summary>
