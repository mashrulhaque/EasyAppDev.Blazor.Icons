...
{
    /// <summary>
    /// BiFiletypeJs icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class BiFiletypeJs : ComponentBase
    {
        /// <summary>
