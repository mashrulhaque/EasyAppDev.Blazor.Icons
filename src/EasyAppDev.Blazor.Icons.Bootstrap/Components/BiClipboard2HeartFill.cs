...
{
    /// <summary>
    /// BiClipboard2HeartFill icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class BiClipboard2HeartFill : ComponentBase
    {
        /// <summary>
