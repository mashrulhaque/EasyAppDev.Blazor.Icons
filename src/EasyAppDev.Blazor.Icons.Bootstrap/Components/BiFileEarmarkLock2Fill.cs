...
{
    /// <summary>
    /// BiFileEarmarkLock2Fill icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class BiFileEarmarkLock2Fill : ComponentBase
    {
        /// <summary>
