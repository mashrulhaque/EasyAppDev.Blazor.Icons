...
{
    /// <summary>
    /// BiCalendar2Check icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class BiCalendar2Check : ComponentBase
    {
        /// <summary>
