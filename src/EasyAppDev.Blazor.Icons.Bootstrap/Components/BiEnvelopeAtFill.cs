...
{
    /// <summary>
    /// BiEnvelopeAtFill icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class BiEnvelopeAtFill : ComponentBase
    {
        /// <summary>
