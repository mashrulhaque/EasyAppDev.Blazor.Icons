...
{
    /// <summary>
    /// BiClipboard2Heart icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class BiClipboard2Heart : ComponentBase
    {
        /// <summary>
