...
{
    /// <summary>
    /// BiDiagram2 icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class BiDiagram2 : ComponentBase
    {
        /// <summary>
