...
{
    /// <summary>
    /// BiSortUpAlt icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class BiSortUpAlt : ComponentBase
    {
        /// <summary>
