...
{
    /// <summary>
    /// BiClipboardCheck icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class BiClipboardCheck : ComponentBase
    {
        /// <summary>
