...
{
    /// <summary>
    /// BiCloudDownload icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class BiCloudDownload : ComponentBase
    {
        /// <summary>
