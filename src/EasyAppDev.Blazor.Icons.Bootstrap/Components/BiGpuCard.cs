...
{
    /// <summary>
    /// BiGpuCard icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class BiGpuCard : ComponentBase
    {
        /// <summary>
