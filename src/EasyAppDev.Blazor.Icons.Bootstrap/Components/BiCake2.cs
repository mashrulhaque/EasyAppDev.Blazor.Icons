...
{
    /// <summary>
    /// BiCake2 icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class BiCake2 : ComponentBase
    {
        /// <summary>
