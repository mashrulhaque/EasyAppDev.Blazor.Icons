...
{
    /// <summary>
    /// BiBorderAll icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class BiBorderAll : ComponentBase
    {
        /// <summary>
        ...
        protected override void BuildRenderTree(RenderTreeBuilder builder)
        {
            ...
            // Inline SVG content
            builder.AddMarkupContent(13, @"<path d=""M0 0h16v16H0zm1 1v6.5h6.5V1zm7.5 0v6.5H15V1zM15 8.5H8.5V15H15zM7.5 15V8.5H1V15z""/>");
