...
{
    /// <summary>
    /// BiSafe2Fill icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class BiSafe2Fill : ComponentBase
    {
        /// <summary>
