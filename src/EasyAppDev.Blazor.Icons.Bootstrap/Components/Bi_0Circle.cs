...
{
    /// <summary>
    /// Bi_0Circle icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class Bi_0Circle : ComponentBase
    {
        /// <summary>
