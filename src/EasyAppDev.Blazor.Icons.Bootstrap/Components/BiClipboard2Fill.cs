...
{
    /// <summary>
    /// BiClipboard2Fill icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class BiClipboard2Fill : ComponentBase
    {
        /// <summary>
