...
{
    /// <summary>
    /// BiFiletypeSql icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class BiFiletypeSql : ComponentBase
    {
        /// <summary>
