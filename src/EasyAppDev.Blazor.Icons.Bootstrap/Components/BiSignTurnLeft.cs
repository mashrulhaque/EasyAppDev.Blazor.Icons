...
{
    /// <summary>
    /// BiSignTurnLeft icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class BiSignTurnLeft : ComponentBase
    {
        /// <summary>
