...
{
    /// <summary>
    /// Bi_9Square icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class Bi_9Square : ComponentBase
    {
        /// <summary>
