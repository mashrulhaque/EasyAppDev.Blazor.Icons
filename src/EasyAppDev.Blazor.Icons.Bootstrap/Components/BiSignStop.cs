...
{
    /// <summary>
    /// BiSignStop icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class BiSignStop : ComponentBase
    {
        /// <summary>
