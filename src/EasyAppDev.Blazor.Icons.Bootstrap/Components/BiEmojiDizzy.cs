...
{
    /// <summary>
    /// BiEmojiDizzy icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class BiEmojiDizzy : ComponentBase
    {
        /// <summary>
