...
{
    /// <summary>
    /// BiMouse3 icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class BiMouse3 : ComponentBase
    {
        /// <summary>
