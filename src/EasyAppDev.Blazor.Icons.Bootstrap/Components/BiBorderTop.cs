...
{
    /// <summary>
    /// BiBorderTop icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class BiBorderTop : ComponentBase
    {
        /// <summary>
