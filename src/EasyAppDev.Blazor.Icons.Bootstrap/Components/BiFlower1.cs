...
{
    /// <summary>
    /// BiFlower1 icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class BiFlower1 : ComponentBase
    {
        /// <summary>
