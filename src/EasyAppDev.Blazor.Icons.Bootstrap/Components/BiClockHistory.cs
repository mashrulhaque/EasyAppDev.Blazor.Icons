...
{
    /// <summary>
    /// BiClockHistory icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class BiClockHistory : ComponentBase
    {
        /// <summary>
