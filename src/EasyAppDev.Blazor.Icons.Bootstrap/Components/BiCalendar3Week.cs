...
{
    /// <summary>
    /// BiCalendar3Week icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class BiCalendar3Week : ComponentBase
    {
        /// <summary>
