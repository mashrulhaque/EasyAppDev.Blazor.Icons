...
{
    /// <summary>
    /// BiFiletypeSh icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class BiFiletypeSh : ComponentBase
    {
        /// <summary>
