...
{
    /// <summary>
    /// BiArrowDownUp icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class BiArrowDownUp : ComponentBase
    {
        /// <summary>
