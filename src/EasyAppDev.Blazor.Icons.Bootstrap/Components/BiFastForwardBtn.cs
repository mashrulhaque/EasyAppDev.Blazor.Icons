...
{
    /// <summary>
    /// BiFastForwardBtn icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class BiFastForwardBtn : ComponentBase
    {
        /// <summary>
