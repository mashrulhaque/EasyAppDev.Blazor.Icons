...
{
    /// <summary>
    /// BiChevronBarContract icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class BiChevronBarContract : ComponentBase
    {
        /// <summary>
