...
{
    /// <summary>
    /// BiPhoneVibrate icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class BiPhoneVibrate : ComponentBase
    {
        /// <summary>
