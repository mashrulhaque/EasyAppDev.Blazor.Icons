...
{
    /// <summary>
    /// BiGearWide icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class BiGearWide : ComponentBase
    {
        /// <summary>
