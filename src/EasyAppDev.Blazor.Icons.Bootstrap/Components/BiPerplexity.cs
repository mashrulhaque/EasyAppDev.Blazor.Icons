...
{
    /// <summary>
    /// BiPerplexity icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class BiPerplexity : ComponentBase
    {
        /// <summary>
