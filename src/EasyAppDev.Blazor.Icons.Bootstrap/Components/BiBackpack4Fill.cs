...
{
    /// <summary>
    /// BiBackpack4Fill icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class BiBackpack4Fill : ComponentBase
    {
        /// <summary>
