...
{
    /// <summary>
    /// BiFiletypeMp3 icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class BiFiletypeMp3 : ComponentBase
    {
        /// <summary>
