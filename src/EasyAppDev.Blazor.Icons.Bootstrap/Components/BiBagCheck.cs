...
{
    /// <summary>
    /// BiBagCheck icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class BiBagCheck : ComponentBase
    {
        /// <summary>
