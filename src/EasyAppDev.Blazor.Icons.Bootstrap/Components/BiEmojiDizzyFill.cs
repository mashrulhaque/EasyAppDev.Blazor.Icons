...
{
    /// <summary>
    /// BiEmojiDizzyFill icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class BiEmojiDizzyFill : ComponentBase
    {
        /// <summary>
