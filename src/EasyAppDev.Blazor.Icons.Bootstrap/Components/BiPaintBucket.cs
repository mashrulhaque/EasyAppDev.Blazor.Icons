...
{
    /// <summary>
    /// BiPaintBucket icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class BiPaintBucket : ComponentBase
    {
        /// <summary>
