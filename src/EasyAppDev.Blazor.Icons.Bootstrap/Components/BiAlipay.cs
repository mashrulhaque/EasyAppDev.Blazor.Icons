...
{
    /// <summary>
    /// BiAlipay icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class BiAlipay : ComponentBase
    {
        /// <summary>
