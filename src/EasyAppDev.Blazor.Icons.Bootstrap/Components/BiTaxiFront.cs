...
{
    /// <summary>
    /// BiTaxiFront icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class BiTaxiFront : ComponentBase
    {
        /// <summary>
