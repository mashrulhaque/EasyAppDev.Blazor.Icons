...
{
    /// <summary>
    /// BiGlobeCentralSouthAsia icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class BiGlobeCentralSouthAsia : ComponentBase
    {
        /// <summary>
