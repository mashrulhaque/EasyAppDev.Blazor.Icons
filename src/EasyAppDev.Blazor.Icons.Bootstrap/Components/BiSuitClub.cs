...
{
    /// <summary>
    /// BiSuitClub icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class BiSuitClub : ComponentBase
    {
        /// <summary>
