...
{
    /// <summary>
    /// BiSpeedometer2 icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class BiSpeedometer2 : ComponentBase
    {
        /// <summary>
