...
{
    /// <summary>
    /// BiCameraFill icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class BiCameraFill : ComponentBase
    {
        /// <summary>
