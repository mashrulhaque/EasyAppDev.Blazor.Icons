...
{
    /// <summary>
    /// BiVirus2 icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class BiVirus2 : ComponentBase
    {
        /// <summary>
