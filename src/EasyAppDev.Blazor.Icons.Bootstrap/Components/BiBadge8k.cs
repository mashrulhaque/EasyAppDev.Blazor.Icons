...
{
    /// <summary>
    /// BiBadge8k icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class BiBadge8k : ComponentBase
    {
        /// <summary>
