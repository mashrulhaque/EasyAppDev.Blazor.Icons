...
{
    /// <summary>
    /// BiShieldPlus icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class BiShieldPlus : ComponentBase
    {
        /// <summary>
