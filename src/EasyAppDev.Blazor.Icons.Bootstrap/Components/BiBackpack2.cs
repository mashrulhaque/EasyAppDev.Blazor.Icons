...
{
    /// <summary>
    /// BiBackpack2 icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class BiBackpack2 : ComponentBase
    {
        /// <summary>
