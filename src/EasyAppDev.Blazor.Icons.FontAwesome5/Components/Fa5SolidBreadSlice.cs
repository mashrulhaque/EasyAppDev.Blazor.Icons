...
{
    /// <summary>
    /// Fa5SolidBreadSlice icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class Fa5SolidBreadSlice : ComponentBase
    {
        /// <summary>
