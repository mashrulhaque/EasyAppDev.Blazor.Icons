...
{
    /// <summary>
    /// Fa6SolidVirusCovidSlash icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class Fa6SolidVirusCovidSlash : ComponentBase
    {
        /// <summary>
