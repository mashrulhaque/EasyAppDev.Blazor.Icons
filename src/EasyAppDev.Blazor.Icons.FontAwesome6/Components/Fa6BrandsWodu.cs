...
{
    /// <summary>
    /// Fa6BrandsWodu icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class Fa6BrandsWodu : ComponentBase
    {
        /// <summary>
