...
{
    /// <summary>
    /// Fa6SolidPersonWalkingLuggage icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class Fa6SolidPersonWalkingLuggage : ComponentBase
    {
        /// <summary>
