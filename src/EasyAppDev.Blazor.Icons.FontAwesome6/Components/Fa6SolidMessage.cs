...
{
    /// <summary>
    /// Fa6SolidMessage icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class Fa6SolidMessage : ComponentBase
    {
        /// <summary>
