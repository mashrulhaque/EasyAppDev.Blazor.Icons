...
{
    /// <summary>
    /// Fa6BrandsMeta icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class Fa6BrandsMeta : ComponentBase
    {
        /// <summary>
