...
{
    /// <summary>
    /// Fa6SolidHandHoldingMedical icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class Fa6SolidHandHoldingMedical : ComponentBase
    {
        /// <summary>
