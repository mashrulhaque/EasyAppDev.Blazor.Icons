...
{
    /// <summary>
    /// Fa6SolidBarsProgress icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class Fa6SolidBarsProgress : ComponentBase
    {
        /// <summary>
