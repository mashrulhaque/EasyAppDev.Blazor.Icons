...
{
    /// <summary>
    /// Fa6SolidHandshakeSlash icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class Fa6SolidHandshakeSlash : ComponentBase
    {
        /// <summary>
