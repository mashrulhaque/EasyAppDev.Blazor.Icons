...
{
    /// <summary>
    /// Fa6SolidCrow icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class Fa6SolidCrow : ComponentBase
    {
        /// <summary>
