...
{
    /// <summary>
    /// Fa6SolidBowlRice icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class Fa6SolidBowlRice : ComponentBase
    {
        /// <summary>
