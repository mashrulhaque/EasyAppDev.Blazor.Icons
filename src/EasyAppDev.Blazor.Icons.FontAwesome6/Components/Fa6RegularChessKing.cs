...
{
    /// <summary>
    /// Fa6RegularChessKing icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class Fa6RegularChessKing : ComponentBase
    {
        /// <summary>
