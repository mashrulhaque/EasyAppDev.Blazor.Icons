...
{
    /// <summary>
    /// Fa6SolidPeoplePulling icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class Fa6SolidPeoplePulling : ComponentBase
    {
        /// <summary>
