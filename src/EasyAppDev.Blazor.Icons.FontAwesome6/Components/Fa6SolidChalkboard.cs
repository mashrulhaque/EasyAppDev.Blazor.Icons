...
{
    /// <summary>
    /// Fa6SolidChalkboard icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class Fa6SolidChalkboard : ComponentBase
    {
        /// <summary>
