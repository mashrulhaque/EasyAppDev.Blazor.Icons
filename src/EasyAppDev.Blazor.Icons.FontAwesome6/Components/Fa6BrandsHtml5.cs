...
{
    /// <summary>
    /// Fa6BrandsHtml5 icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class Fa6BrandsHtml5 : ComponentBase
    {
        /// <summary>
