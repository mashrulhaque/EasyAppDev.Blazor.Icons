...
{
    /// <summary>
    /// Fa6BrandsFedex icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class Fa6BrandsFedex : ComponentBase
    {
        /// <summary>
