...
{
    /// <summary>
    /// Fa6BrandsScreenpal icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class Fa6BrandsScreenpal : ComponentBase
    {
        /// <summary>
