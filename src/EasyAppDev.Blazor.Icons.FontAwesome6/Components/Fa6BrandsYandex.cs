...
{
    /// <summary>
    /// Fa6BrandsYandex icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class Fa6BrandsYandex : ComponentBase
    {
        /// <summary>
