...
{
    /// <summary>
    /// Fa6SolidBezierCurve icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class Fa6SolidBezierCurve : ComponentBase
    {
        /// <summary>
