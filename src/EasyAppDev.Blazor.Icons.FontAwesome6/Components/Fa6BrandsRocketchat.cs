...
{
    /// <summary>
    /// Fa6BrandsRocketchat icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class Fa6BrandsRocketchat : ComponentBase
    {
        /// <summary>
