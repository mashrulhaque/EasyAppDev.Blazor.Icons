...
{
    /// <summary>
    /// Fa6RegularShareFromSquare icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class Fa6RegularShareFromSquare : ComponentBase
    {
        /// <summary>
