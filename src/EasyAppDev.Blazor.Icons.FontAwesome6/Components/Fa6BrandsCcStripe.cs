...
{
    /// <summary>
    /// Fa6BrandsCcStripe icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class Fa6BrandsCcStripe : ComponentBase
    {
        /// <summary>
