...
{
    /// <summary>
    /// Fa6BrandsGg icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class Fa6BrandsGg : ComponentBase
    {
        /// <summary>
