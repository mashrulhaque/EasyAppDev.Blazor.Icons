...
{
    /// <summary>
    /// Fa6SolidLocationPinLock icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class Fa6SolidLocationPinLock : ComponentBase
    {
        /// <summary>
