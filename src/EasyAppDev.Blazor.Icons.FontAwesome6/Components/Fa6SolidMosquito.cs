...
{
    /// <summary>
    /// Fa6SolidMosquito icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class Fa6SolidMosquito : ComponentBase
    {
        /// <summary>
