...
{
    /// <summary>
    /// Fa6SolidBuildingWheat icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class Fa6SolidBuildingWheat : ComponentBase
    {
        /// <summary>
