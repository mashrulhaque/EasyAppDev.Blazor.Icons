...
{
    /// <summary>
    /// Fa6SolidBatteryEmpty icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class Fa6SolidBatteryEmpty : ComponentBase
    {
        /// <summary>
