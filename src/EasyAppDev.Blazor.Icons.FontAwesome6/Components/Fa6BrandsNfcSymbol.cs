...
{
    /// <summary>
    /// Fa6BrandsNfcSymbol icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class Fa6BrandsNfcSymbol : ComponentBase
    {
        /// <summary>
