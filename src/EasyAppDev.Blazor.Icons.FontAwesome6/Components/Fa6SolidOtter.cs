...
{
    /// <summary>
    /// Fa6SolidOtter icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class Fa6SolidOtter : ComponentBase
    {
        /// <summary>
