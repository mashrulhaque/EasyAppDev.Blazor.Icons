...
{
    /// <summary>
    /// Fa6SolidSignature icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class Fa6SolidSignature : ComponentBase
    {
        /// <summary>
