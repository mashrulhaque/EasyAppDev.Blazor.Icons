...
{
    /// <summary>
    /// Fa6SolidPaintRoller icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class Fa6SolidPaintRoller : ComponentBase
    {
        /// <summary>
