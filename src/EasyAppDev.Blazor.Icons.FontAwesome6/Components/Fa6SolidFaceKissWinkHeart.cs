...
{
    /// <summary>
    /// Fa6SolidFaceKissWinkHeart icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class Fa6SolidFaceKissWinkHeart : ComponentBase
    {
        /// <summary>
