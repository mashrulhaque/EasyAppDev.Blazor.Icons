...
{
    /// <summary>
    /// Fa6BrandsSwift icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class Fa6BrandsSwift : ComponentBase
    {
        /// <summary>
