...
{
    /// <summary>
    /// Fa6BrandsGulp icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class Fa6BrandsGulp : ComponentBase
    {
        /// <summary>
