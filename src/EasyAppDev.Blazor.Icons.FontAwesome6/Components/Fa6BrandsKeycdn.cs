...
{
    /// <summary>
    /// Fa6BrandsKeycdn icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class Fa6BrandsKeycdn : ComponentBase
    {
        /// <summary>
