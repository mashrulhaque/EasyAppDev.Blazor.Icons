...
{
    /// <summary>
    /// Fa6SolidGaugeSimple icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class Fa6SolidGaugeSimple : ComponentBase
    {
        /// <summary>
