...
{
    /// <summary>
    /// Fa6BrandsStripe icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class Fa6BrandsStripe : ComponentBase
    {
        /// <summary>
