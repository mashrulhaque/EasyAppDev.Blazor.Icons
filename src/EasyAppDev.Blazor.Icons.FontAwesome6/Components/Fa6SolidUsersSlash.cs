...
{
    /// <summary>
    /// Fa6SolidUsersSlash icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class Fa6SolidUsersSlash : ComponentBase
    {
        /// <summary>
