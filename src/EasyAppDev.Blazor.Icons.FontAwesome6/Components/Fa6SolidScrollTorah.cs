...
{
    /// <summary>
    /// Fa6SolidScrollTorah icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class Fa6SolidScrollTorah : ComponentBase
    {
        /// <summary>
