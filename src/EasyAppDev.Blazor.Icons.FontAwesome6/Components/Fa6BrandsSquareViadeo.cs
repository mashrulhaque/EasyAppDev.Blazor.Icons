...
{
    /// <summary>
    /// Fa6BrandsSquareViadeo icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class Fa6BrandsSquareViadeo : ComponentBase
    {
        /// <summary>
