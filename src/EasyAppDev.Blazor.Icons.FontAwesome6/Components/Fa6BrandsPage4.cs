...
{
    /// <summary>
    /// Fa6BrandsPage4 icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class Fa6BrandsPage4 : ComponentBase
    {
        /// <summary>
