...
{
    /// <summary>
    /// Fa6SolidStapler icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class Fa6SolidStapler : ComponentBase
    {
        /// <summary>
