...
{
    /// <summary>
    /// Fa6SolidShieldVirus icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class Fa6SolidShieldVirus : ComponentBase
    {
        /// <summary>
