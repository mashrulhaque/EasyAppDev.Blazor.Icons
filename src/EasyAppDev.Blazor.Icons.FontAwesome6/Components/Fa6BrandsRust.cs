...
{
    /// <summary>
    /// Fa6BrandsRust icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class Fa6BrandsRust : ComponentBase
    {
        /// <summary>
