...
{
    /// <summary>
    /// Fa6SolidHandsHolding icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class Fa6SolidHandsHolding : ComponentBase
    {
        /// <summary>
