...
{
    /// <summary>
    /// Fa6BrandsMandalorian icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class Fa6BrandsMandalorian : ComponentBase
    {
        /// <summary>
