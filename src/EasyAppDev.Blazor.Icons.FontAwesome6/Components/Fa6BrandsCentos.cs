...
{
    /// <summary>
    /// Fa6BrandsCentos icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class Fa6BrandsCentos : ComponentBase
    {
        /// <summary>
