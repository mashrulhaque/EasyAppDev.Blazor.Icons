...
{
    /// <summary>
    /// Fa6SolidMobileRetro icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class Fa6SolidMobileRetro : ComponentBase
    {
        /// <summary>
