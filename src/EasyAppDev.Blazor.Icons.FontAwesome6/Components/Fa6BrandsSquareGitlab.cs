...
{
    /// <summary>
    /// Fa6BrandsSquareGitlab icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class Fa6BrandsSquareGitlab : ComponentBase
    {
        /// <summary>
