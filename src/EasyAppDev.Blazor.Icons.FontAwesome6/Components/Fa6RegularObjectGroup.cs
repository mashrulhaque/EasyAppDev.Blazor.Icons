...
{
    /// <summary>
    /// Fa6RegularObjectGroup icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class Fa6RegularObjectGroup : ComponentBase
    {
        /// <summary>
