...
{
    /// <summary>
    /// Fa6RegularFaceKissWinkHeart icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class Fa6RegularFaceKissWinkHeart : ComponentBase
    {
        /// <summary>
