...
{
    /// <summary>
    /// Fa6RegularFloppyDisk icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class Fa6RegularFloppyDisk : ComponentBase
    {
        /// <summary>
