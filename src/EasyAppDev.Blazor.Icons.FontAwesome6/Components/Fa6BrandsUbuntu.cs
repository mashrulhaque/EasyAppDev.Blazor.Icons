...
{
    /// <summary>
    /// Fa6BrandsUbuntu icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class Fa6BrandsUbuntu : ComponentBase
    {
        /// <summary>
