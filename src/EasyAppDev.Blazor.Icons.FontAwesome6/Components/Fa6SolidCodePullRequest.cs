...
{
    /// <summary>
    /// Fa6SolidCodePullRequest icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class Fa6SolidCodePullRequest : ComponentBase
    {
        /// <summary>
