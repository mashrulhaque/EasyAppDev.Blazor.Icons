...
{
    /// <summary>
    /// Fa6BrandsBuyNLarge icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class Fa6BrandsBuyNLarge : ComponentBase
    {
        /// <summary>
