...
{
    /// <summary>
    /// Fa6BrandsFirefoxBrowser icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class Fa6BrandsFirefoxBrowser : ComponentBase
    {
        /// <summary>
