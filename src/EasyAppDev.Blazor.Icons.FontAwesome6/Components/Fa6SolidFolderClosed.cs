...
{
    /// <summary>
    /// Fa6SolidFolderClosed icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class Fa6SolidFolderClosed : ComponentBase
    {
        /// <summary>
