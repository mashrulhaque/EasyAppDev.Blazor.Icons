...
{
    /// <summary>
    /// Fa6BrandsHooli icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class Fa6BrandsHooli : ComponentBase
    {
        /// <summary>
