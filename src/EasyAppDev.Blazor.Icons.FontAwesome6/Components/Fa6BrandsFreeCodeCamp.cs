...
{
    /// <summary>
    /// Fa6BrandsFreeCodeCamp icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class Fa6BrandsFreeCodeCamp : ComponentBase
    {
        /// <summary>
