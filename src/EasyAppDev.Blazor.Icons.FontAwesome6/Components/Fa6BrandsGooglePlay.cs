...
{
    /// <summary>
    /// Fa6BrandsGooglePlay icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class Fa6BrandsGooglePlay : ComponentBase
    {
        /// <summary>
