...
{
    /// <summary>
    /// Fa6BrandsPixiv icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class Fa6BrandsPixiv : ComponentBase
    {
        /// <summary>
