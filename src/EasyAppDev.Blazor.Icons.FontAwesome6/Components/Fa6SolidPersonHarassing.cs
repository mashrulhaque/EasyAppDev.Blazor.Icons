...
{
    /// <summary>
    /// Fa6SolidPersonHarassing icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class Fa6SolidPersonHarassing : ComponentBase
    {
        /// <summary>
