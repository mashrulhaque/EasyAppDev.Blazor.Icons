...
{
    /// <summary>
    /// Fa6BrandsSquareLastfm icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class Fa6BrandsSquareLastfm : ComponentBase
    {
        /// <summary>
