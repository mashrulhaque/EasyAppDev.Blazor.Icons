...
{
    /// <summary>
    /// Fa6SolidTruckPlane icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class Fa6SolidTruckPlane : ComponentBase
    {
        /// <summary>
