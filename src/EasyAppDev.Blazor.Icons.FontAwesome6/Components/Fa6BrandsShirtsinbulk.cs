...
{
    /// <summary>
    /// Fa6BrandsShirtsinbulk icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class Fa6BrandsShirtsinbulk : ComponentBase
    {
        /// <summary>
