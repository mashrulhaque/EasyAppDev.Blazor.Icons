...
{
    /// <summary>
    /// Fa6SolidPlateWheat icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class Fa6SolidPlateWheat : ComponentBase
    {
        /// <summary>
