...
{
    /// <summary>
    /// Fa6BrandsEdge icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class Fa6BrandsEdge : ComponentBase
    {
        /// <summary>
