...
{
    /// <summary>
    /// Fa6SolidTurkishLiraSign icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class Fa6SolidTurkishLiraSign : ComponentBase
    {
        /// <summary>
