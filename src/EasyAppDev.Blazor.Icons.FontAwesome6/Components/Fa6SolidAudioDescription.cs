...
{
    /// <summary>
    /// Fa6SolidAudioDescription icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class Fa6SolidAudioDescription : ComponentBase
    {
        /// <summary>
