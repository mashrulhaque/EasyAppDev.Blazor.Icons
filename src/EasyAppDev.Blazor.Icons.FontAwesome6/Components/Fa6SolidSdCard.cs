...
{
    /// <summary>
    /// Fa6SolidSdCard icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class Fa6SolidSdCard : ComponentBase
    {
        /// <summary>
