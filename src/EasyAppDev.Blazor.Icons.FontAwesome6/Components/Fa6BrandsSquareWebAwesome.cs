...
{
    /// <summary>
    /// Fa6BrandsSquareWebAwesome icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class Fa6BrandsSquareWebAwesome : ComponentBase
    {
        /// <summary>
