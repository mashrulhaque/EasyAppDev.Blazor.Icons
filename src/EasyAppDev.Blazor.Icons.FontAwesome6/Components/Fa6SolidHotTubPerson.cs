...
{
    /// <summary>
    /// Fa6SolidHotTubPerson icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class Fa6SolidHotTubPerson : ComponentBase
    {
        /// <summary>
