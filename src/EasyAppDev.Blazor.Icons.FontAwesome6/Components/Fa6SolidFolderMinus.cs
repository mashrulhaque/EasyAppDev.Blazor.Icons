...
{
    /// <summary>
    /// Fa6SolidFolderMinus icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class Fa6SolidFolderMinus : ComponentBase
    {
        /// <summary>
