...
{
    /// <summary>
    /// Fa6SolidWonSign icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class Fa6SolidWonSign : ComponentBase
    {
        /// <summary>
