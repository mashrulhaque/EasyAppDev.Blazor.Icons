...
{
    /// <summary>
    /// Fa6RegularFileAudio icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class Fa6RegularFileAudio : ComponentBase
    {
        /// <summary>
