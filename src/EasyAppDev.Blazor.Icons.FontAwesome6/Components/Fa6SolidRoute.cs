...
{
    /// <summary>
    /// Fa6SolidRoute icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class Fa6SolidRoute : ComponentBase
    {
        /// <summary>
