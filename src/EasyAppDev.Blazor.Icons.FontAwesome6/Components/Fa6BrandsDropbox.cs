...
{
    /// <summary>
    /// Fa6BrandsDropbox icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class Fa6BrandsDropbox : ComponentBase
    {
        /// <summary>
