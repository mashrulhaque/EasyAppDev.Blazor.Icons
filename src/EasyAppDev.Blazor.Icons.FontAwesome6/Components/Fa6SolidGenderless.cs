...
{
    /// <summary>
    /// Fa6SolidGenderless icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class Fa6SolidGenderless : ComponentBase
    {
        /// <summary>
