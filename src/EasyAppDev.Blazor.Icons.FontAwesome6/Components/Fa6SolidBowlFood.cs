...
{
    /// <summary>
    /// Fa6SolidBowlFood icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class Fa6SolidBowlFood : ComponentBase
    {
        /// <summary>
