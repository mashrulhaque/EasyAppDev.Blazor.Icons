...
{
    /// <summary>
    /// Fa6SolidStoreSlash icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class Fa6SolidStoreSlash : ComponentBase
    {
        /// <summary>
