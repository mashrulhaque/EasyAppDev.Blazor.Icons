...
{
    /// <summary>
    /// Fa6RegularRectangleXmark icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class Fa6RegularRectangleXmark : ComponentBase
    {
        /// <summary>
