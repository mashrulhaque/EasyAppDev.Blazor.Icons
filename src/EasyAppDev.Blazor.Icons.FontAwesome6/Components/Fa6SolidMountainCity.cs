...
{
    /// <summary>
    /// Fa6SolidMountainCity icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class Fa6SolidMountainCity : ComponentBase
    {
        /// <summary>
