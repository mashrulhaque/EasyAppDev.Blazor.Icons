...
{
    /// <summary>
    /// Fa6RegularHandPointDown icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class Fa6RegularHandPointDown : ComponentBase
    {
        /// <summary>
