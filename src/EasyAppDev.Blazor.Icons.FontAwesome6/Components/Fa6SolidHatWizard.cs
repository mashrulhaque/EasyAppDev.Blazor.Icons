...
{
    /// <summary>
    /// Fa6SolidHatWizard icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class Fa6SolidHatWizard : ComponentBase
    {
        /// <summary>
