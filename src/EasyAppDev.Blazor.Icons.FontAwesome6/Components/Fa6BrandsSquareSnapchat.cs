...
{
    /// <summary>
    /// Fa6BrandsSquareSnapchat icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class Fa6BrandsSquareSnapchat : ComponentBase
    {
        /// <summary>
