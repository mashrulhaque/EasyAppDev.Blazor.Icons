...
{
    /// <summary>
    /// Fa6SolidChildCombatant icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class Fa6SolidChildCombatant : ComponentBase
    {
        /// <summary>
