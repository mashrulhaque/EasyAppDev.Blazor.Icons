...
{
    /// <summary>
    /// Fa6BrandsKaggle icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class Fa6BrandsKaggle : ComponentBase
    {
        /// <summary>
