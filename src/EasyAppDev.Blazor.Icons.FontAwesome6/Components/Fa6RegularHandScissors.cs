...
{
    /// <summary>
    /// Fa6RegularHandScissors icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class Fa6RegularHandScissors : ComponentBase
    {
        /// <summary>
