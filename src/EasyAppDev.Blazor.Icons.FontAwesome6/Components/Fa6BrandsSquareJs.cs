...
{
    /// <summary>
    /// Fa6BrandsSquareJs icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class Fa6BrandsSquareJs : ComponentBase
    {
        /// <summary>
