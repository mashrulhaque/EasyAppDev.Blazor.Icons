...
{
    /// <summary>
    /// Fa6RegularChessRook icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class Fa6RegularChessRook : ComponentBase
    {
        /// <summary>
