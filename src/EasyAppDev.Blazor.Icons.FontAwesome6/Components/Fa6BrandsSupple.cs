...
{
    /// <summary>
    /// Fa6BrandsSupple icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class Fa6BrandsSupple : ComponentBase
    {
        /// <summary>
