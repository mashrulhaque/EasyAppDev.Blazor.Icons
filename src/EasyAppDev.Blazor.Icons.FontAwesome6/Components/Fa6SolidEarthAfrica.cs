...
{
    /// <summary>
    /// Fa6SolidEarthAfrica icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class Fa6SolidEarthAfrica : ComponentBase
    {
        /// <summary>
