...
{
    /// <summary>
    /// Fa6BrandsTheRedYeti icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class Fa6BrandsTheRedYeti : ComponentBase
    {
        /// <summary>
