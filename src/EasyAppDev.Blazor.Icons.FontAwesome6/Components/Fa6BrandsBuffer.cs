...
{
    /// <summary>
    /// Fa6BrandsBuffer icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class Fa6BrandsBuffer : ComponentBase
    {
        /// <summary>
