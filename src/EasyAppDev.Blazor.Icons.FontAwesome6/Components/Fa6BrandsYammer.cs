...
{
    /// <summary>
    /// Fa6BrandsYammer icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class Fa6BrandsYammer : ComponentBase
    {
        /// <summary>
