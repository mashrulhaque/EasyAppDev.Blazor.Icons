...
{
    /// <summary>
    /// Fa6RegularFileZipper icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class Fa6RegularFileZipper : ComponentBase
    {
        /// <summary>
