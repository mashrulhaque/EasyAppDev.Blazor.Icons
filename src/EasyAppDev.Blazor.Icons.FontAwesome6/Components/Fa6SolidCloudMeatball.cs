...
{
    /// <summary>
    /// Fa6SolidCloudMeatball icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class Fa6SolidCloudMeatball : ComponentBase
    {
        /// <summary>
