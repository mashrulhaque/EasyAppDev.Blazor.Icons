...
{
    /// <summary>
    /// Fa6BrandsViadeo icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class Fa6BrandsViadeo : ComponentBase
    {
        /// <summary>
