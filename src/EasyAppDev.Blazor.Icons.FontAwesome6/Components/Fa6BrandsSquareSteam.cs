...
{
    /// <summary>
    /// Fa6BrandsSquareSteam icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class Fa6BrandsSquareSteam : ComponentBase
    {
        /// <summary>
