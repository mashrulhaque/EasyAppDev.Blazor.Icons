...
{
    /// <summary>
    /// Fa6SolidUserAstronaut icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class Fa6SolidUserAstronaut : ComponentBase
    {
        /// <summary>
