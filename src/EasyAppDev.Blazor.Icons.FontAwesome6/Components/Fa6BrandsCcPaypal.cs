...
{
    /// <summary>
    /// Fa6BrandsCcPaypal icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class Fa6BrandsCcPaypal : ComponentBase
    {
        /// <summary>
