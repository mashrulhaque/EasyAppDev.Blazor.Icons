...
{
    /// <summary>
    /// Fa6BrandsFigma icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class Fa6BrandsFigma : ComponentBase
    {
        /// <summary>
