...
{
    /// <summary>
    /// Fa6BrandsLaravel icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class Fa6BrandsLaravel : ComponentBase
    {
        /// <summary>
