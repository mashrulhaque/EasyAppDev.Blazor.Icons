...
{
    /// <summary>
    /// Fa6BrandsFirstOrder icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class Fa6BrandsFirstOrder : ComponentBase
    {
        /// <summary>
