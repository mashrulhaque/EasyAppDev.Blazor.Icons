...
{
    /// <summary>
    /// Fa6SolidTornado icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class Fa6SolidTornado : ComponentBase
    {
        /// <summary>
