...
{
    /// <summary>
    /// Fa6SolidUsersLine icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class Fa6SolidUsersLine : ComponentBase
    {
        /// <summary>
