...
{
    /// <summary>
    /// Fa6SolidCircleHalfStroke icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class Fa6SolidCircleHalfStroke : ComponentBase
    {
        /// <summary>
