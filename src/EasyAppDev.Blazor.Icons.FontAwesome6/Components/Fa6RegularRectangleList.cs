...
{
    /// <summary>
    /// Fa6RegularRectangleList icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class Fa6RegularRectangleList : ComponentBase
    {
        /// <summary>
