...
{
    /// <summary>
    /// Fa6BrandsSchlix icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class Fa6BrandsSchlix : ComponentBase
    {
        /// <summary>
