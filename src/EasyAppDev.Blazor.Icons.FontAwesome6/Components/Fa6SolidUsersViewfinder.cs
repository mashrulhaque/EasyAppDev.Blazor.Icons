...
{
    /// <summary>
    /// Fa6SolidUsersViewfinder icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class Fa6SolidUsersViewfinder : ComponentBase
    {
        /// <summary>
