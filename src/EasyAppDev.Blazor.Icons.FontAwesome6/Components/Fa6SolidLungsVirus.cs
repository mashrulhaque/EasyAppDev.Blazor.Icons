...
{
    /// <summary>
    /// Fa6SolidLungsVirus icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class Fa6SolidLungsVirus : ComponentBase
    {
        /// <summary>
