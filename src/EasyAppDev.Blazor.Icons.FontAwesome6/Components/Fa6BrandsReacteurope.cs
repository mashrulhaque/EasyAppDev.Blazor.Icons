...
{
    /// <summary>
    /// Fa6BrandsReacteurope icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class Fa6BrandsReacteurope : ComponentBase
    {
        /// <summary>
