...
{
    /// <summary>
    /// Fa6BrandsDeskpro icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class Fa6BrandsDeskpro : ComponentBase
    {
        /// <summary>
