...
{
    /// <summary>
    /// Fa6SolidShareFromSquare icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class Fa6SolidShareFromSquare : ComponentBase
    {
        /// <summary>
