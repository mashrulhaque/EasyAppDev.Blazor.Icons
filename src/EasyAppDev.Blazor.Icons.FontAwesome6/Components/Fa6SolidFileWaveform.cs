...
{
    /// <summary>
    /// Fa6SolidFileWaveform icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class Fa6SolidFileWaveform : ComponentBase
    {
        /// <summary>
