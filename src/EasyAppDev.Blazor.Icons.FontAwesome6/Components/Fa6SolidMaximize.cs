...
{
    /// <summary>
    /// Fa6SolidMaximize icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class Fa6SolidMaximize : ComponentBase
    {
        /// <summary>
