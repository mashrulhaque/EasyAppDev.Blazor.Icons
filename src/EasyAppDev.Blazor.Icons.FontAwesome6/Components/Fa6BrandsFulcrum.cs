...
{
    /// <summary>
    /// Fa6BrandsFulcrum icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class Fa6BrandsFulcrum : ComponentBase
    {
        /// <summary>
