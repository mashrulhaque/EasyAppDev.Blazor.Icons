...
{
    /// <summary>
    /// Fa6BrandsHive icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class Fa6BrandsHive : ComponentBase
    {
        /// <summary>
