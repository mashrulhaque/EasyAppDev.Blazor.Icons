...
{
    /// <summary>
    /// Fa6SolidPooStorm icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class Fa6SolidPooStorm : ComponentBase
    {
        /// <summary>
