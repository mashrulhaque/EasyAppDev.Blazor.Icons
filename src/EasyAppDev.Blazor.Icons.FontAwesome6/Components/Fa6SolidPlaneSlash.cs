...
{
    /// <summary>
    /// Fa6SolidPlaneSlash icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class Fa6SolidPlaneSlash : ComponentBase
    {
        /// <summary>
