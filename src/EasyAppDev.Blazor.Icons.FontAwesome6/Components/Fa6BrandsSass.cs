...
{
    /// <summary>
    /// Fa6BrandsSass icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class Fa6BrandsSass : ComponentBase
    {
        /// <summary>
