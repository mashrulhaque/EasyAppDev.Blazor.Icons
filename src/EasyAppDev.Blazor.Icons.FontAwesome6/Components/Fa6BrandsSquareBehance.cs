...
{
    /// <summary>
    /// Fa6BrandsSquareBehance icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class Fa6BrandsSquareBehance : ComponentBase
    {
        /// <summary>
