...
{
    /// <summary>
    /// Fa6RegularChessPawn icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class Fa6RegularChessPawn : ComponentBase
    {
        /// <summary>
