...
{
    /// <summary>
    /// Fa6BrandsMailchimp icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class Fa6BrandsMailchimp : ComponentBase
    {
        /// <summary>
