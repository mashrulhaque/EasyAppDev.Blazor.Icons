...
{
    /// <summary>
    /// Fa6BrandsSafari icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class Fa6BrandsSafari : ComponentBase
    {
        /// <summary>
