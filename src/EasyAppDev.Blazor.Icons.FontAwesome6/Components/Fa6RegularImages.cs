...
{
    /// <summary>
    /// Fa6RegularImages icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class Fa6RegularImages : ComponentBase
    {
        /// <summary>
