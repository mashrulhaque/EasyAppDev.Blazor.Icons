...
{
    /// <summary>
    /// FlSpace3dRegular icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class FlSpace3dRegular : ComponentBase
    {
        /// <summary>
