...
{
    /// <summary>
    /// FlVoicemailShieldFilled icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class FlVoicemailShieldFilled : ComponentBase
    {
        /// <summary>
        ...
        protected override void BuildRenderTree(RenderTreeBuilder builder)
        {
            ...
            // Inline SVG content
            builder.AddMarkupContent(13, @"<path d=""M19.75 4C20.99 4 22 5 22 6.25v5.35a7.65 7.65 0 0 1-1.96-1.22 1.6 1.6 0 0 0-1.69-.24A3 3 0 0 0 16.18 9L16 9H7.82a3 3 0 1 0 2.88 1.7l-.1-.2h2.8a2.99 2.99 0 0 0-.26 2.4c-.09.19-.14.4-.14.63v3.5c0 1.16.27 2.14.68 2.97H4.25C3.01 20 2 19 2 17.75V6.25C2 5.01 3 4 4.25 4h15.5ZM16 10.5c.45 0 .85.2 1.12.5-.68.45-1.6.89-2.62 1 0-.83.67-1.5 1.5-1.5Zm-8 0a1.5 1.5 0 1 1 0 3 1.5 1.5 0 0 1 0-3Zm11.39.64c.68.58 2.2 1.7 4.11 1.87.28.02.5.24.5.52v3.5c0 4.21-4.1 5.7-4.87 5.95a.42.42 0 0 1-.26 0c-.78-.25-4.87-1.74-4.87-5.95v-3.5c0-.28.22-.5.5-.52a7.72 7.72 0 0 0 4.12-1.87.6.6 0 0 1 .77 0Z""/>");
