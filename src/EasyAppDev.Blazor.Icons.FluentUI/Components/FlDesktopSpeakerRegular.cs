...
{
    /// <summary>
    /// FlDesktopSpeakerRegular icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class FlDesktopSpeakerRegular : ComponentBase
    {
        /// <summary>
