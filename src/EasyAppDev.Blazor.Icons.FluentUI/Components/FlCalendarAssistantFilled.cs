...
{
    /// <summary>
    /// FlCalendarAssistantFilled icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class FlCalendarAssistantFilled : ComponentBase
    {
        /// <summary>
        ...
        protected override void BuildRenderTree(RenderTreeBuilder builder)
        {
            ...
            // Inline SVG content
            builder.AddMarkupContent(13, @"<path d=""M21 8.5v3.52A6.5 6.5 0 0 0 12.02 21H6.25A3.25 3.25 0 0 1 3 17.75V8.5h18Z""/><path d=""M17.75 3C19.55 3 21 4.46 21 6.25V7H3v-.75C3 4.45 4.46 3 6.25 3h11.5Z""/><path d=""M17.5 23a5.5 5.5 0 1 0 0-11 5.5 5.5 0 0 0 0 11Zm-.4-9h1.43c.35 0 .59.35.47.68L18.5 16h.63c.38 0 .6.41.4.73l-2.63 4.03a.52.52 0 0 1-.92-.44l.77-2.32h-.78a.5.5 0 0 1-.47-.68l1.13-3a.5.5 0 0 1 .47-.32Z""/>");
