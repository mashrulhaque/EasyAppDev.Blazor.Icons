...
{
    /// <summary>
    /// FlPersonWalkingRegular icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class FlPersonWalkingRegular : ComponentBase
    {
        /// <summary>
