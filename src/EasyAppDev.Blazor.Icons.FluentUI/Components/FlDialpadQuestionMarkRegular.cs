...
{
    /// <summary>
    /// FlDialpadQuestionMarkRegular icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class FlDialpadQuestionMarkRegular : ComponentBase
    {
        /// <summary>
        ...
        protected override void BuildRenderTree(RenderTreeBuilder builder)
        {
            ...
            // Inline SVG content
            builder.AddMarkupContent(13, @"<path d=""M12 2.75a1.25 1.25 0 1 1 0 2.5 1.25 1.25 0 0 1 0-2.5ZM13.25 9a1.25 1.25 0 1 0-2.5 0 1.25 1.25 0 0 0 2.5 0ZM7 12.75a1.25 1.25 0 1 1 0 2.5 1.25 1.25 0 0 1 0-2.5Zm5 0c.3 0 .57.1.78.28a6.5 6.5 0 0 0-1.33 2.1 1.25 1.25 0 0 1 .55-2.38Zm5-5a1.25 1.25 0 1 1 0 2.5 1.25 1.25 0 0 1 0-2.5ZM8.25 9a1.25 1.25 0 1 0-2.5 0 1.25 1.25 0 0 0 2.5 0Zm10-5a1.25 1.25 0 1 0-2.5 0 1.25 1.25 0 0 0 2.5 0ZM7 2.75a1.25 1.25 0 1 1 0 2.5 1.25 1.25 0 0 1 0-2.5ZM17.5 12a5.5 5.5 0 1 1 0 11 5.5 5.5 0 0 1 0-11Zm0 7.75a.62.62 0 1 0 0 1.25.62.62 0 0 0 0-1.25Zm0-5.88c-1.05 0-1.86.82-1.85 1.96a.5.5 0 0 0 1-.01c0-.58.36-.95.85-.95.47 0 .85.4.85.95 0 .2-.05.35-.22.57l-.1.11-.1.11-.26.3-.14.15c-.38.46-.53.8-.53 1.31a.5.5 0 0 0 1 0c0-.2.06-.36.24-.59l.08-.1.1-.12.27-.29.13-.15c.38-.45.53-.79.53-1.3 0-1.1-.82-1.95-1.85-1.95Z""/>");
