...
{
    /// <summary>
    /// FlGuestRegular icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class FlGuestRegular : ComponentBase
    {
        /// <summary>
        ...
        protected override void BuildRenderTree(RenderTreeBuilder builder)
        {
            ...
            // Inline SVG content
            builder.AddMarkupContent(13, @"<path d=""M16 15.25c0-.7-.56-1.25-1.25-1.25h-5.5C8.56 14 8 14.56 8 15.25v.5c0 1.84 1.47 2.75 4 2.75 2.53 0 4-.9 4-2.76v-.5Zm-6.5.5v-.25h5v.24c0 .83-.7 1.26-2.5 1.26s-2.5-.43-2.5-1.26Zm5-5.25a2.5 2.5 0 1 0-5 0 2.5 2.5 0 0 0 5 0Zm-3.5 0a1 1 0 1 1 2 0 1 1 0 0 1-2 0ZM10.75 5a.75.75 0 0 0 0 1.5h2.5a.75.75 0 0 0 0-1.5h-2.5Zm9.24-.9A2.25 2.25 0 0 0 17.75 2H6.1A2.25 2.25 0 0 0 4 4.26v15.66A2.25 2.25 0 0 0 6.26 22h11.5l.15-.01a2.25 2.25 0 0 0 2.1-2.25V4.1ZM6.25 3.5h11.6c.37.06.65.37.65.75v15.6a.75.75 0 0 1-.75.65H6.15a.75.75 0 0 1-.65-.75V4.15a.75.75 0 0 1 .75-.65Z""/>");
