...
{
    /// <summary>
    /// FlLotteryRegular icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class FlLotteryRegular : ComponentBase
    {
        /// <summary>
        ...
        protected override void BuildRenderTree(RenderTreeBuilder builder)
        {
            ...
            // Inline SVG content
            builder.AddMarkupContent(13, @"<path d=""M14.15 4.72a2.5 2.5 0 0 0-4.3 0 5.96 5.96 0 0 0-1.41-.55 4 4 0 0 1 7.12 0c-.5.13-.97.31-1.41.55ZM9.38 7.44a7.95 7.95 0 0 1 1.66-.38 5 5 0 1 0-6.98 6.98c.07-.57.2-1.13.38-1.66a3.5 3.5 0 0 1 4.95-4.95Zm10.56 6.6a5 5 0 1 0-6.98-6.98c.57.07 1.13.2 1.66.38a3.5 3.5 0 0 1 4.95 4.95c.18.52.3 1.08.37 1.65ZM9.5 13.25c0-.41.34-.75.75-.75h4.25a.75.75 0 0 1 .5 1.31l-.02.02a3.24 3.24 0 0 0-.26.26 9.55 9.55 0 0 0-2.25 3.86.75.75 0 1 1-1.44-.4c.4-1.5 1.15-2.7 1.78-3.54l.01-.01h-2.57a.75.75 0 0 1-.75-.75ZM12 22a7 7 0 1 0 0-14 7 7 0 0 0 0 14Zm0-1.5a5.5 5.5 0 1 1 0-11 5.5 5.5 0 0 1 0 11Z""/>");
