...
{
    /// <summary>
    /// FlWasherRegular icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class FlWasherRegular : ComponentBase
    {
        /// <summary>
