...
{
    /// <summary>
    /// FlPersonSubtractRegular icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class FlPersonSubtractRegular : ComponentBase
    {
        /// <summary>
