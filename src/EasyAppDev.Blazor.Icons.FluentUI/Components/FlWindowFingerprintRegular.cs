...
{
    /// <summary>
    /// FlWindowFingerprintRegular icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class FlWindowFingerprintRegular : ComponentBase
    {
        /// <summary>
