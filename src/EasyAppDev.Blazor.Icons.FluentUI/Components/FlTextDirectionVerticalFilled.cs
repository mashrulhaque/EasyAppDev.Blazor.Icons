...
{
    /// <summary>
    /// FlTextDirectionVerticalFilled icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class FlTextDirectionVerticalFilled : ComponentBase
    {
        /// <summary>
        ...
        protected override void BuildRenderTree(RenderTreeBuilder builder)
        {
            ...
            // Inline SVG content
            builder.AddMarkupContent(13, @"<path d=""M8 4a1 1 0 0 0-2 0v13.59l-.3-.3a1 1 0 0 0-1.4 1.42l2 2a1 1 0 0 0 1.4 0l2-2a1 1 0 0 0-1.4-1.42l-.3.3V4Zm9.17-.38a1 1 0 0 0-1.84 0l-3.75 9a1 1 0 1 0 1.84.76l1-2.38h3.66l1 2.38a1 1 0 0 0 1.84-.76l-3.75-9ZM17.25 9h-2l1-2.4 1 2.4ZM16 14a1 1 0 0 0-1 1v2.59l-.3-.3a1 1 0 0 0-1.4 1.42l2 2a1 1 0 0 0 1.4 0l2-2a1 1 0 0 0-1.4-1.42l-.3.3V15a1 1 0 0 0-1-1Z""/>");
