...
{
    /// <summary>
    /// FlPeopleSearchFilled icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class FlPeopleSearchFilled : ComponentBase
    {
        /// <summary>
