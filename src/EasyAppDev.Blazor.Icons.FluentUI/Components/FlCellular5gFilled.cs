...
{
    /// <summary>
    /// FlCellular5gFilled icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class FlCellular5gFilled : ComponentBase
    {
        /// <summary>
