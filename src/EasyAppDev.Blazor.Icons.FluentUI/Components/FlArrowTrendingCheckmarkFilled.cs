...
{
    /// <summary>
    /// FlArrowTrendingCheckmarkFilled icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class FlArrowTrendingCheckmarkFilled : ComponentBase
    {
        /// <summary>
        ...
        protected override void BuildRenderTree(RenderTreeBuilder builder)
        {
            ...
            // Inline SVG content
            builder.AddMarkupContent(13, @"<path d=""M20 3a1 1 0 0 1 1 1v5a1 1 0 1 1-2 0V6.41l-5.8 5.8a1 1 0 0 1-1.4 0L10 10.4l-5.3 5.3a1 1 0 0 1-1.4-1.42l6-6a1 1 0 0 1 1.4 0l1.8 1.8L17.59 5H15a1 1 0 1 1 0-2h5Zm3 14.5a5.5 5.5 0 1 1-11 0 5.5 5.5 0 0 1 11 0Zm-2.15-2.35a.5.5 0 0 0-.7 0l-3.65 3.64-1.65-1.64a.5.5 0 0 0-.7.7l2 2c.2.2.5.2.7 0l4-4a.5.5 0 0 0 0-.7Z""/>");
