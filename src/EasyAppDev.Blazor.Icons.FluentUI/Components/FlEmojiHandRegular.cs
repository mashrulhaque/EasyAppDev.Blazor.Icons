...
{
    /// <summary>
    /// FlEmojiHandRegular icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class FlEmojiHandRegular : ComponentBase
    {
        /// <summary>
