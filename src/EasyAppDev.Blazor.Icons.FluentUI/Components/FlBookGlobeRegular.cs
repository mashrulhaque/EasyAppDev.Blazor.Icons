...
{
    /// <summary>
    /// FlBookGlobeRegular icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class FlBookGlobeRegular : ComponentBase
    {
        /// <summary>
        ...
        protected override void BuildRenderTree(RenderTreeBuilder builder)
        {
            ...
            // Inline SVG content
            builder.AddMarkupContent(13, @"<path d=""M12.04 6.02a4.75 4.75 0 1 0 .34-.02h-.01a1.35 1.35 0 0 0-.33.02Zm-1.62 1.83c-.23.68-.37 1.5-.4 2.4h-1.1c.14-1 .7-1.86 1.5-2.4Zm-.38 3.9c.07.7.2 1.36.38 1.91a3.5 3.5 0 0 1-1.4-1.91h1.02Zm3.97 2.1c.22-.6.38-1.31.45-2.1h1.27a3.5 3.5 0 0 1-1.72 2.1Zm-1.06-2.1a6.49 6.49 0 0 1-.34 1.57 2.06 2.06 0 0 1-.36.64l-.02-.02c-.1-.11-.22-.31-.34-.62a6.49 6.49 0 0 1-.34-1.57h1.4Zm.04-1.5H11.5a7.1 7.1 0 0 1 .38-2.07 2.06 2.06 0 0 1 .36-.64l.02.02c.1.11.22.31.34.62.2.52.34 1.24.38 2.07Zm1.5 0A8.65 8.65 0 0 0 14 7.66a3.5 3.5 0 0 1 1.83 2.59h-1.35ZM12.3 7.49Zm-.12 0ZM6.5 2A2.5 2.5 0 0 0 4 4.5v15A2.5 2.5 0 0 0 6.5 22h13.25a.75.75 0 0 0 0-1.5H6.5a1 1 0 0 1-1-1h14.25c.41 0 .75-.34.75-.75V4.5A2.5 2.5 0 0 0 18 2H6.5ZM19 4.5V18H5.5V4.5a1 1 0 0 1 1-1H18a1 1 0 0 1 1 1ZM12.3 14v.01Z""/>");
