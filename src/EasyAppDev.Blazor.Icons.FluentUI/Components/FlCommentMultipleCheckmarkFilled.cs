...
{
    /// <summary>
    /// FlCommentMultipleCheckmarkFilled icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class FlCommentMultipleCheckmarkFilled : ComponentBase
    {
        /// <summary>
        ...
        protected override void BuildRenderTree(RenderTreeBuilder builder)
        {
            ...
            // Inline SVG content
            builder.AddMarkupContent(13, @"<path d=""M5.25 5h-.24c.57-.9 1.59-1.5 2.74-1.5h8a5.75 5.75 0 0 1 5.75 5.75v3.13a6.5 6.5 0 0 0-1.5-.88V9.25C20 6.9 18.1 5 15.75 5H5.25Zm12.25 6c.52 0 1.02.06 1.5.17V9.25C19 7.45 17.54 6 15.75 6H5.25A3.25 3.25 0 0 0 2 9.25v6.5a3.25 3.25 0 0 0 3 3.24v1.76a1.25 1.25 0 0 0 1.99 1L10.75 19h.42a6.52 6.52 0 0 1 6.33-8Zm5.5 6.5a5.5 5.5 0 1 1-11 0 5.5 5.5 0 0 1 11 0Zm-2.15-2.35a.5.5 0 0 0-.7 0l-3.65 3.64-1.65-1.64a.5.5 0 0 0-.7.7l2 2c.2.2.5.2.7 0l4-4a.5.5 0 0 0 0-.7Z""/>");
