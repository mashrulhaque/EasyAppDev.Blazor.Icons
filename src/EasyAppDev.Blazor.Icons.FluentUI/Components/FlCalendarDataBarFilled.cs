...
{
    /// <summary>
    /// FlCalendarDataBarFilled icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class FlCalendarDataBarFilled : ComponentBase
    {
        /// <summary>
        ...
        protected override void BuildRenderTree(RenderTreeBuilder builder)
        {
            ...
            // Inline SVG content
            builder.AddMarkupContent(13, @"<path d=""M21 8.5v4.55c-.37.07-.7.23-1 .45a2.5 2.5 0 0 0-5 0v2a2.5 2.5 0 0 0-4 2V21H6.25A3.25 3.25 0 0 1 3 17.75V8.5h18ZM17.75 3C19.55 3 21 4.46 21 6.25V7H3v-.75C3 4.45 4.46 3 6.25 3h11.5Zm-.25 9c-.83 0-1.5.67-1.5 1.5v8a1.5 1.5 0 0 0 3 0v-8c0-.83-.67-1.5-1.5-1.5Zm-4 4c-.83 0-1.5.67-1.5 1.5v4a1.5 1.5 0 0 0 3 0v-4c0-.83-.67-1.5-1.5-1.5Zm6.5-.5a1.5 1.5 0 0 1 3 0v6a1.5 1.5 0 0 1-3 0v-6Z""/>");
