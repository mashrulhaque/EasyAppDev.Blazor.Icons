...
{
    /// <summary>
    /// FlTableDeleteColumnFilled icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class FlTableDeleteColumnFilled : ComponentBase
    {
        /// <summary>
