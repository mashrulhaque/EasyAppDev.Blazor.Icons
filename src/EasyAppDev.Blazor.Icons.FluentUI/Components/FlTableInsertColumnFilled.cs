...
{
    /// <summary>
    /// FlTableInsertColumnFilled icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class FlTableInsertColumnFilled : ComponentBase
    {
        /// <summary>
        ...
        protected override void BuildRenderTree(RenderTreeBuilder builder)
        {
            ...
            // Inline SVG content
            builder.AddMarkupContent(13, @"<path d=""M4.5 3.75v16.5a.75.75 0 0 1-1.5 0V3.75a.75.75 0 0 1 1.5 0ZM16 5.25C16 4.01 15.1 3 14 3h-4C8.9 3 8 4 8 5.25V8h8V5.25ZM8 14.5v-5h8v5H8ZM8 16v2.75c0 1.24.9 2.25 2 2.25h4c1.1 0 2-1 2-2.25V16H8Zm13 4.25V3.75a.75.75 0 0 0-1.5 0v16.5a.75.75 0 0 0 1.5 0Z""/>");
