...
{
    /// <summary>
    /// FlImageSearchRegular icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class FlImageSearchRegular : ComponentBase
    {
        /// <summary>
