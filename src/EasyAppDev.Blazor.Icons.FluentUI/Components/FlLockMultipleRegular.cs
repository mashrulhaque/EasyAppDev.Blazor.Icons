...
{
    /// <summary>
    /// FlLockMultipleRegular icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class FlLockMultipleRegular : ComponentBase
    {
        /// <summary>
        ...
        protected override void BuildRenderTree(RenderTreeBuilder builder)
        {
            ...
            // Inline SVG content
            builder.AddMarkupContent(13, @"<path d=""M10.75 13.75a1.25 1.25 0 1 0 0-2.5 1.25 1.25 0 0 0 0 2.5ZM7.25 5.5a3.5 3.5 0 1 1 7 0v1h1c1.24 0 2.25 1 2.25 2.25v7.5c0 1.24-1 2.25-2.25 2.25h-9c-1.24 0-2.25-1-2.25-2.25v-7.5C4 7.51 5 6.5 6.25 6.5h1v-1Zm5.5 0a2 2 0 1 0-4 0v1h4v-1ZM5.5 8.75v7.5c0 .41.34.75.75.75h9c.41 0 .75-.34.75-.75v-7.5a.75.75 0 0 0-.75-.75h-9a.75.75 0 0 0-.75.75ZM9.75 21c-.98 0-1.81-.63-2.12-1.5h8.12a2.75 2.75 0 0 0 2.75-2.75v-6.62c.87.3 1.5 1.14 1.5 2.12v4.5C20 19.1 18.1 21 15.75 21h-6Z""/>");
