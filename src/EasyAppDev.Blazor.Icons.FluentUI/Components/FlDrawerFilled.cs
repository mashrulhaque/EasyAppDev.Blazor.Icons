...
{
    /// <summary>
    /// FlDrawerFilled icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class FlDrawerFilled : ComponentBase
    {
        /// <summary>
        ...
        protected override void BuildRenderTree(RenderTreeBuilder builder)
        {
            ...
            // Inline SVG content
            builder.AddMarkupContent(13, @"<path d=""M6.4 3.9A2 2 0 0 1 8.08 3h7.86a2 2 0 0 1 1.66.9L19.66 7A2 2 0 0 1 20 8.1V11a1 1 0 0 1-1 1h-.36l.86 2c.83 0 1.5.67 1.5 1.5v4c0 .83-.67 1.5-1.5 1.5h-15A1.5 1.5 0 0 1 3 19.5v-4c0-.83.67-1.5 1.5-1.5l.86-2H5a1 1 0 0 1-1-1V8.1A2 2 0 0 1 4.34 7L6.4 3.9ZM6 10.5l.86-2H5.5v2H6Zm9.51-2H8.5l-2.34 5.45.03.05h11.64l.03-.05L15.5 8.5Zm1.63 0 .86 2h.5v-2h-1.36Zm-6.89 8.25a.75.75 0 0 0 0 1.5h3.5a.75.75 0 0 0 0-1.5h-3.5Z""/>");
