...
{
    /// <summary>
    /// FlCloudArchiveFilled icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class FlCloudArchiveFilled : ComponentBase
    {
        /// <summary>
