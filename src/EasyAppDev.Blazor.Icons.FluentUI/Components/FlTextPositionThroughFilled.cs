...
{
    /// <summary>
    /// FlTextPositionThroughFilled icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class FlTextPositionThroughFilled : ComponentBase
    {
        /// <summary>
