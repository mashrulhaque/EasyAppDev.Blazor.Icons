...
{
    /// <summary>
    /// FlTableSimpleExcludeFilled icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class FlTableSimpleExcludeFilled : ComponentBase
    {
        /// <summary>
        ...
        protected override void BuildRenderTree(RenderTreeBuilder builder)
        {
            ...
            // Inline SVG content
            builder.AddMarkupContent(13, @"<path d=""M5.25 2H9.5v7.5H2V5.25C2 3.45 3.46 2 5.25 2ZM2 11v4.25c0 1.8 1.46 3.25 3.25 3.25H9.5V11H2Zm16.5-1.5V5.25c0-1.8-1.46-3.25-3.25-3.25H11v7.5h7.5Zm-6 5.25c0-1.24 1-2.25 2.25-2.25h5c1.24 0 2.25 1 2.25 2.25v5c0 1.24-1 2.25-2.25 2.25h-5c-1.24 0-2.25-1-2.25-2.25v-5Z""/>");
