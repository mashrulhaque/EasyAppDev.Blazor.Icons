...
{
    /// <summary>
    /// FlTextIndentIncreaseLtrRotate270Filled icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class FlTextIndentIncreaseLtrRotate270Filled : ComponentBase
    {
        /// <summary>
        ...
        protected override void BuildRenderTree(RenderTreeBuilder builder)
        {
            ...
            // Inline SVG content
            builder.AddMarkupContent(13, @"<path d=""M16 15V6.5a1 1 0 0 1 2-.12V15a1 1 0 0 1-2 .12V15Zm-6.7 6.7a1 1 0 0 1-.09-1.31l.08-.1 2-2a1 1 0 0 1 1.32-.08l.1.08 2 2a1 1 0 0 1-1.32 1.5l-.1-.08L12 20.4l-1.3 1.3a1 1 0 0 1-1.4 0ZM11 15V3.5a1 1 0 0 1 2-.12V15a1 1 0 0 1-2 .12V15Zm-5 0V6.5a1 1 0 0 1 2-.12V15a1 1 0 0 1-2 .12V15Z""/>");
