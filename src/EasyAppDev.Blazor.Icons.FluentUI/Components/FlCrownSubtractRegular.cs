...
{
    /// <summary>
    /// FlCrownSubtractRegular icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class FlCrownSubtractRegular : ComponentBase
    {
        /// <summary>
        ...
        protected override void BuildRenderTree(RenderTreeBuilder builder)
        {
            ...
            // Inline SVG content
            builder.AddMarkupContent(13, @"<path d=""M13.46 6.37A2 2 0 0 0 12 3a2 2 0 0 0-1.46 3.37L7.92 9.65c-.07.1-.2.12-.3.07L4.95 8.39A2.01 2.01 0 0 0 3 6a2 2 0 0 0-.44 3.95l1.8 9.62c.16.83.88 1.43 1.72 1.43h5.94c-.3-.46-.53-.97-.7-1.5H6.07a.25.25 0 0 1-.25-.2L4.03 9.7l.1-.06 2.81 1.4c.74.38 1.64.18 2.15-.46L11.96 7a2.04 2.04 0 0 0 .08 0l2.87 3.59c.25.32.6.53.98.61.4-.1.83-.17 1.27-.2l2.71-1.35.1.06-.32 1.65c.5.18.97.41 1.4.7l.4-2.11a2 2 0 1 0-2.41-1.56l-2.65 1.33a.25.25 0 0 1-.3-.07l-2.63-3.28ZM23 17.5a5.5 5.5 0 1 1-11 0 5.5 5.5 0 0 1 11 0Zm-9 0c0 .28.22.5.5.5h6a.5.5 0 0 0 0-1h-6a.5.5 0 0 0-.5.5Z""/>");
