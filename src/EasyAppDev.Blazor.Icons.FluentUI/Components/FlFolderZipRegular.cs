...
{
    /// <summary>
    /// FlFolderZipRegular icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class FlFolderZipRegular : ComponentBase
    {
        /// <summary>
        ...
        protected override void BuildRenderTree(RenderTreeBuilder builder)
        {
            ...
            // Inline SVG content
            builder.AddMarkupContent(13, @"<path d=""M8.13 3c.6 0 1.17.24 1.59.66l1.84 1.84h7.19c1.8 0 3.25 1.46 3.25 3.25v9a3.25 3.25 0 0 1-3 3.24v1.4l-.01.12a.62.62 0 0 1-.48.48l-.13.01h-4.76a.62.62 0 0 1-.6-.5l-.02-.12V21H5.25A3.25 3.25 0 0 1 2 17.75V6.25C2 4.45 3.46 3 5.25 3h2.88ZM16 16.5c-.83 0-1.5.67-1.5 1.5v3.5h3V18c0-.83-.67-1.5-1.5-1.5ZM9.72 8.84c-.42.42-1 .66-1.6.66H3.5v8.25c0 .97.78 1.75 1.75 1.75H13V18a3 3 0 0 1 1.34-2.5h-.59a.75.75 0 0 1 0-1.5H16v1a3 3 0 0 1 3 3v1.48c.85-.12 1.5-.85 1.5-1.73v-9c0-.97-.78-1.75-1.75-1.75h-7.19L9.72 8.84Zm8.53 3.66a.75.75 0 0 1 0 1.5H16v-1.5h2.25Zm-2.25 0h-2.25a.75.75 0 0 1 0-1.5H16v1.5Zm2.25-3a.75.75 0 0 1 0 1.5H16V9.5h2.25ZM16 9.5h-2.25a.75.75 0 0 1 0-1.5H16v1.5Zm-10.75-5c-.97 0-1.75.78-1.75 1.75V8h4.63c.2 0 .39-.08.53-.22l1.53-1.53-1.53-1.53a.75.75 0 0 0-.53-.22H5.25Z""/>");
