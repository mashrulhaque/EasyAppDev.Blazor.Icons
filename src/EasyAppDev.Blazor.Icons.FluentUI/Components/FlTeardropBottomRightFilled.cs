...
{
    /// <summary>
    /// FlTeardropBottomRightFilled icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class FlTeardropBottomRightFilled : ComponentBase
    {
        /// <summary>
        ...
        protected override void BuildRenderTree(RenderTreeBuilder builder)
        {
            ...
            // Inline SVG content
            builder.AddMarkupContent(13, @"<path d=""M2 12a10 10 0 1 1 20 0v7.75c0 1.24-1 2.25-2.25 2.25H12A10 10 0 0 1 2 12Z""/>");
