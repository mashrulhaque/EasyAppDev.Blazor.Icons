...
{
    /// <summary>
    /// FlDualScreenStatusBarFilled icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class FlDualScreenStatusBarFilled : ComponentBase
    {
        /// <summary>
        ...
        protected override void BuildRenderTree(RenderTreeBuilder builder)
        {
            ...
            // Inline SVG content
            builder.AddMarkupContent(13, @"<path d=""M20.25 4C21.2 4 22 4.8 22 5.75v12.5c0 .97-.79 1.75-1.75 1.75H13c-.09 0-.17 0-.26-.02V4.02L13 4h7.25ZM11 4c.08 0 .16 0 .24.02v15.96L11 20H3.75C2.78 20 2 19.2 2 18.25V5.75C2 4.8 2.78 4 3.75 4H11Zm8.75 2.5h-4.5a.75.75 0 0 0-.1 1.5h4.6a.75.75 0 0 0 .1-1.5h-.1Z""/>");
