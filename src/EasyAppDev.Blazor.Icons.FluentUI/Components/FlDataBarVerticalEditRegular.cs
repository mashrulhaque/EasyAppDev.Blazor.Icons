...
{
    /// <summary>
    /// FlDataBarVerticalEditRegular icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class FlDataBarVerticalEditRegular : ComponentBase
    {
        /// <summary>
        ...
        protected override void BuildRenderTree(RenderTreeBuilder builder)
        {
            ...
            // Inline SVG content
            builder.AddMarkupContent(13, @"<path d=""M19.1 12.67a2.29 2.29 0 0 1 3.23 3.23l-5.9 5.9c-.34.35-.78.6-1.25.71l-1.83.46c-.8.2-1.52-.52-1.32-1.32l.46-1.83c.12-.47.36-.9.7-1.25l5.91-5.9ZM5.25 11c1.24 0 2.25 1 2.25 2.25v5.5a2.25 2.25 0 0 1-4.5 0v-5.5C3 12 4 11 5.25 11Zm6.5-4C12.99 7 14 8 14 9.25v7.1l-1.5 1.5v-8.6a.75.75 0 1 0-1.5 0v9.5c0 .35.23.63.55.72 0 .04-.02.07-.03.1l-.34 1.35a2.25 2.25 0 0 1-1.68-2.17v-9.5C9.5 8 10.5 7 11.75 7Zm-6.5 5.5a.75.75 0 0 0-.75.75v5.5a.75.75 0 0 0 1.5 0v-5.5a.75.75 0 0 0-.75-.75Zm13-9.5c1.24 0 2.25 1 2.25 2.25V11c-.52.03-1.04.2-1.5.48V5.25a.75.75 0 1 0-1.5 0v7.6l-1.5 1.5v-9.1C16 4 17 3 18.25 3Z""/>");
