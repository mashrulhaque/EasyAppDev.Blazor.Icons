...
{
    /// <summary>
    /// FlVehicleSubwayRegular icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class FlVehicleSubwayRegular : ComponentBase
    {
        /// <summary>
