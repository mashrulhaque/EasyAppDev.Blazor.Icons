...
{
    /// <summary>
    /// FlSpeakerSettingsRegular icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class FlSpeakerSettingsRegular : ComponentBase
    {
        /// <summary>
