...
{
    /// <summary>
    /// FlWifi2Filled icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class FlWifi2Filled : ComponentBase
    {
        /// <summary>
        ...
        protected override void BuildRenderTree(RenderTreeBuilder builder)
        {
            ...
            // Inline SVG content
            builder.AddMarkupContent(13, @"<path d=""M10.96 16.44a1.5 1.5 0 1 1 2.12 2.12 1.5 1.5 0 0 1-2.12-2.12Zm-2.6-2.74a5.23 5.23 0 0 1 8.5 1.62 1 1 0 1 1-1.83.8 3.23 3.23 0 0 0-5.93-.01 1 1 0 1 1-1.83-.8c.26-.6.63-1.15 1.09-1.61Zm-2.05-3a8.13 8.13 0 0 1 13 2.1 1 1 0 1 1-1.78.9 6.13 6.13 0 0 0-10.94-.02 1 1 0 1 1-1.78-.9c.38-.76.88-1.46 1.5-2.07Z""/>");
