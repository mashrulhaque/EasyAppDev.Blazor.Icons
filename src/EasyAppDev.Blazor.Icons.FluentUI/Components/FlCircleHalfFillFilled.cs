...
{
    /// <summary>
    /// FlCircleHalfFillFilled icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class FlCircleHalfFillFilled : ComponentBase
    {
        /// <summary>
        ...
        protected override void BuildRenderTree(RenderTreeBuilder builder)
        {
            ...
            // Inline SVG content
            builder.AddMarkupContent(13, @"<path d=""M4 12a8 8 0 1 1 16 0H4Zm8-10a10 10 0 1 0 0 20 10 10 0 0 0 0-20Z""/>");
