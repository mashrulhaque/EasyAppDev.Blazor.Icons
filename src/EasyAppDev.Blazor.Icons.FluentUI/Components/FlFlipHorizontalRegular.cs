...
{
    /// <summary>
    /// FlFlipHorizontalRegular icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class FlFlipHorizontalRegular : ComponentBase
    {
        /// <summary>
        ...
        protected override void BuildRenderTree(RenderTreeBuilder builder)
        {
            ...
            // Inline SVG content
            builder.AddMarkupContent(13, @"<path d=""M21.88 19.66a.75.75 0 0 1-.63.34h-7.5a.75.75 0 0 1-.75-.75V2.75a.75.75 0 0 1 1.43-.31l7.5 16.5c.1.23.09.5-.05.72ZM14.5 6.2V18.5h5.59L14.5 6.21ZM2.5 20a.5.5 0 0 1-.45-.71l8-17a.5.5 0 0 1 .95.21v17a.5.5 0 0 1-.5.5h-8Z""/>");
