...
{
    /// <summary>
    /// FlCardUiPortraitFlipFilled icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class FlCardUiPortraitFlipFilled : ComponentBase
    {
        /// <summary>
        ...
        protected override void BuildRenderTree(RenderTreeBuilder builder)
        {
            ...
            // Inline SVG content
            builder.AddMarkupContent(13, @"<path d=""M4 4.75A2.75 2.75 0 0 1 6.75 2h10.5A2.75 2.75 0 0 1 20 4.75V10h-.75a1.75 1.75 0 0 0-1.14 3.08A12.46 12.46 0 0 1 12 14.5c-2.75 0-4.74-.67-6.1-1.42A1.75 1.75 0 0 0 4.74 10H4V4.75ZM12 18c3.5 0 6.12-.9 8-1.97v3.22A2.75 2.75 0 0 1 17.25 22H6.75A2.75 2.75 0 0 1 4 19.25v-3.22A15.84 15.84 0 0 0 12 18ZM8.75 6a.75.75 0 0 0 0 1.5h6.5a.75.75 0 0 0 0-1.5h-6.5ZM8 10.75c0 .41.34.75.75.75h4.5a.75.75 0 0 0 0-1.5h-4.5a.75.75 0 0 0-.75.75ZM1.75 11a.75.75 0 0 0-.75.75v3a.75.75 0 0 0 1.5 0v-1.03c.32.29.7.6 1.14.9C5.38 15.82 8.09 17 12 17c3.91 0 6.62-1.18 8.36-2.38.44-.3.82-.61 1.14-.9v1.03a.75.75 0 0 0 1.5 0v-3a.75.75 0 0 0-.75-.75h-3a.75.75 0 0 0 0 1.5h1.36c-.3.28-.66.58-1.1.88-1.5 1.05-3.92 2.12-7.51 2.12s-6-1.07-7.51-2.12c-.44-.3-.8-.6-1.1-.88h1.36a.75.75 0 0 0 0-1.5h-3Z""/>");
