...
{
    /// <summary>
    /// FlWindowDatabaseFilled icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class FlWindowDatabaseFilled : ComponentBase
    {
        /// <summary>
