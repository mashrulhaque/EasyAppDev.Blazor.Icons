...
{
    /// <summary>
    /// FlTextboxRotate90Regular icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class FlTextboxRotate90Regular : ComponentBase
    {
        /// <summary>
