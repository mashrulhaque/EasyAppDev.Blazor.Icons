...
{
    /// <summary>
    /// FlFps30Regular icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class FlFps30Regular : ComponentBase
    {
        /// <summary>
