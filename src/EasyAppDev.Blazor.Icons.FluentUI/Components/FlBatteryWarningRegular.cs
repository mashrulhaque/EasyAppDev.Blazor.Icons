...
{
    /// <summary>
    /// FlBatteryWarningRegular icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class FlBatteryWarningRegular : ComponentBase
    {
        /// <summary>
        ...
        protected override void BuildRenderTree(RenderTreeBuilder builder)
        {
            ...
            // Inline SVG content
            builder.AddMarkupContent(13, @"<path d=""M8.24 11.2c.24.13.43.32.56.56l4 7A1.5 1.5 0 0 1 11.5 21H3.5a1.5 1.5 0 0 1-1.3-2.25l4-7a1.5 1.5 0 0 1 2.05-.55ZM7.5 18a.5.5 0 1 0 0 1 .5.5 0 0 0 0-1ZM17 6a3 3 0 0 1 3 3v1h1a1 1 0 0 1 1 1v2a1 1 0 0 1-1 1h-1v1a3 3 0 0 1-3 3h-3.47l-.86-1.5H17c.78 0 1.42-.6 1.5-1.36V9c0-.78-.6-1.42-1.36-1.5H5c-.78 0-1.42.6-1.5 1.36v5.59l-1.14 1.98A2.99 2.99 0 0 1 2 15V9a3 3 0 0 1 3-3h12Zm-9.5 7a.5.5 0 0 0-.5.41V16.59a.5.5 0 0 0 .99 0V13.41a.5.5 0 0 0-.5-.41Z""/>");
