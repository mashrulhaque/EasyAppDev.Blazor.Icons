...
{
    /// <summary>
    /// FlTableOffsetRegular icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class FlTableOffsetRegular : ComponentBase
    {
        /// <summary>
        ...
        protected override void BuildRenderTree(RenderTreeBuilder builder)
        {
            ...
            // Inline SVG content
            builder.AddMarkupContent(13, @"<path d=""M6.25 3A3.25 3.25 0 0 0 3 6.25v11.5C3 19.55 4.46 21 6.25 21h11.5c1.8 0 3.25-1.46 3.25-3.25V6.25C21 4.45 19.54 3 17.75 3H6.25ZM4.5 6.25c0-.97.78-1.75 1.75-1.75H14v4H4.5V6.25Zm0 3.75h4v4h-4v-4Zm5.5 0h9.5v4H10v-4Zm9.5-1.5h-4v-4h2.25c.97 0 1.75.78 1.75 1.75V8.5Zm-4 7h4v2.25c0 .97-.78 1.75-1.75 1.75H15.5v-4Zm-11 2.25V15.5H14v4H6.25c-.97 0-1.75-.78-1.75-1.75Z""/>");
