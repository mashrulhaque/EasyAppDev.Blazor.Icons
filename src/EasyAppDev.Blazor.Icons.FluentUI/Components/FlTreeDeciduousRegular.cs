...
{
    /// <summary>
    /// FlTreeDeciduousRegular icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class FlTreeDeciduousRegular : ComponentBase
    {
        /// <summary>
        ...
        protected override void BuildRenderTree(RenderTreeBuilder builder)
        {
            ...
            // Inline SVG content
            builder.AddMarkupContent(13, @"<path d=""M12 2a4.25 4.25 0 0 0-4 2.82 4.25 4.25 0 0 0-3.37 5.24A4.25 4.25 0 0 0 6.5 18h3v2.25c0 .97.78 1.75 1.75 1.75h1.5c.97 0 1.75-.78 1.75-1.75V18h3c.06 0 .12 0 .18-.02a4.25 4.25 0 0 0 1.69-7.92A4.26 4.26 0 0 0 16 4.82 4.25 4.25 0 0 0 12 2Zm1 16v2.25c0 .14-.11.25-.25.25h-1.5a.25.25 0 0 1-.25-.25V18h2Zm-6.39-1.5h-.06a2.75 2.75 0 0 1-.73-5.34.75.75 0 0 0 .43-1.02 2.75 2.75 0 0 1 2.37-3.89.75.75 0 0 0 .7-.59 2.75 2.75 0 0 1 5.37 0c.07.33.36.58.7.6a2.75 2.75 0 0 1 2.36 3.88.75.75 0 0 0 .43 1.02 2.75 2.75 0 0 1-.8 5.34H6.62Z""/>");
