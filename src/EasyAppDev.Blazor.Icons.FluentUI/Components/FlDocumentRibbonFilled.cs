...
{
    /// <summary>
    /// FlDocumentRibbonFilled icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class FlDocumentRibbonFilled : ComponentBase
    {
        /// <summary>
        ...
        protected override void BuildRenderTree(RenderTreeBuilder builder)
        {
            ...
            // Inline SVG content
            builder.AddMarkupContent(13, @"<path d=""M12 2v6c0 1.1.9 2 2 2h6v10a2 2 0 0 1-2 2H9v-3.67a4.5 4.5 0 0 0-5-7.07V4c0-1.1.9-2 2-2h6Zm1.5.5V8c0 .28.22.5.5.5h5.5l-6-6ZM9 15.5a3.5 3.5 0 1 1-7 0 3.5 3.5 0 0 1 7 0Zm-6 3.74v3.05c0 .63.76.95 1.21.5L5.5 21.5l1.29 1.3A.71.71 0 0 0 8 22.28v-3.05a4.48 4.48 0 0 1-5 0Z""/>");
