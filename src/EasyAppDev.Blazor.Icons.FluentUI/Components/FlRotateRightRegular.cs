...
{
    /// <summary>
    /// FlRotateRightRegular icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class FlRotateRightRegular : ComponentBase
    {
        /// <summary>
