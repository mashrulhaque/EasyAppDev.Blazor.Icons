...
{
    /// <summary>
    /// FlCalendarEyeFilled icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class FlCalendarEyeFilled : ComponentBase
    {
        /// <summary>
