...
{
    /// <summary>
    /// FlCalendarChatRegular icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class FlCalendarChatRegular : ComponentBase
    {
        /// <summary>
        ...
        protected override void BuildRenderTree(RenderTreeBuilder builder)
        {
            ...
            // Inline SVG content
            builder.AddMarkupContent(13, @"<path d=""M17.75 3C19.55 3 21 4.46 21 6.25v5.77c-.46-.3-.97-.53-1.5-.7V8.5h-15v9.25c0 .97.78 1.75 1.75 1.75h5.06c.09.26.19.52.3.76l-.22.74H6.25A3.25 3.25 0 0 1 3 17.75V6.25C3 4.45 4.46 3 6.25 3h11.5Zm0 1.5H6.25c-.97 0-1.75.78-1.75 1.75V7h15v-.75c0-.97-.78-1.75-1.75-1.75Zm1.75 7.87a5.5 5.5 0 1 1-4.67 9.94l-2.18.67a.5.5 0 0 1-.63-.62l.67-2.2A5.5 5.5 0 0 1 17.48 12l.02.01c.7 0 1.38.13 2 .37Zm0 4.63a.5.5 0 1 0 0-1h-4a.5.5 0 1 0 0 1h4Zm-4 2h2a.5.5 0 1 0 0-1h-2a.5.5 0 1 0 0 1Z""/>");
