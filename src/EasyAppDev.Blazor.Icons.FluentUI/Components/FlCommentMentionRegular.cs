...
{
    /// <summary>
    /// FlCommentMentionRegular icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class FlCommentMentionRegular : ComponentBase
    {
        /// <summary>
