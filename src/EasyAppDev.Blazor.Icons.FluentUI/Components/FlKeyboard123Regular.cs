...
{
    /// <summary>
    /// FlKeyboard123Regular icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class FlKeyboard123Regular : ComponentBase
    {
        /// <summary>
