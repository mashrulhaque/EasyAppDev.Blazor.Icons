...
{
    /// <summary>
    /// FlSkipForward10Filled icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class FlSkipForward10Filled : ComponentBase
    {
        /// <summary>
