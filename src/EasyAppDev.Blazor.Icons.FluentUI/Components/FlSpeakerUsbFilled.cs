...
{
    /// <summary>
    /// FlSpeakerUsbFilled icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class FlSpeakerUsbFilled : ComponentBase
    {
        /// <summary>
        ...
        protected override void BuildRenderTree(RenderTreeBuilder builder)
        {
            ...
            // Inline SVG content
            builder.AddMarkupContent(13, @"<path d=""M15 4.25a1.25 1.25 0 0 0-2.06-.96L7.98 7.5H4.25C3.01 7.5 2 8.52 2 9.76v4.5c0 1.24 1 2.25 2.25 2.25h3.73l4.96 4.2a1.25 1.25 0 0 0 2.06-.95V4.25Zm1.16 9.7L17.5 16v2a1 1 0 0 0 1 1h2a1 1 0 0 0 1-1v-2l1.33-2a1 1 0 0 0 .17-.56V10a1 1 0 0 0-1-1V7a1 1 0 0 0-1-1h-3a1 1 0 0 0-1 1v2a1 1 0 0 0-1 1v3.4c0 .2.06.4.16.55ZM18.5 7.5h2V9h-2V7.5Z""/>");
