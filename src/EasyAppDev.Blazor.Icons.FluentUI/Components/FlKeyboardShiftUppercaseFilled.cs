...
{
    /// <summary>
    /// FlKeyboardShiftUppercaseFilled icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class FlKeyboardShiftUppercaseFilled : ComponentBase
    {
        /// <summary>
        ...
        protected override void BuildRenderTree(RenderTreeBuilder builder)
        {
            ...
            // Inline SVG content
            builder.AddMarkupContent(13, @"<path d=""M13.32 2.6c-.7-.8-1.95-.8-2.64 0l-8.25 9.5A1.75 1.75 0 0 0 3.75 15H7v2.25c0 .97.78 1.75 1.75 1.75h6.5c.97 0 1.75-.78 1.75-1.75V15h3.24c1.5 0 2.3-1.76 1.33-2.9l-8.25-9.5ZM7.75 20.5a.75.75 0 0 0 0 1.5h8.5a.75.75 0 0 0 0-1.5h-8.5Z""/>");
