...
{
    /// <summary>
    /// FlArrowMinimizeVerticalRegular icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class FlArrowMinimizeVerticalRegular : ComponentBase
    {
        /// <summary>
