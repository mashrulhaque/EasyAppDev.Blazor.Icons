...
{
    /// <summary>
    /// FlPeopleSyncColor icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class FlPeopleSyncColor : ComponentBase
    {
        /// <summary>
