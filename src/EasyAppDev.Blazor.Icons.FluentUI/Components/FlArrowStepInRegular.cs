...
{
    /// <summary>
    /// FlArrowStepInRegular icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class FlArrowStepInRegular : ComponentBase
    {
        /// <summary>
        ...
        protected override void BuildRenderTree(RenderTreeBuilder builder)
        {
            ...
            // Inline SVG content
            builder.AddMarkupContent(13, @"<path d=""M12 2c.41 0 .75.34.75.75v9.26l3.48-3.3a.75.75 0 1 1 1.04 1.08l-4.75 4.5a.75.75 0 0 1-1.04 0L6.73 9.8a.75.75 0 0 1 1.04-1.08l3.48 3.3V2.75c0-.41.34-.75.75-.75Zm0 20a3 3 0 1 0 0-6 3 3 0 0 0 0 6Zm0-1.5a1.5 1.5 0 1 1 0-3 1.5 1.5 0 0 1 0 3Z""/>");
