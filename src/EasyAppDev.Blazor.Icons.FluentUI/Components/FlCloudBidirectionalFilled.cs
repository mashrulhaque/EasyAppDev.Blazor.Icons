...
{
    /// <summary>
    /// FlCloudBidirectionalFilled icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class FlCloudBidirectionalFilled : ComponentBase
    {
        /// <summary>
        ...
        protected override void BuildRenderTree(RenderTreeBuilder builder)
        {
            ...
            // Inline SVG content
            builder.AddMarkupContent(13, @"<path d=""M6.08 7.02a6 6 0 0 1 11.84 0A4.5 4.5 0 0 1 17.5 16h-4v-3.17a1.75 1.75 0 0 0 1.99-2.82l-2.5-2.5a1.75 1.75 0 0 0-2.48 0l-2.5 2.5A1.75 1.75 0 0 0 10 12.83V16H6.5a4.5 4.5 0 0 1-.42-8.98Zm8.7 4.76c-.3.3-.77.3-1.06 0l-1.22-1.22v8.88l1.22-1.22a.75.75 0 1 1 1.06 1.06l-2.5 2.5c-.3.3-.77.3-1.06 0l-2.5-2.5a.75.75 0 1 1 1.06-1.06L11 19.44v-8.88l-1.22 1.22a.75.75 0 0 1-1.06-1.06l2.5-2.5c.3-.3.77-.3 1.06 0l2.5 2.5c.3.3.3.77 0 1.06Z""/>");
