...
{
    /// <summary>
    /// FlTextHeader2Filled icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class FlTextHeader2Filled : ComponentBase
    {
        /// <summary>
