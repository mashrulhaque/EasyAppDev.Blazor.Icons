...
{
    /// <summary>
    /// FlGavelFilled icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class FlGavelFilled : ComponentBase
    {
        /// <summary>
