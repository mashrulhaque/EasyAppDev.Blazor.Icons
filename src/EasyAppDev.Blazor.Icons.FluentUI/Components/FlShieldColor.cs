...
{
    /// <summary>
    /// FlShieldColor icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class FlShieldColor : ComponentBase
    {
        /// <summary>
        ...
        protected override void BuildRenderTree(RenderTreeBuilder builder)
        {
            ...
            // Inline SVG content
            builder.AddMarkupContent(13, @"<path d=""M3 5.75c0-.41.34-.75.75-.75 2.66 0 5.26-.94 7.8-2.85.27-.2.63-.2.9 0C14.99 4.05 17.59 5 20.25 5c.41 0 .75.34.75.75V11c0 5-2.96 8.68-8.73 10.95a.75.75 0 0 1-.54 0C5.96 19.68 3 16 3 11V5.75Z"" fill=""url(#paint0_radial_378174_9603)""/><defs><radialGradient id=""paint0_radial_378174_9603"" cx=""0"" cy=""0"" r=""1"" gradientUnits=""userSpaceOnUse"" gradientTransform=""rotate(54.5 6.94 -8.58) scale(47.5993 42.0478)""><stop offset="".34"" stop-color=""#0FAFFF""/><stop offset="".53"" stop-color=""#367AF2""/><stop offset="".68"" stop-color=""#5750E2""/><stop offset="".86"" stop-color=""#CC23D1""/></radialGradient></defs>");
