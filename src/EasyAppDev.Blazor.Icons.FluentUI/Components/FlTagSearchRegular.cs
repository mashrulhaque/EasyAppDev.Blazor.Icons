...
{
    /// <summary>
    /// FlTagSearchRegular icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class FlTagSearchRegular : ComponentBase
    {
        /// <summary>
        ...
        protected override void BuildRenderTree(RenderTreeBuilder builder)
        {
            ...
            // Inline SVG content
            builder.AddMarkupContent(13, @"<path d=""M22 4.25C22 3.01 21 2 19.75 2h-5.47c-.86 0-1.69.34-2.3.95l-8.5 8.51a3.25 3.25 0 0 0 0 4.6l4.47 4.45a3.25 3.25 0 0 0 4.6 0l.1-.1a5.52 5.52 0 0 1-.93-1.19l-.23.23c-.69.68-1.8.68-2.48 0L4.55 15a1.75 1.75 0 0 1-.02-2.46L13.05 4c.32-.33.77-.51 1.23-.51h5.47c.41 0 .75.34.75.75v5.46c0 .47-.18.91-.51 1.24l-.77.77c.44.25.84.56 1.2.92l.63-.63c.6-.61.95-1.44.95-2.3V4.25ZM18.5 7a1.5 1.5 0 1 0-3 0 1.5 1.5 0 0 0 3 0Zm1.67 12.1a4.5 4.5 0 1 0-1.06 1.06l2.61 2.62a.75.75 0 1 0 1.06-1.06l-2.61-2.61Zm-.67-2.6a3 3 0 1 1-6 0 3 3 0 0 1 6 0Z""/>");
