...
{
    /// <summary>
    /// FlTimer3Filled icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class FlTimer3Filled : ComponentBase
    {
        /// <summary>
