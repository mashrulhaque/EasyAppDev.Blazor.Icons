...
{
    /// <summary>
    /// FlHdFilled icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class FlHdFilled : ComponentBase
    {
        /// <summary>
        ...
        protected override void BuildRenderTree(RenderTreeBuilder builder)
        {
            ...
            // Inline SVG content
            builder.AddMarkupContent(13, @"<path d=""M14.5 14.5v-5h.25c.97 0 1.75.78 1.75 1.75v1.5c0 .97-.78 1.75-1.75 1.75h-.25ZM6.25 3A3.25 3.25 0 0 0 3 6.25v11.5C3 19.55 4.46 21 6.25 21h11.5c1.8 0 3.25-1.46 3.25-3.25V6.25C21 4.45 19.54 3 17.75 3H6.25Zm1 5c.41 0 .75.34.75.75v2.75h2V8.75a.75.75 0 0 1 1.5 0v6.5a.75.75 0 0 1-1.5 0V13H8v2.25a.75.75 0 0 1-1.5 0v-6.5c0-.41.34-.75.75-.75Zm6.5 0h1C16.55 8 18 9.46 18 11.25v1.5c0 1.8-1.46 3.25-3.25 3.25h-1a.75.75 0 0 1-.75-.75v-6.5c0-.41.34-.75.75-.75Z""/>");
