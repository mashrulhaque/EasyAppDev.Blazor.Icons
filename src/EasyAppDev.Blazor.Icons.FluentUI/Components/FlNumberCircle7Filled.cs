...
{
    /// <summary>
    /// FlNumberCircle7Filled icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class FlNumberCircle7Filled : ComponentBase
    {
        /// <summary>
        ...
        protected override void BuildRenderTree(RenderTreeBuilder builder)
        {
            ...
            // Inline SVG content
            builder.AddMarkupContent(13, @"<path d=""M22 12a10 10 0 1 1-20 0 10 10 0 0 1 20 0Zm-10.88 5.49.13.01v.01c.36 0 .68-.25.74-.62.86-5.12 3.8-8.61 3.83-8.64a.75.75 0 0 0-.57-1.24h-6.5a.76.76 0 0 0-.75.75c0 .41.34.75.75.75h5.01a21.24 21.24 0 0 0-3.26 8.12c-.06.4.21.79.62.86Z""/>");
