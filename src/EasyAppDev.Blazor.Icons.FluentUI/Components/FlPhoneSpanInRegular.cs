...
{
    /// <summary>
    /// FlPhoneSpanInRegular icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class FlPhoneSpanInRegular : ComponentBase
    {
        /// <summary>
