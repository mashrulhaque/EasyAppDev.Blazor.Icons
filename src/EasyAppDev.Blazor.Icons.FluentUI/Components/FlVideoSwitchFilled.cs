...
{
    /// <summary>
    /// FlVideoSwitchFilled icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class FlVideoSwitchFilled : ComponentBase
    {
        /// <summary>
