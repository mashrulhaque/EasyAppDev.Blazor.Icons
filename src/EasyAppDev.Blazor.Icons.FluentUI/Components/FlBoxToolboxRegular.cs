...
{
    /// <summary>
    /// FlBoxToolboxRegular icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class FlBoxToolboxRegular : ComponentBase
    {
        /// <summary>
