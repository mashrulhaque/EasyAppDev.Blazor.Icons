...
{
    /// <summary>
    /// FlAnimalDogRegular icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class FlAnimalDogRegular : ComponentBase
    {
        /// <summary>
