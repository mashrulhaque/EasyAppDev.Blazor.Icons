...
{
    /// <summary>
    /// FlWalletCreditCardRegular icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class FlWalletCreditCardRegular : ComponentBase
    {
        /// <summary>
