...
{
    /// <summary>
    /// FlPhoneScreenTimeFilled icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class FlPhoneScreenTimeFilled : ComponentBase
    {
        /// <summary>
