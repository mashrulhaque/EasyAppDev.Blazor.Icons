...
{
    /// <summary>
    /// FlDocumentBorderPrintRegular icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class FlDocumentBorderPrintRegular : ComponentBase
    {
        /// <summary>
        ...
        protected override void BuildRenderTree(RenderTreeBuilder builder)
        {
            ...
            // Inline SVG content
            builder.AddMarkupContent(13, @"<path d=""M7.25 2A3.25 3.25 0 0 0 4 5.25v13.5C4 20.55 5.46 22 7.25 22h5.85a2.74 2.74 0 0 1-.09-.5H13a2 2 0 0 1-1.73-1H7.25c-.97 0-1.75-.78-1.75-1.75V5.25c0-.97.78-1.75 1.75-1.75h9.5c.97 0 1.75.78 1.75 1.75V11h.75c.26 0 .51.04.75.1V5.25C20 3.45 18.54 2 16.75 2h-9.5ZM17 6v5h-1.25l-.25.01V6.5h-7v11H11V19H8a1 1 0 0 1-1-1V6a1 1 0 0 1 1-1h8a1 1 0 0 1 1 1Zm-3 7.75c0-.97.78-1.75 1.75-1.75h3.5c.97 0 1.75.78 1.75 1.75v.75h.5c.83 0 1.5.67 1.5 1.5v3.5a1 1 0 0 1-1 1h-1v.75c0 .97-.78 1.75-1.75 1.75h-3.5c-.97 0-1.75-.78-1.75-1.75v-.75h-1a1 1 0 0 1-1-1V16c0-.83.67-1.5 1.5-1.5h.5v-.75Zm5.5 0a.25.25 0 0 0-.25-.25h-3.5a.25.25 0 0 0-.25.25v.75h4v-.75Zm-4 5.5v2c0 .14.11.25.25.25h3.5c.14 0 .25-.11.25-.25v-2a.25.25 0 0 0-.25-.25h-3.5a.25.25 0 0 0-.25.25Z""/>");
