...
{
    /// <summary>
    /// FlTableCellsSplitRegular icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class FlTableCellsSplitRegular : ComponentBase
    {
        /// <summary>
        ...
        protected override void BuildRenderTree(RenderTreeBuilder builder)
        {
            ...
            // Inline SVG content
            builder.AddMarkupContent(13, @"<path d=""M12.5 10H11v4h1.5v-4ZM3 6.25C3 4.45 4.46 3 6.25 3h11.5C19.55 3 21 4.46 21 6.25v11.5c0 1.8-1.46 3.25-3.25 3.25H6.25A3.25 3.25 0 0 1 3 17.75V6.25ZM6.25 4.5c-.97 0-1.75.78-1.75 1.75V7.5H11v-3H6.25Zm13.25 12h-7v3h5.25c.97 0 1.75-.78 1.75-1.75V16.5Zm0-10.25c0-.97-.78-1.75-1.75-1.75H12.5v3h7V6.25ZM4.5 16.5v1.25c0 .97.78 1.75 1.75 1.75H11v-3H4.5Zm0-1.5h15V9h-15v6Z""/>");
