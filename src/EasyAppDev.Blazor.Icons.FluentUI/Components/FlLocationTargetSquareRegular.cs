...
{
    /// <summary>
    /// FlLocationTargetSquareRegular icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class FlLocationTargetSquareRegular : ComponentBase
    {
        /// <summary>
        ...
        protected override void BuildRenderTree(RenderTreeBuilder builder)
        {
            ...
            // Inline SVG content
            builder.AddMarkupContent(13, @"<path d=""M6.25 3A3.25 3.25 0 0 0 3 6.25v11.5C3 19.55 4.46 21 6.25 21h11.5c1.8 0 3.25-1.46 3.25-3.25V6.25C21 4.45 19.54 3 17.75 3H6.25ZM4.5 6.25c0-.97.78-1.75 1.75-1.75h11.5c.97 0 1.75.78 1.75 1.75v11.5c0 .97-.78 1.75-1.75 1.75H6.25c-.97 0-1.75-.78-1.75-1.75V6.25ZM9 12a3 3 0 1 1 6 0 3 3 0 0 1-6 0Zm-1.44-.75h-.81a.75.75 0 0 0 0 1.5h.81a4.5 4.5 0 0 0 3.69 3.69v.81a.75.75 0 0 0 1.5 0v-.81a4.5 4.5 0 0 0 3.69-3.69h.81a.75.75 0 0 0 0-1.5h-.81a4.5 4.5 0 0 0-3.69-3.69v-.81a.75.75 0 0 0-1.5 0v.81a4.5 4.5 0 0 0-3.69 3.69Zm5.94.75a1.5 1.5 0 1 1-3 0 1.5 1.5 0 0 1 3 0Z""/>");
