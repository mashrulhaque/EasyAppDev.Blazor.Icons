...
{
    /// <summary>
    /// FlSkipForward30Filled icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class FlSkipForward30Filled : ComponentBase
    {
        /// <summary>
