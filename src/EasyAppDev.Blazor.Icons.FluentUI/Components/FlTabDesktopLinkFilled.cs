...
{
    /// <summary>
    /// FlTabDesktopLinkFilled icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class FlTabDesktopLinkFilled : ComponentBase
    {
        /// <summary>
