...
{
    /// <summary>
    /// FlCellular3gFilled icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class FlCellular3gFilled : ComponentBase
    {
        /// <summary>
