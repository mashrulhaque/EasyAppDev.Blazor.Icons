...
{
    /// <summary>
    /// FlNextFrameRegular icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class FlNextFrameRegular : ComponentBase
    {
        /// <summary>
        ...
        protected override void BuildRenderTree(RenderTreeBuilder builder)
        {
            ...
            // Inline SVG content
            builder.AddMarkupContent(13, @"<path d=""M5.5 3.75a.75.75 0 0 0-1.5 0v16.5a.75.75 0 0 0 1.5 0V3.75Zm6.24-.44A1.75 1.75 0 0 0 9 4.75v14.5a1.75 1.75 0 0 0 2.75 1.43l10.5-7.3c1-.7 1-2.19-.01-2.88l-10.5-7.2ZM10.5 4.75c0-.2.23-.32.4-.2l10.49 7.19c.14.1.14.31 0 .41l-10.5 7.3c-.16.12-.39 0-.39-.2V4.75Z""/>");
