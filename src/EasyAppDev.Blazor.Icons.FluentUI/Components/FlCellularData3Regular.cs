...
{
    /// <summary>
    /// FlCellularData3Regular icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class FlCellularData3Regular : ComponentBase
    {
        /// <summary>
        ...
        protected override void BuildRenderTree(RenderTreeBuilder builder)
        {
            ...
            // Inline SVG content
            builder.AddMarkupContent(13, @"<path d=""M3.75 17c.38 0 .7.28.74.65l.01.1v1.5a.75.75 0 0 1-1.5.1v-1.6c0-.41.34-.75.75-.75Zm8-6c.38 0 .7.28.74.65l.01.1v7.5a.75.75 0 0 1-1.5.1v-7.6c0-.41.34-.75.75-.75Zm-4 3c.38 0 .7.28.74.65l.01.1v4.5a.75.75 0 0 1-1.5.1v-4.6c0-.41.34-.75.75-.75Z""/>");
