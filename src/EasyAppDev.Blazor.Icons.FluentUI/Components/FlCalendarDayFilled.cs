...
{
    /// <summary>
    /// FlCalendarDayFilled icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class FlCalendarDayFilled : ComponentBase
    {
        /// <summary>
        ...
        protected override void BuildRenderTree(RenderTreeBuilder builder)
        {
            ...
            // Inline SVG content
            builder.AddMarkupContent(13, @"<path d=""M17.75 3C19.55 3 21 4.46 21 6.25v11.5c0 1.8-1.46 3.25-3.25 3.25H6.25A3.25 3.25 0 0 1 3 17.75V6.25C3 4.45 4.46 3 6.25 3h11.5Zm-1.5 8h-8.5c-.38 0-.7.28-.74.65l-.01.1v4.5c0 .38.28.7.65.74l.1.01h8.5c.38 0 .7-.28.74-.65l.01-.1v-4.5c0-.38-.28-.7-.65-.74l-.1-.01Zm-.75 1.5v3h-7v-3h7Zm.75-5.25h-8.5a.75.75 0 0 0 0 1.5h8.5a.75.75 0 0 0 0-1.5Z""/>");
