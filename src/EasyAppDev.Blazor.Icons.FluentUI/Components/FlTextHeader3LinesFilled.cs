...
{
    /// <summary>
    /// FlTextHeader3LinesFilled icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class FlTextHeader3LinesFilled : ComponentBase
    {
        /// <summary>
