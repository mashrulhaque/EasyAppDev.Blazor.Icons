...
{
    /// <summary>
    /// FlLayoutCellFourFilled icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class FlLayoutCellFourFilled : ComponentBase
    {
        /// <summary>
        ...
        protected override void BuildRenderTree(RenderTreeBuilder builder)
        {
            ...
            // Inline SVG content
            builder.AddMarkupContent(13, @"<path d=""M17.75 21h-5v-8.25H21v5c0 1.8-1.46 3.25-3.25 3.25ZM21 11.25h-8.25V3h5C19.55 3 21 4.46 21 6.25v5Zm-9.75 0V3h-5A3.25 3.25 0 0 0 3 6.25v5h8.25ZM3 12.75v5C3 19.55 4.46 21 6.25 21h5v-8.25H3Z""/>");
