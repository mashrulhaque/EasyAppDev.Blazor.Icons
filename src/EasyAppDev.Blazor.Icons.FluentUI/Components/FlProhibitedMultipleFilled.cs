...
{
    /// <summary>
    /// FlProhibitedMultipleFilled icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class FlProhibitedMultipleFilled : ComponentBase
    {
        /// <summary>
        ...
        protected override void BuildRenderTree(RenderTreeBuilder builder)
        {
            ...
            // Inline SVG content
            builder.AddMarkupContent(13, @"<path d=""M6.05 6.05a7 7 0 0 1 9.14-.66l-9.8 9.8a7 7 0 0 1 .66-9.14Zm.76 10.56 9.8-9.8a7 7 0 0 1-9.8 9.8ZM17.36 4.64A9 9 0 1 0 4.64 17.36 9 9 0 0 0 17.36 4.64ZM21 11a10 10 0 0 1-12.83 9.6A9 9 0 0 0 20.6 8.16c.26.9.4 1.85.4 2.83Z""/>");
