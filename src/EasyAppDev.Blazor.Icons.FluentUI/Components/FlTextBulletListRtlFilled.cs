...
{
    /// <summary>
    /// FlTextBulletListRtlFilled icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class FlTextBulletListRtlFilled : ComponentBase
    {
        /// <summary>
        ...
        protected override void BuildRenderTree(RenderTreeBuilder builder)
        {
            ...
            // Inline SVG content
            builder.AddMarkupContent(13, @"<path d=""M20.5 16.5a1.5 1.5 0 1 0 0 3 1.5 1.5 0 0 0 0-3Zm-4 .5H3a1 1 0 0 0-.12 2H16.5a1 1 0 0 0 .12-2h-.12Zm4-6.5a1.5 1.5 0 1 0 0 3 1.5 1.5 0 0 0 0-3Zm-4 .5H3a1 1 0 0 0-.12 2H16.5a1 1 0 0 0 .12-2h-.12Zm4-6.5a1.5 1.5 0 1 0 0 3 1.5 1.5 0 0 0 0-3Zm-4 .5H3a1 1 0 0 0-.12 2H16.5a1 1 0 0 0 .12-2h-.12Z""/>");
