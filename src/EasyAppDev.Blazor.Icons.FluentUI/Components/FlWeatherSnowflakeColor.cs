...
{
    /// <summary>
    /// FlWeatherSnowflakeColor icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class FlWeatherSnowflakeColor : ComponentBase
    {
        /// <summary>
