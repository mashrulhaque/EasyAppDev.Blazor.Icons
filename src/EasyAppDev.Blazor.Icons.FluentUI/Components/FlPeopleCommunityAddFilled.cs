...
{
    /// <summary>
    /// FlPeopleCommunityAddFilled icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class FlPeopleCommunityAddFilled : ComponentBase
    {
        /// <summary>
        ...
        protected override void BuildRenderTree(RenderTreeBuilder builder)
        {
            ...
            // Inline SVG content
            builder.AddMarkupContent(13, @"<path d=""M8.75 6.25a3.25 3.25 0 1 1 6.5 0 3.25 3.25 0 0 1-6.5 0ZM5 5a3 3 0 1 0 0 6 3 3 0 0 0 0-6Zm14 0a3 3 0 1 0 0 6 3 3 0 0 0 0-6Zm-9.75 6c-.97 0-1.75.78-1.75 1.75v3.75A4.5 4.5 0 0 0 12 21h.02a6.5 6.5 0 0 1 3.65-9.74 1.74 1.74 0 0 0-.92-.26h-5.5Zm-2.64.98c-.07.24-.11.5-.11.77v3.75c0 1.72.8 3.26 2.03 4.27a4.5 4.5 0 0 1-5.76-3.1L2.06 15c-.25-.94.3-1.9 1.24-2.14l3.31-.9ZM23 17.5a5.5 5.5 0 1 0-11 0 5.5 5.5 0 0 0 11 0Zm-5 .5v2.5a.5.5 0 1 1-1 0V18h-2.5a.5.5 0 0 1 0-1H17v-2.5a.5.5 0 1 1 1 0V17h2.5a.5.5 0 0 1 0 1H18Z""/>");
