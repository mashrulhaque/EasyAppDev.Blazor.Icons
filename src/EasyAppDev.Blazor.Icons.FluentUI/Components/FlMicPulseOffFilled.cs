...
{
    /// <summary>
    /// FlMicPulseOffFilled icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class FlMicPulseOffFilled : ComponentBase
    {
        /// <summary>
