...
{
    /// <summary>
    /// FlKeyCommandFilled icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class FlKeyCommandFilled : ComponentBase
    {
        /// <summary>
