...
{
    /// <summary>
    /// FlSlideEraserFilled icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class FlSlideEraserFilled : ComponentBase
    {
        /// <summary>
        ...
        protected override void BuildRenderTree(RenderTreeBuilder builder)
        {
            ...
            // Inline SVG content
            builder.AddMarkupContent(13, @"<path d=""M4.75 4A2.75 2.75 0 0 0 2 6.75v10.5A2.75 2.75 0 0 0 4.75 20h7.83a2.5 2.5 0 0 1 .17-3.35l4.91-4.92a2.5 2.5 0 0 1 3.54 0l.8.8V6.76A2.75 2.75 0 0 0 19.25 4H4.75Z""/><path d=""M20.5 12.44a1.5 1.5 0 0 0-2.13 0l-3.11 3.11 4.2 4.2 3.12-3.1a1.5 1.5 0 0 0 0-2.12l-2.09-2.09Z""/><path d=""m13.45 17.36 1.1-1.1 4.21 4.2-1.1 1.1a1.5 1.5 0 0 1-2.12 0l-2.09-2.08a1.5 1.5 0 0 1 0-2.12Z""/>");
