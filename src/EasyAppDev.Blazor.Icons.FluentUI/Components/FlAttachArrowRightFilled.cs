...
{
    /// <summary>
    /// FlAttachArrowRightFilled icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class FlAttachArrowRightFilled : ComponentBase
    {
        /// <summary>
