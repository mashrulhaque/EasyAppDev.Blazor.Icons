...
{
    /// <summary>
    /// FlFontDecreaseFilled icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class FlFontDecreaseFilled : ComponentBase
    {
        /// <summary>
        ...
        protected override void BuildRenderTree(RenderTreeBuilder builder)
        {
            ...
            // Inline SVG content
            builder.AddMarkupContent(13, @"<path d=""M16.62 2.22a1 1 0 1 0-1.24 1.56l2.5 2a1 1 0 0 0 1.24 0l2.5-2a1 1 0 0 0-1.24-1.56l-1.88 1.5-1.88-1.5ZM12 4a1 1 0 0 1 .92.6l6 14a1 1 0 0 1-1.84.8L15.2 15H8.8l-1.88 4.4a1 1 0 0 1-1.84-.8l6-14A1 1 0 0 1 12 4Zm0 3.54L9.66 13h4.68L12 7.54Z""/>");
