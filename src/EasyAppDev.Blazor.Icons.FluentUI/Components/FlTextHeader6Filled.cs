...
{
    /// <summary>
    /// FlTextHeader6Filled icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class FlTextHeader6Filled : ComponentBase
    {
        /// <summary>
