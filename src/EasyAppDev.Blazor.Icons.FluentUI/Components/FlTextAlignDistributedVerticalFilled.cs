...
{
    /// <summary>
    /// FlTextAlignDistributedVerticalFilled icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class FlTextAlignDistributedVerticalFilled : ComponentBase
    {
        /// <summary>
        ...
        protected override void BuildRenderTree(RenderTreeBuilder builder)
        {
            ...
            // Inline SVG content
            builder.AddMarkupContent(13, @"<path d=""M19 5.41V21a1 1 0 1 1-2 0V5.41l-.3.3a1 1 0 1 1-1.4-1.42l2-2a1 1 0 0 1 1.4 0l2 2a1 1 0 0 1-1.4 1.42l-.3-.3ZM5 18.6l-.3-.3a1 1 0 0 0-1.4 1.42l2 2a1 1 0 0 0 1.4 0l2-2a1 1 0 1 0-1.4-1.42l-.3.3V3a1 1 0 1 0-2 0v15.59ZM13 3a1 1 0 1 0-2 0v18a1 1 0 1 0 2 0V3Z""/>");
