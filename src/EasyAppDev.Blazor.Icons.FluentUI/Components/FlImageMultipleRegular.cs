...
{
    /// <summary>
    /// FlImageMultipleRegular icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class FlImageMultipleRegular : ComponentBase
    {
        /// <summary>
