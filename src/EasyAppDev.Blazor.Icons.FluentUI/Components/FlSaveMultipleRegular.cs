...
{
    /// <summary>
    /// FlSaveMultipleRegular icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class FlSaveMultipleRegular : ComponentBase
    {
        /// <summary>
