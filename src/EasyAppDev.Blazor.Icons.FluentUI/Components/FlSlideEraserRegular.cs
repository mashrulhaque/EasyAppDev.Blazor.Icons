...
{
    /// <summary>
    /// FlSlideEraserRegular icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class FlSlideEraserRegular : ComponentBase
    {
        /// <summary>
        ...
        protected override void BuildRenderTree(RenderTreeBuilder builder)
        {
            ...
            // Inline SVG content
            builder.AddMarkupContent(13, @"<path d=""M2 6.75A2.75 2.75 0 0 1 4.75 4h14.5A2.75 2.75 0 0 1 22 6.75v5.79l-.8-.8a2.5 2.5 0 0 0-.7-.5V6.75c0-.69-.56-1.25-1.25-1.25H4.75c-.69 0-1.25.56-1.25 1.25v10.5c0 .69.56 1.25 1.25 1.25h7.26c.02.53.2 1.06.57 1.5H4.75A2.75 2.75 0 0 1 2 17.25V6.75Z""/><path d=""M20.5 12.44a1.5 1.5 0 0 0-2.13 0l-3.11 3.11 4.2 4.2 3.12-3.1a1.5 1.5 0 0 0 0-2.12l-2.09-2.09Z""/><path d=""m13.45 17.36 1.1-1.1 4.21 4.2-1.1 1.1a1.5 1.5 0 0 1-2.12 0l-2.09-2.08a1.5 1.5 0 0 1 0-2.12Z""/>");
