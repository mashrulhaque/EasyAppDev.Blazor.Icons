...
{
    /// <summary>
    /// FlGlobeSearchFilled icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class FlGlobeSearchFilled : ComponentBase
    {
        /// <summary>
