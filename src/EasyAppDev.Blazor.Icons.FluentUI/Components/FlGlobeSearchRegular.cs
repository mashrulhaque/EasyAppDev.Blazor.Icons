...
{
    /// <summary>
    /// FlGlobeSearchRegular icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class FlGlobeSearchRegular : ComponentBase
    {
        /// <summary>
