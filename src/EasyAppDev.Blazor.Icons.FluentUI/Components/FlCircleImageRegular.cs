...
{
    /// <summary>
    /// FlCircleImageRegular icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class FlCircleImageRegular : ComponentBase
    {
        /// <summary>
        ...
        protected override void BuildRenderTree(RenderTreeBuilder builder)
        {
            ...
            // Inline SVG content
            builder.AddMarkupContent(13, @"<path d=""M9 3.5a5.5 5.5 0 0 0-1 10.9v1.53A7 7 0 1 1 15.93 8H14.4A5.5 5.5 0 0 0 9 3.5Zm5.8 13.77a1 1 0 0 1 1.4 0l3.14 3.13c-.19.06-.38.1-.59.1h-6.5c-.2 0-.4-.04-.59-.1l3.13-3.13Zm-4.2 2.07c-.06-.19-.1-.38-.1-.59v-6.5c0-.97.78-1.75 1.75-1.75h6.5c.97 0 1.75.78 1.75 1.75v6.5c0 .2-.04.4-.1.59l-3.13-3.13a2.5 2.5 0 0 0-3.54 0l-3.13 3.13ZM19.25 13a1.25 1.25 0 1 1-2.5 0 1.25 1.25 0 0 1 2.5 0Zm-7-4A3.25 3.25 0 0 0 9 12.25v6.5c0 1.8 1.46 3.25 3.25 3.25h6.5c1.8 0 3.25-1.46 3.25-3.25v-6.5C22 10.45 20.54 9 18.75 9h-6.5Z""/>");
