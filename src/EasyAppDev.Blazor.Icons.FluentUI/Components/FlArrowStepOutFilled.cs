...
{
    /// <summary>
    /// FlArrowStepOutFilled icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class FlArrowStepOutFilled : ComponentBase
    {
        /// <summary>
        ...
        protected override void BuildRenderTree(RenderTreeBuilder builder)
        {
            ...
            // Inline SVG content
            builder.AddMarkupContent(13, @"<path d=""M12.75 13.75a.75.75 0 0 1-1.5 0V4.49L7.77 7.8a.75.75 0 1 1-1.04-1.08l4.75-4.5a.75.75 0 0 1 1.04 0l4.75 4.5a.75.75 0 0 1-1.04 1.08l-3.48-3.3v9.26ZM15 19a3 3 0 1 1-6 0 3 3 0 0 1 6 0Z""/>");
