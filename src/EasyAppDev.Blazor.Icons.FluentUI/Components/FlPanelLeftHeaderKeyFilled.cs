...
{
    /// <summary>
    /// FlPanelLeftHeaderKeyFilled icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class FlPanelLeftHeaderKeyFilled : ComponentBase
    {
        /// <summary>
        ...
        protected override void BuildRenderTree(RenderTreeBuilder builder)
        {
            ...
            // Inline SVG content
            builder.AddMarkupContent(13, @"<path d=""M2 7.25C2 5.45 3.46 4 5.25 4h13.5C20.55 4 22 5.46 22 7.25v4.5c-.45-.3-.96-.52-1.5-.64v-.61h-11v8h3.09l-1.08 1.07c-.12.13-.23.27-.31.43H5.25A3.25 3.25 0 0 1 2 16.75v-9.5ZM9.5 9h11V7.25c0-.97-.78-1.75-1.75-1.75H9.5V9Zm10 10a3.5 3.5 0 1 0-3.38-2.59.75.75 0 0 0-.15.12l-3.75 3.75a.75.75 0 0 0-.22.53v1.44c0 .41.34.75.75.75h1.75a.5.5 0 0 0 .5-.5V22h1a.5.5 0 0 0 .5-.5v-1h1a.5.5 0 0 0 .5-.5v-1h1.5Zm1.5-4a1 1 0 1 1-2 0 1 1 0 0 1 2 0Z""/>");
