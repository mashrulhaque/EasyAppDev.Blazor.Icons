...
{
    /// <summary>
    /// FlTextAlignLeftRotate90Regular icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class FlTextAlignLeftRotate90Regular : ComponentBase
    {
        /// <summary>
        ...
        protected override void BuildRenderTree(RenderTreeBuilder builder)
        {
            ...
            // Inline SVG content
            builder.AddMarkupContent(13, @"<path d=""M18.25 2c.41 0 .75.34.75.75v15.5a.75.75 0 0 1-1.5 0V2.75c0-.41.34-.75.75-.75Zm-13 0c.41 0 .75.34.75.75v10.5a.75.75 0 0 1-1.5 0V2.75c0-.41.34-.75.75-.75Zm7.25.75a.75.75 0 0 0-1.5 0v18.5a.75.75 0 0 0 1.5 0V2.75Z""/>");
