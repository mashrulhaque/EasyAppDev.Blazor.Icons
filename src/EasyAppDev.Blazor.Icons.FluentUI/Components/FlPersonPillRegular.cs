...
{
    /// <summary>
    /// FlPersonPillRegular icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class FlPersonPillRegular : ComponentBase
    {
        /// <summary>
