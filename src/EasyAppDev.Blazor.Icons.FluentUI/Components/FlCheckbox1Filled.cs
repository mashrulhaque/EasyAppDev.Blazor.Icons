...
{
    /// <summary>
    /// FlCheckbox1Filled icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class FlCheckbox1Filled : ComponentBase
    {
        /// <summary>
