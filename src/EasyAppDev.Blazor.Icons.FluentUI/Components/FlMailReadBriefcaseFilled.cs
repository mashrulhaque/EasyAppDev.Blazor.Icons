...
{
    /// <summary>
    /// FlMailReadBriefcaseFilled icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class FlMailReadBriefcaseFilled : ComponentBase
    {
        /// <summary>
        ...
        protected override void BuildRenderTree(RenderTreeBuilder builder)
        {
            ...
            // Inline SVG content
            builder.AddMarkupContent(13, @"<path d=""M10.8 2.34a2.25 2.25 0 0 1 2.4 0l7.74 4.83.22.16L16.1 10h-.34c-1.05 0-1.96.59-2.43 1.45l-1.32.7-9.17-4.82.23-.16 7.75-4.83Zm.85 11.32.1.05A2.5 2.5 0 0 0 11 15.5V20H5.25A3.25 3.25 0 0 1 2 16.75V9.08c0-.16.02-.31.05-.47l9.6 5.05ZM19.31 10A2.75 2.75 0 0 1 22 12.74V9.08c0-.16-.02-.32-.05-.47L19.31 10ZM14 14h-.5c-.83 0-1.5.67-1.5 1.5v5c0 .83.67 1.5 1.5 1.5h8c.83 0 1.5-.67 1.5-1.5v-5c0-.83-.67-1.5-1.5-1.5H21v-1.25c0-.97-.78-1.75-1.75-1.75h-3.5c-.97 0-1.75.78-1.75 1.75V14Zm1.5-1.25c0-.14.11-.25.25-.25h3.5c.14 0 .25.11.25.25V14h-4v-1.25Z""/>");
