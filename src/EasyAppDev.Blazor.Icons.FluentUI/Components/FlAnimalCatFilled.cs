...
{
    /// <summary>
    /// FlAnimalCatFilled icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class FlAnimalCatFilled : ComponentBase
    {
        /// <summary>
