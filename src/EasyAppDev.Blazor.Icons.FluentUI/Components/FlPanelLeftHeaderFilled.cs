...
{
    /// <summary>
    /// FlPanelLeftHeaderFilled icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class FlPanelLeftHeaderFilled : ComponentBase
    {
        /// <summary>
        ...
        protected override void BuildRenderTree(RenderTreeBuilder builder)
        {
            ...
            // Inline SVG content
            builder.AddMarkupContent(13, @"<path d=""M2 7.25C2 5.45 3.46 4 5.25 4h13.5C20.55 4 22 5.46 22 7.25v9.5c0 1.8-1.46 3.25-3.25 3.25H5.25A3.25 3.25 0 0 1 2 16.75v-9.5Zm18.5 0c0-.97-.78-1.75-1.75-1.75H9.5V9h11V7.25Zm0 3.25h-11v8h9.25c.97 0 1.75-.78 1.75-1.75V10.5Z""/>");
