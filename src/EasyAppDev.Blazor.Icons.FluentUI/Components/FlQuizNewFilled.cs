...
{
    /// <summary>
    /// FlQuizNewFilled icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class FlQuizNewFilled : ComponentBase
    {
        /// <summary>
