...
{
    /// <summary>
    /// FlBowlSaladRegular icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class FlBowlSaladRegular : ComponentBase
    {
        /// <summary>
