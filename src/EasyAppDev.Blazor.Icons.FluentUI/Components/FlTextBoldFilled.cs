...
{
    /// <summary>
    /// FlTextBoldFilled icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class FlTextBoldFilled : ComponentBase
    {
        /// <summary>
        ...
        protected override void BuildRenderTree(RenderTreeBuilder builder)
        {
            ...
            // Inline SVG content
            builder.AddMarkupContent(13, @"<path d=""M6 5.75C6 4.78 6.78 4 7.75 4h4.75a4.76 4.76 0 0 1 3.95 7.38A4.84 4.84 0 0 1 18 15c0 3.13-2.68 5-5 5H7.75C6.78 20 6 19.22 6 18.25V5.75Zm3.5 7.75v3H13c.31 0 .71-.14 1.02-.42.3-.26.48-.62.48-1.08 0-.89-.75-1.5-1.5-1.5H9.5Zm0-3.5h3c.71 0 1.25-.6 1.25-1.25 0-.66-.54-1.25-1.25-1.25h-3V10Z""/>");
