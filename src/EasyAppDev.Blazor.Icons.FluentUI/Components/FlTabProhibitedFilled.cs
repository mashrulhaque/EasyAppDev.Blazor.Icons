...
{
    /// <summary>
    /// FlTabProhibitedFilled icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class FlTabProhibitedFilled : ComponentBase
    {
        /// <summary>
