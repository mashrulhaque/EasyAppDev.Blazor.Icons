...
{
    /// <summary>
    /// FlDataBarHorizontalRegular icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class FlDataBarHorizontalRegular : ComponentBase
    {
        /// <summary>
        ...
        protected override void BuildRenderTree(RenderTreeBuilder builder)
        {
            ...
            // Inline SVG content
            builder.AddMarkupContent(13, @"<path d=""M21 18.25c0-1.24-1-2.25-2.25-2.25H5.25a2.25 2.25 0 1 0 0 4.5h13.5c1.24 0 2.25-1 2.25-2.25Zm-4-6.5c0-1.24-1-2.25-2.25-2.25h-9.5a2.25 2.25 0 1 0 0 4.5h9.5C16 14 17 13 17 11.75Zm-4-6.5C13 4.01 12 3 10.75 3h-5.5a2.25 2.25 0 0 0 0 4.5h5.5C12 7.5 13 6.5 13 5.25Zm6.5 13c0 .41-.34.75-.75.75H5.25a.75.75 0 0 1 0-1.5h13.5c.41 0 .75.34.75.75Zm-4-6.5c0 .41-.34.75-.75.75h-9.5a.75.75 0 0 1 0-1.5h9.5c.41 0 .75.34.75.75Zm-4-6.5c0 .41-.34.75-.75.75h-5.5a.75.75 0 0 1 0-1.5h5.5c.41 0 .75.34.75.75Z""/>");
