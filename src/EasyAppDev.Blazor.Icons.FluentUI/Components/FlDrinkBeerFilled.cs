...
{
    /// <summary>
    /// FlDrinkBeerFilled icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class FlDrinkBeerFilled : ComponentBase
    {
        /// <summary>
