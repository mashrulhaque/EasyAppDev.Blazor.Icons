...
{
    /// <summary>
    /// FlFlashAutoRegular icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class FlFlashAutoRegular : ComponentBase
    {
        /// <summary>
