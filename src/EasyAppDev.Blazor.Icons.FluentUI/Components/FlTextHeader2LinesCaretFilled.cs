...
{
    /// <summary>
    /// FlTextHeader2LinesCaretFilled icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class FlTextHeader2LinesCaretFilled : ComponentBase
    {
        /// <summary>
        ...
        protected override void BuildRenderTree(RenderTreeBuilder builder)
        {
            ...
            // Inline SVG content
            builder.AddMarkupContent(13, @"<path d=""M12.41 4.4c.24-.52.85-.76 1.29-.6.57.24.8.97.5 1.46-.17.26-.42.54-.78.85l-.64.53-.51.43c-.73.61-1.77 1.56-1.77 2.93a1 1 0 0 0 1 1h4.25a1 1 0 1 0 0-2h-2.64c.12-.12.27-.26.45-.4l.42-.36.77-.63c.4-.36.83-.78 1.14-1.29 1-1.58.23-3.7-1.45-4.37-1.58-.63-3.24.28-3.85 1.63a1 1 0 1 0 1.82.83ZM3 2a1 1 0 0 1 1 1v2.5h3V3a1 1 0 0 1 2 0v7a1 1 0 1 1-2 0V7.5H4V10a1 1 0 1 1-2 0V3a1 1 0 0 1 1-1Zm14.56 3.46a.75.75 0 0 1 .69-.46h3a.75.75 0 0 1 .53 1.28l-1.5 1.5c-.3.3-.77.3-1.06 0l-1.5-1.5a.75.75 0 0 1-.16-.82ZM2 20a1 1 0 0 1 1-1h18a1 1 0 1 1 0 2H3a1 1 0 0 1-1-1Zm1-6a1 1 0 1 0 0 2h18a1 1 0 1 0 0-2H3Z""/>");
