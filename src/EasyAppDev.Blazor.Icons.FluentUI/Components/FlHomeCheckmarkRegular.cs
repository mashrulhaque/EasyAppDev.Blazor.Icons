...
{
    /// <summary>
    /// FlHomeCheckmarkRegular icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class FlHomeCheckmarkRegular : ComponentBase
    {
        /// <summary>
        ...
        protected override void BuildRenderTree(RenderTreeBuilder builder)
        {
            ...
            // Inline SVG content
            builder.AddMarkupContent(13, @"<path d=""M13.45 2.53c-.84-.7-2.06-.7-2.9 0L3.8 8.23c-.5.42-.8 1.05-.8 1.71v9.31c0 .97.78 1.75 1.75 1.75h14.5c.97 0 1.75-.78 1.75-1.75v-9.3c0-.67-.3-1.3-.8-1.73l-6.75-5.69Zm-1.93 1.15a.75.75 0 0 1 .96 0l6.75 5.7c.17.13.27.34.27.56v9.31c0 .14-.11.25-.25.25H4.75a.25.25 0 0 1-.25-.25v-9.3c0-.23.1-.44.27-.58l6.75-5.7Zm4.26 7.6a.75.75 0 1 0-1.06-1.06l-3.97 3.97-1.47-1.47a.75.75 0 1 0-1.06 1.06l2 2a.75.75 0 0 0 1.06 0l4.5-4.5Z""/>");
