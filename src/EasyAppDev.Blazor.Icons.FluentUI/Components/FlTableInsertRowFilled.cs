...
{
    /// <summary>
    /// FlTableInsertRowFilled icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class FlTableInsertRowFilled : ComponentBase
    {
        /// <summary>
        ...
        protected override void BuildRenderTree(RenderTreeBuilder builder)
        {
            ...
            // Inline SVG content
            builder.AddMarkupContent(13, @"<path d=""M20.25 4.5H3.75a.75.75 0 0 1 0-1.5h16.5a.75.75 0 0 1 0 1.5ZM8 8H5.25C4.01 8 3 8.9 3 10v4c0 1.1 1 2 2.25 2H8V8Zm1.5 8h5V8h-5v8Zm9.25 0H16V8h2.75c1.24 0 2.25.9 2.25 2v4c0 1.1-1 2-2.25 2Zm-15 5h16.5a.75.75 0 0 0 0-1.5H3.75a.75.75 0 0 0 0 1.5Z""/>");
