...
{
    /// <summary>
    /// FlDoubleSwipeUpFilled icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class FlDoubleSwipeUpFilled : ComponentBase
    {
        /// <summary>
