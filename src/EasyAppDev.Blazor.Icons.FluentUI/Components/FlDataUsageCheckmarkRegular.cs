...
{
    /// <summary>
    /// FlDataUsageCheckmarkRegular icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class FlDataUsageCheckmarkRegular : ComponentBase
    {
        /// <summary>
        ...
        protected override void BuildRenderTree(RenderTreeBuilder builder)
        {
            ...
            // Inline SVG content
            builder.AddMarkupContent(13, @"<path d=""M17.25 2A2.75 2.75 0 0 1 20 4.75v6.75c-.47-.2-.98-.34-1.5-.42V4.75c0-.7-.56-1.25-1.25-1.25H4.75c-.69 0-1.25.56-1.25 1.25v12.5c0 .69.56 1.25 1.25 1.25h6.33c.08.52.22 1.02.42 1.5H4.75A2.75 2.75 0 0 1 2 17.25V4.75A2.75 2.75 0 0 1 4.75 2h12.5ZM16 6.73v4.44c-.53.13-1.03.32-1.5.56v-5c0-.4.34-.73.75-.73.38 0 .7.27.74.63l.01.1Zm-4.29 4.99.03 2.76c-.24.47-.43.97-.56 1.5a.73.73 0 0 1-.89-.6v-.1l-.04-3.55c0-.4.32-.73.73-.73.37 0 .67.26.73.62v.1ZM6.75 8c.38 0 .7.28.74.64l.01.1v6.51a.75.75 0 0 1-1.5.1v-6.6c0-.42.34-.75.75-.75ZM23 17.5a5.5 5.5 0 1 1-11 0 5.5 5.5 0 0 1 11 0Zm-2.15-2.35a.5.5 0 0 0-.7 0l-3.65 3.64-1.65-1.64a.5.5 0 0 0-.7.7l2 2c.2.2.5.2.7 0l4-4a.5.5 0 0 0 0-.7Z""/>");
