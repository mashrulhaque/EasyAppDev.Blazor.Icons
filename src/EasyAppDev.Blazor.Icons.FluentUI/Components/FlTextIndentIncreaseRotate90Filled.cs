...
{
    /// <summary>
    /// FlTextIndentIncreaseRotate90Filled icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class FlTextIndentIncreaseRotate90Filled : ComponentBase
    {
        /// <summary>
        ...
        protected override void BuildRenderTree(RenderTreeBuilder builder)
        {
            ...
            // Inline SVG content
            builder.AddMarkupContent(13, @"<path d=""M8 9v8.5a1 1 0 0 1-2 .12V9a1 1 0 0 1 2-.12V9Zm6.7-6.7a1 1 0 0 1 .09 1.31l-.08.1-2 2a1 1 0 0 1-1.32.08l-.1-.08-2-2a1 1 0 0 1 1.32-1.5l.1.08L12 3.6l1.3-1.3a1 1 0 0 1 1.4 0ZM13 9v11.5a1 1 0 0 1-2 .12V9a1 1 0 0 1 2-.12V9Zm5 0v8.5a1 1 0 0 1-2 .12V9a1 1 0 0 1 2-.12V9Z""/>");
