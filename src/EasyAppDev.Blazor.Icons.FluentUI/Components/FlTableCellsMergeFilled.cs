...
{
    /// <summary>
    /// FlTableCellsMergeFilled icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class FlTableCellsMergeFilled : ComponentBase
    {
        /// <summary>
