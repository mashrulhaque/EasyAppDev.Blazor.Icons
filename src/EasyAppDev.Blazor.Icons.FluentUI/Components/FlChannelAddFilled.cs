...
{
    /// <summary>
    /// FlChannelAddFilled icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class FlChannelAddFilled : ComponentBase
    {
        /// <summary>
