...
{
    /// <summary>
    /// FlTvUsbFilled icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class FlTvUsbFilled : ComponentBase
    {
        /// <summary>
