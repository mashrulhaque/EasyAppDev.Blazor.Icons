...
{
    /// <summary>
    /// FlTextDescriptionRtlRegular icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class FlTextDescriptionRtlRegular : ComponentBase
    {
        /// <summary>
        ...
        protected override void BuildRenderTree(RenderTreeBuilder builder)
        {
            ...
            // Inline SVG content
            builder.AddMarkupContent(13, @"<path d=""M21.25 17H8.75a.75.75 0 0 0-.1 1.5h12.6a.75.75 0 0 0 .1-1.5H8.75h12.5Zm0-4H2.75a.75.75 0 0 0-.1 1.5h18.6a.75.75 0 0 0 .1-1.5H2.75h18.5Zm0-4H2.75a.75.75 0 0 0-.1 1.5h18.6a.75.75 0 0 0 .1-1.5H2.75h18.5Zm0-4H2.75a.75.75 0 0 0-.1 1.5h18.6a.75.75 0 0 0 .1-1.5H2.75h18.5Z""/>");
