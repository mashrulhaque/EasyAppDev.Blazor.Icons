...
{
    /// <summary>
    /// FlPersonSwapFilled icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class FlPersonSwapFilled : ComponentBase
    {
        /// <summary>
        ...
        protected override void BuildRenderTree(RenderTreeBuilder builder)
        {
            ...
            // Inline SVG content
            builder.AddMarkupContent(13, @"<path d=""M15.75 14C17 14 18 15 18 16.25v.91c0 .29-.04.57-.13.84h-2.03A1.75 1.75 0 0 0 13 16.02l-2.5 2.5a1.75 1.75 0 0 0 0 2.48l.94.93c-.47.05-.95.07-1.45.07-3.42 0-5.95-1.07-7.49-3.24a2.75 2.75 0 0 1-.51-1.6v-.91C2 15 3 14 4.25 14h11.5ZM10 2a5 5 0 1 1 0 10 5 5 0 0 1 0-10Zm4.78 15.78a.75.75 0 0 0-1.06-1.06l-2.5 2.5a.75.75 0 0 0 0 1.06l2.5 2.5a.75.75 0 0 0 1.06-1.06l-1.22-1.22h6.88l-1.22 1.22a.75.75 0 0 0 1.06 1.06l2.5-2.5a.75.75 0 0 0 0-1.06l-2.5-2.5a.75.75 0 1 0-1.06 1.06L20.44 19h-6.88l1.22-1.22Z""/>");
