...
{
    /// <summary>
    /// FlShoppingBagAddFilled icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class FlShoppingBagAddFilled : ComponentBase
    {
        /// <summary>
        ...
        protected override void BuildRenderTree(RenderTreeBuilder builder)
        {
            ...
            // Inline SVG content
            builder.AddMarkupContent(13, @"<path d=""M7 7V5a3 3 0 0 1 5-2.24A3 3 0 0 1 17 5v2h1.5c.83 0 1.5.67 1.5 1.5v3a6.48 6.48 0 0 0-5.5.23V7h1V5a1.5 1.5 0 0 0-2.66-.96c.1.3.16.63.16.96v7.81a6.48 6.48 0 0 0-.19 9.19H8a4 4 0 0 1-4-4V8.5C4 7.67 4.67 7 5.5 7H7Zm1.5-2v2h3V5a1.5 1.5 0 0 0-3 0Zm9 7a5.5 5.5 0 1 1 0 11 5.5 5.5 0 0 1 0-11Zm.5 8.5V18h2.5a.5.5 0 0 0 0-1H18v-2.5a.5.5 0 1 0-1 0V17h-2.5a.5.5 0 0 0 0 1H17v2.5a.5.5 0 1 0 1 0Z""/>");
