...
{
    /// <summary>
    /// FlColorLineRegular icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class FlColorLineRegular : ComponentBase
    {
        /// <summary>
