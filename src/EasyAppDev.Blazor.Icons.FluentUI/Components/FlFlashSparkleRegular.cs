...
{
    /// <summary>
    /// FlFlashSparkleRegular icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class FlFlashSparkleRegular : ComponentBase
    {
        /// <summary>
