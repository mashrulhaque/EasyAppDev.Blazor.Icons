...
{
    /// <summary>
    /// FlCenterHorizontalFilled icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class FlCenterHorizontalFilled : ComponentBase
    {
        /// <summary>
        ...
        protected override void BuildRenderTree(RenderTreeBuilder builder)
        {
            ...
            // Inline SVG content
            builder.AddMarkupContent(13, @"<path d=""M3.75 3c.41 0 .75.34.75.75v16.5a.75.75 0 0 1-1.5 0V3.75c0-.41.34-.75.75-.75Zm16.5 0c.41 0 .75.34.75.75v16.5a.75.75 0 0 1-1.5 0V3.75c0-.41.34-.75.75-.75Zm-10 2C9.01 5 8 6 8 7.25v9.5C8 17.99 9 19 10.25 19h3.5c1.24 0 2.25-1 2.25-2.25v-9.5C16 6.01 15 5 13.75 5h-3.5Z""/>");
