...
{
    /// <summary>
    /// FlInkStrokeArrowUpDownFilled icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class FlInkStrokeArrowUpDownFilled : ComponentBase
    {
        /// <summary>
