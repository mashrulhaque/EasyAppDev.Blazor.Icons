...
{
    /// <summary>
    /// FlStatusFilled icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class FlStatusFilled : ComponentBase
    {
        /// <summary>
        ...
        protected override void BuildRenderTree(RenderTreeBuilder builder)
        {
            ...
            // Inline SVG content
            builder.AddMarkupContent(13, @"<path d=""M16.03 3.03a3.5 3.5 0 0 1 4.94 4.94l-6.05 6.06c-.35.35-.78.6-1.26.72l-4.72 1.23a.75.75 0 0 1-.92-.92l1.23-4.72c.12-.48.37-.9.72-1.26l6.06-6.05Zm-1.7.27A9.01 9.01 0 1 0 12 21a9 9 0 0 0 8.7-11.33l-1.27 1.27a7.5 7.5 0 1 1-6.36-6.36l1.26-1.28Z""/>");
