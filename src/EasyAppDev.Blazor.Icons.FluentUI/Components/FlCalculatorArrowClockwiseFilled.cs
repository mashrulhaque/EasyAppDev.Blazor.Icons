...
{
    /// <summary>
    /// FlCalculatorArrowClockwiseFilled icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class FlCalculatorArrowClockwiseFilled : ComponentBase
    {
        /// <summary>
        ...
        protected override void BuildRenderTree(RenderTreeBuilder builder)
        {
            ...
            // Inline SVG content
            builder.AddMarkupContent(13, @"<path d=""M4 5.25C4 3.45 5.46 2 7.25 2h9.5C18.55 2 20 3.46 20 5.25v5.03a1.76 1.76 0 0 0-.23.29A7 7 0 0 0 12.1 22H7.25A3.25 3.25 0 0 1 4 18.75V5.25ZM9 5a2 2 0 0 0-2 2v1c0 1.1.9 2 2 2h6a2 2 0 0 0 2-2V7a2 2 0 0 0-2-2H9Zm.5 8.25a1.25 1.25 0 1 0-2.5 0 1.25 1.25 0 0 0 2.5 0ZM8.25 18.5a1.25 1.25 0 1 0 0-2.5 1.25 1.25 0 0 0 0 2.5Zm13-3.5c.41 0 .75-.34.75-.75V11.5a.75.75 0 0 0-1.5 0v.63A6 6 0 1 0 23 17a.75.75 0 0 0-1.5 0 4.5 4.5 0 1 1-1.69-3.51h.01v.01H18.5a.75.75 0 0 0 0 1.5h2.75Z""/>");
