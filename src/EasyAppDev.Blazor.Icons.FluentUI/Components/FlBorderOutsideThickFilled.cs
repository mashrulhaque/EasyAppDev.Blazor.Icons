...
{
    /// <summary>
    /// FlBorderOutsideThickFilled icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class FlBorderOutsideThickFilled : ComponentBase
    {
        /// <summary>
        ...
        protected override void BuildRenderTree(RenderTreeBuilder builder)
        {
            ...
            // Inline SVG content
            builder.AddMarkupContent(13, @"<path d=""M2.5 5.75c0-1.8 1.46-3.25 3.25-3.25h12.5c1.8 0 3.25 1.46 3.25 3.25v12.5c0 1.8-1.46 3.25-3.25 3.25H5.75a3.25 3.25 0 0 1-3.25-3.25V5.75ZM5.75 5a.75.75 0 0 0-.75.75v12.5c0 .41.34.75.75.75h12.5c.41 0 .75-.34.75-.75V5.75a.75.75 0 0 0-.75-.75H5.75Z""/>");
