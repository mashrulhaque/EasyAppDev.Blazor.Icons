...
{
    /// <summary>
    /// FlCenterVerticalFilled icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class FlCenterVerticalFilled : ComponentBase
    {
        /// <summary>
        ...
        protected override void BuildRenderTree(RenderTreeBuilder builder)
        {
            ...
            // Inline SVG content
            builder.AddMarkupContent(13, @"<path d=""M21 3.75c0 .41-.34.75-.75.75H3.75a.75.75 0 0 1 0-1.5h16.5c.41 0 .75.34.75.75Zm0 16.5c0 .41-.34.75-.75.75H3.75a.75.75 0 0 1 0-1.5h16.5c.41 0 .75.34.75.75ZM7.25 8C6.01 8 5 9 5 10.25v3.5C5 14.99 6 16 7.25 16h9.5c1.24 0 2.25-1 2.25-2.25v-3.5C19 9.01 18 8 16.75 8h-9.5Z""/>");
