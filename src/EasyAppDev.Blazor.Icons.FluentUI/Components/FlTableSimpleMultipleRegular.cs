...
{
    /// <summary>
    /// FlTableSimpleMultipleRegular icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class FlTableSimpleMultipleRegular : ComponentBase
    {
        /// <summary>
        ...
        protected override void BuildRenderTree(RenderTreeBuilder builder)
        {
            ...
            // Inline SVG content
            builder.AddMarkupContent(13, @"<path d=""M5.25 2A3.25 3.25 0 0 0 2 5.25v10.5C2 17.55 3.46 19 5.25 19h10.5c1.8 0 3.25-1.46 3.25-3.25V5.25C19 3.45 17.54 2 15.75 2H5.25ZM3.5 5.25c0-.97.78-1.75 1.75-1.75H10V10H3.5V5.25Zm8 4.75V3.5h4.25c.97 0 1.75.78 1.75 1.75V10h-6Zm-8 1.5H10v6H5.25c-.97 0-1.75-.78-1.75-1.75V11.5Zm8 0h6v4.25c0 .97-.78 1.75-1.75 1.75H11.5v-6ZM8.25 22a3.25 3.25 0 0 1-3-2h1.78c.31.3.74.5 1.22.5h8.25a4 4 0 0 0 4-4V8.25c0-.48-.19-.9-.5-1.22V5.25c1.18.49 2 1.65 2 3v8.25a5.5 5.5 0 0 1-5.5 5.5H8.25Z""/>");
