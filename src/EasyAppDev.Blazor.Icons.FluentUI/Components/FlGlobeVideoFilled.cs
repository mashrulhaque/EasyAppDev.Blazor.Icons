...
{
    /// <summary>
    /// FlGlobeVideoFilled icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class FlGlobeVideoFilled : ComponentBase
    {
        /// <summary>
