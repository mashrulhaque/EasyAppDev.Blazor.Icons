...
{
    /// <summary>
    /// FlNumberCircle2Regular icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class FlNumberCircle2Regular : ComponentBase
    {
        /// <summary>
