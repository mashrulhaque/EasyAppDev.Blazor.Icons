...
{
    /// <summary>
    /// FlShiftsDayFilled icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class FlShiftsDayFilled : ComponentBase
    {
        /// <summary>
