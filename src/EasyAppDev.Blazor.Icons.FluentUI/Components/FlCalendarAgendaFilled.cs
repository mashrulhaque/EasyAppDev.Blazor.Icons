...
{
    /// <summary>
    /// FlCalendarAgendaFilled icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class FlCalendarAgendaFilled : ComponentBase
    {
        /// <summary>
        ...
        protected override void BuildRenderTree(RenderTreeBuilder builder)
        {
            ...
            // Inline SVG content
            builder.AddMarkupContent(13, @"<path d=""M21 17.75c0 1.8-1.46 3.25-3.25 3.25H6.25A3.25 3.25 0 0 1 3 17.75V6.25C3 4.45 4.46 3 6.25 3h11.5C19.55 3 21 4.46 21 6.25v11.5Zm-4-10c0-.38-.28-.7-.65-.74l-.1-.01h-8.6a.75.75 0 0 0 0 1.5h8.7a.75.75 0 0 0 .65-.75Zm0 8.5c0-.38-.28-.7-.65-.74l-.1-.01h-8.6a.75.75 0 0 0 0 1.5h8.7a.75.75 0 0 0 .65-.75ZM17 12c0-.38-.28-.7-.65-.74l-.1-.01h-8.6a.75.75 0 0 0 0 1.5h8.7A.75.75 0 0 0 17 12Z""/>");
