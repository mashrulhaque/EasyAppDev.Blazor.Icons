...
{
    /// <summary>
    /// FlTableColumnTopBottomEditRegular icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class FlTableColumnTopBottomEditRegular : ComponentBase
    {
        /// <summary>
        ...
        protected override void BuildRenderTree(RenderTreeBuilder builder)
        {
            ...
            // Inline SVG content
            builder.AddMarkupContent(13, @"<path d=""M6.25 3A3.25 3.25 0 0 0 3 6.25v11.5C3 19.55 4.46 21 6.25 21h4.92l.35-1.42c.16-.65.5-1.24.97-1.72L16.36 14h-.86v-4h4v1.23c.48-.19 1-.26 1.5-.22V6.25C21 4.45 19.54 3 17.75 3H6.25ZM4.5 6.25c0-.97.78-1.75 1.75-1.75H8.5v4h-4V6.25Zm0 7.75v-4h4v4h-4Zm5.5 0v-4h4v4h-4Zm9.5-5.5h-4v-4h2.25c.97 0 1.75.78 1.75 1.75V8.5Zm-15 9.25V15.5h4v4H6.25c-.97 0-1.75-.78-1.75-1.75Zm14.6-5.08-5.9 5.9c-.35.35-.6.78-.7 1.25l-.47 1.83c-.2.8.53 1.52 1.32 1.32l1.83-.46c.47-.12.9-.36 1.25-.7l5.9-5.9a2.29 2.29 0 0 0-3.23-3.24Z""/>");
