...
{
    /// <summary>
    /// FlDocumentFolderRegular icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class FlDocumentFolderRegular : ComponentBase
    {
        /// <summary>
        ...
        protected override void BuildRenderTree(RenderTreeBuilder builder)
        {
            ...
            // Inline SVG content
            builder.AddMarkupContent(13, @"<path d=""M18.5 4.63V15h-1V4.25c0-1.24-1-2.25-2.25-2.25h-9C5.01 2 4 3 4 4.25v4.13c-.6.4-1 1.09-1 1.87v8.5C3 20.55 4.46 22 6.25 22h11.5c1.8 0 3.25-1.46 3.25-3.25v-1.5c0-.78-.4-1.47-1-1.87V6.75c0-.98-.63-1.81-1.5-2.12ZM5.5 8V4.25c0-.41.34-.75.75-.75h9c.41 0 .75.34.75.75V15h-.1c-.2 0-.4-.09-.55-.24l-5.6-6.04A2.25 2.25 0 0 0 8.1 8H5.5Zm-1 2.25c0-.41.34-.75.75-.75H8.1c.2 0 .4.09.55.24l5.6 6.04c.43.46 1.03.72 1.65.72h2.85c.41 0 .75.34.75.75v1.5c0 .97-.78 1.75-1.75 1.75H6.25c-.97 0-1.75-.78-1.75-1.75v-8.5Z""/>");
