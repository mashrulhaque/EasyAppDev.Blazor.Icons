...
{
    /// <summary>
    /// FlWeatherRainRegular icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class FlWeatherRainRegular : ComponentBase
    {
        /// <summary>
