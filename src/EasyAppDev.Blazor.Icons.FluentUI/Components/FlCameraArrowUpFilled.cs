...
{
    /// <summary>
    /// FlCameraArrowUpFilled icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class FlCameraArrowUpFilled : ComponentBase
    {
        /// <summary>
