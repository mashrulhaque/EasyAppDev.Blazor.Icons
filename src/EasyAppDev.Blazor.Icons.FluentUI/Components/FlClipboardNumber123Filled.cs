...
{
    /// <summary>
    /// FlClipboardNumber123Filled icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class FlClipboardNumber123Filled : ComponentBase
    {
        /// <summary>
