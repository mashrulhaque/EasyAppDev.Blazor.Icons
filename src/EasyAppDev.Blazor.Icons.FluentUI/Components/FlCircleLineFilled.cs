...
{
    /// <summary>
    /// FlCircleLineFilled icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class FlCircleLineFilled : ComponentBase
    {
        /// <summary>
        ...
        protected override void BuildRenderTree(RenderTreeBuilder builder)
        {
            ...
            // Inline SVG content
            builder.AddMarkupContent(13, @"<path d=""M21.97 12.75H2.03a10 10 0 0 0 19.94 0Zm0-1.5H2.03a10 10 0 0 1 19.94 0Z""/>");
