...
{
    /// <summary>
    /// FlCalendarEyeRegular icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class FlCalendarEyeRegular : ComponentBase
    {
        /// <summary>
        ...
        protected override void BuildRenderTree(RenderTreeBuilder builder)
        {
            ...
            // Inline SVG content
            builder.AddMarkupContent(13, @"<path d=""M17.5 13c3.04 0 5.5 3 5.5 4.5S20.54 22 17.5 22 12 19 12 17.5s2.46-4.5 5.5-4.5Zm.25-10C19.55 3 21 4.46 21 6.25v6.86c-.46-.3-.96-.56-1.5-.75V8.5h-15v9.25c0 .97.78 1.75 1.75 1.75h5.41a7.5 7.5 0 0 0 1.22 1.5H6.25A3.25 3.25 0 0 1 3 17.75V6.25C3 4.45 4.46 3 6.25 3h11.5Zm-.25 11.5a3 3 0 1 0 0 6 3 3 0 0 0 0-6Zm0 1.5a1.5 1.5 0 1 1 0 3 1.5 1.5 0 0 1 0-3ZM6.25 4.5c-.97 0-1.75.78-1.75 1.75V7h15v-.75c0-.97-.78-1.75-1.75-1.75H6.25Z""/>");
