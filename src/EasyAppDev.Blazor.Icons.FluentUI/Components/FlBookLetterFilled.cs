...
{
    /// <summary>
    /// FlBookLetterFilled icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class FlBookLetterFilled : ComponentBase
    {
        /// <summary>
