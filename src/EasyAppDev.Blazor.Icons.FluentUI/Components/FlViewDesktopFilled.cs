...
{
    /// <summary>
    /// FlViewDesktopFilled icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class FlViewDesktopFilled : ComponentBase
    {
        /// <summary>
