...
{
    /// <summary>
    /// FlReadAloudFilled icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class FlReadAloudFilled : ComponentBase
    {
        /// <summary>
