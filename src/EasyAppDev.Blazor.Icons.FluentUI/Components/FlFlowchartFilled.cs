...
{
    /// <summary>
    /// FlFlowchartFilled icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class FlFlowchartFilled : ComponentBase
    {
        /// <summary>
