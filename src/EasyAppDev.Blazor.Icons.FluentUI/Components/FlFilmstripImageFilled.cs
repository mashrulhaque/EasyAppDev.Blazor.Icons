...
{
    /// <summary>
    /// FlFilmstripImageFilled icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class FlFilmstripImageFilled : ComponentBase
    {
        /// <summary>
