...
{
    /// <summary>
    /// FlNotebookSubsectionRegular icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class FlNotebookSubsectionRegular : ComponentBase
    {
        /// <summary>
        ...
        protected override void BuildRenderTree(RenderTreeBuilder builder)
        {
            ...
            // Inline SVG content
            builder.AddMarkupContent(13, @"<path d=""M9 2a4.5 4.5 0 0 0-4.5 4.5v9.4c0 .98.63 1.81 1.5 2.12V6.5a3 3 0 0 1 3-3h5A2.25 2.25 0 0 0 11.88 2H9Z""/><path d=""M7 6.75C7 5.51 8 4.5 9.25 4.5H15V2.75a.75.75 0 0 1 1.5 0v18.5a.75.75 0 0 1-1.5 0V20H9.25C8.01 20 7 19 7 17.75v-11Zm8 11.75V6H9.25a.75.75 0 0 0-.75.75v11c0 .41.34.75.75.75H15Z""/>");
