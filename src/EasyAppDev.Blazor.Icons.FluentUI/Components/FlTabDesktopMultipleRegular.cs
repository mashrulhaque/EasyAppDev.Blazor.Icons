...
{
    /// <summary>
    /// FlTabDesktopMultipleRegular icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class FlTabDesktopMultipleRegular : ComponentBase
    {
        /// <summary>
        ...
        protected override void BuildRenderTree(RenderTreeBuilder builder)
        {
            ...
            // Inline SVG content
            builder.AddMarkupContent(13, @"<path d=""M9.25 22A3.25 3.25 0 0 1 6 19h1.5c.13.85.86 1.5 1.74 1.5h8c1.8 0 3.25-1.46 3.25-3.25v-8c0-.88-.65-1.61-1.5-1.73V6c1.68.13 3 1.53 3 3.24v8A4.75 4.75 0 0 1 17.25 22h-8ZM2 5.25C2 3.45 3.46 2 5.25 2h9.5C16.55 2 18 3.46 18 5.25v9.5c0 1.8-1.46 3.25-3.25 3.25h-9.5A3.25 3.25 0 0 1 2 14.75v-9.5ZM5.25 3.5c-.97 0-1.75.78-1.75 1.75v9.5c0 .97.78 1.75 1.75 1.75h9.5c.97 0 1.75-.78 1.75-1.75V7.5h-5.75c-1.24 0-2.25-1-2.25-2.25V3.5H5.25Zm4.75 0v1.75c0 .41.34.75.75.75h5.75v-.75c0-.97-.78-1.75-1.75-1.75H10Z""/>");
