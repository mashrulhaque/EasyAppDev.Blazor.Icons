...
{
    /// <summary>
    /// FlDataUsageSettingsRegular icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class FlDataUsageSettingsRegular : ComponentBase
    {
        /// <summary>
