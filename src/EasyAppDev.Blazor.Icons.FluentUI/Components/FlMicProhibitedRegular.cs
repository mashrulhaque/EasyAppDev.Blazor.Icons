...
{
    /// <summary>
    /// FlMicProhibitedRegular icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class FlMicProhibitedRegular : ComponentBase
    {
        /// <summary>
