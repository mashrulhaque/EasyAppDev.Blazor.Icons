...
{
    /// <summary>
    /// MdStarShootingOutline icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class MdStarShootingOutline : ComponentBase
    {
        /// <summary>
