...
{
    /// <summary>
    /// MdFanClock icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class MdFanClock : ComponentBase
    {
        /// <summary>
