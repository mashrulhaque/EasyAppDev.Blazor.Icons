...
{
    /// <summary>
    /// MdStomach icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class MdStomach : ComponentBase
    {
        /// <summary>
