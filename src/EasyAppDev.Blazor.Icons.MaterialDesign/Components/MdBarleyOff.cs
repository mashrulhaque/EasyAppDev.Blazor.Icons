...
{
    /// <summary>
    /// MdBarleyOff icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class MdBarleyOff : ComponentBase
    {
        /// <summary>
