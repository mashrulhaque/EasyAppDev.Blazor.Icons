...
{
    /// <summary>
    /// MdRugby icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class MdRugby : ComponentBase
    {
        /// <summary>
