...
{
    /// <summary>
    /// MdRelationOneToMany icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class MdRelationOneToMany : ComponentBase
    {
        /// <summary>
        ...
        protected override void BuildRenderTree(RenderTreeBuilder builder)
        {
            ...
            // Inline SVG content
            builder.AddMarkupContent(13, @"<path d=""M22 13V19H21L19 17H11V9H7V11H5V9H2V7H5V5H7V7H13V15H19L21 13Z"" />");
