...
{
    /// <summary>
    /// MdCctvOff icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class MdCctvOff : ComponentBase
    {
        /// <summary>
