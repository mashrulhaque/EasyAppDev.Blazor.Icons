...
{
    /// <summary>
    /// MdCameraOffOutline icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class MdCameraOffOutline : ComponentBase
    {
        /// <summary>
