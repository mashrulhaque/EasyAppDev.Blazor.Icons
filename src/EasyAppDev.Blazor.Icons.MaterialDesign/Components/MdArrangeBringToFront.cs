...
{
    /// <summary>
    /// MdArrangeBringToFront icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class MdArrangeBringToFront : ComponentBase
    {
        /// <summary>
        ...
        protected override void BuildRenderTree(RenderTreeBuilder builder)
        {
            ...
            // Inline SVG content
            builder.AddMarkupContent(13, @"<path d=""M2,2H11V6H9V4H4V9H6V11H2V2M22,13V22H13V18H15V20H20V15H18V13H22M8,8H16V16H8V8Z"" />");
