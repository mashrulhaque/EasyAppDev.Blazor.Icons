...
{
    /// <summary>
    /// MdStorefrontEdit icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class MdStorefrontEdit : ComponentBase
    {
        /// <summary>
