...
{
    /// <summary>
    /// MdDiceD20Outline icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class MdDiceD20Outline : ComponentBase
    {
        /// <summary>
