...
{
    /// <summary>
    /// MdClockStarFourPoints icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class MdClockStarFourPoints : ComponentBase
    {
        /// <summary>
