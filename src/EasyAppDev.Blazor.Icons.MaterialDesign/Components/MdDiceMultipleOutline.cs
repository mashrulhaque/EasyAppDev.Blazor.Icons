...
{
    /// <summary>
    /// MdDiceMultipleOutline icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class MdDiceMultipleOutline : ComponentBase
    {
        /// <summary>
