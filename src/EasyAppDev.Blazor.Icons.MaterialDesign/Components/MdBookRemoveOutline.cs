...
{
    /// <summary>
    /// MdBookRemoveOutline icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class MdBookRemoveOutline : ComponentBase
    {
        /// <summary>
