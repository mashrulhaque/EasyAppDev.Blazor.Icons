...
{
    /// <summary>
    /// MdBookOpenBlankVariant icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class MdBookOpenBlankVariant : ComponentBase
    {
        /// <summary>
