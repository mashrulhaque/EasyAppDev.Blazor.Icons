...
{
    /// <summary>
    /// MdUnicode icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class MdUnicode : ComponentBase
    {
        /// <summary>
