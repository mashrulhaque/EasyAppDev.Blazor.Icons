...
{
    /// <summary>
    /// MdCarWrench icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class MdCarWrench : ComponentBase
    {
        /// <summary>
