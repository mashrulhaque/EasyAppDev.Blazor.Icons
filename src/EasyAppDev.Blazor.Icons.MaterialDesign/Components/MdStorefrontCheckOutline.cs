...
{
    /// <summary>
    /// MdStorefrontCheckOutline icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class MdStorefrontCheckOutline : ComponentBase
    {
        /// <summary>
