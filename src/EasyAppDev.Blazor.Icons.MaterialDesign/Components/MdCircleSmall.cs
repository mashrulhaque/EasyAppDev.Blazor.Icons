...
{
    /// <summary>
    /// MdCircleSmall icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class MdCircleSmall : ComponentBase
    {
        /// <summary>
        ...
        protected override void BuildRenderTree(RenderTreeBuilder builder)
        {
            ...
            // Inline SVG content
            builder.AddMarkupContent(13, @"<path d=""M12,10A2,2 0 0,0 10,12C10,13.11 10.9,14 12,14C13.11,14 14,13.11 14,12A2,2 0 0,0 12,10Z"" />");
