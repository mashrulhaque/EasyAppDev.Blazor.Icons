...
{
    /// <summary>
    /// MdPrinterPosSync icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class MdPrinterPosSync : ComponentBase
    {
        /// <summary>
