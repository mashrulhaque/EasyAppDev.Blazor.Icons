...
{
    /// <summary>
    /// MdHexagonSlice5 icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class MdHexagonSlice5 : ComponentBase
    {
        /// <summary>
