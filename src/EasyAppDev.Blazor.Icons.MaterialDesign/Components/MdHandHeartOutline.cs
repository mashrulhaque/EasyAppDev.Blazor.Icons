...
{
    /// <summary>
    /// MdHandHeartOutline icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class MdHandHeartOutline : ComponentBase
    {
        /// <summary>
