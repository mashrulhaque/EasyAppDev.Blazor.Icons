...
{
    /// <summary>
    /// MdCookieCog icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class MdCookieCog : ComponentBase
    {
        /// <summary>
