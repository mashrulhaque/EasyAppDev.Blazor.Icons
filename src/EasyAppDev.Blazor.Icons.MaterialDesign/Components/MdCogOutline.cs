...
{
    /// <summary>
    /// MdCogOutline icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class MdCogOutline : ComponentBase
    {
        /// <summary>
