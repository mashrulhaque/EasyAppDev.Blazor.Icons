...
{
    /// <summary>
    /// MdEmoticonCoolOutline icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class MdEmoticonCoolOutline : ComponentBase
    {
        /// <summary>
