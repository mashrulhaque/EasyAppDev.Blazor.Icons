...
{
    /// <summary>
    /// MdAccountFilter icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class MdAccountFilter : ComponentBase
    {
        /// <summary>
