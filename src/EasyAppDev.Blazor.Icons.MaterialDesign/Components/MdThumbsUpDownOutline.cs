...
{
    /// <summary>
    /// MdThumbsUpDownOutline icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class MdThumbsUpDownOutline : ComponentBase
    {
        /// <summary>
