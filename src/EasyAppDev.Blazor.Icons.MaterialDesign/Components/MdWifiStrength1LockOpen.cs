...
{
    /// <summary>
    /// MdWifiStrength1LockOpen icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class MdWifiStrength1LockOpen : ComponentBase
    {
        /// <summary>
