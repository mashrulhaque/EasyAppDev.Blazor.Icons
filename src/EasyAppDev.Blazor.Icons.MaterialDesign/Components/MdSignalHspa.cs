...
{
    /// <summary>
    /// MdSignalHspa icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class MdSignalHspa : ComponentBase
    {
        /// <summary>
        ...
        protected override void BuildRenderTree(RenderTreeBuilder builder)
        {
            ...
            // Inline SVG content
            builder.AddMarkupContent(13, @"<path d=""M10.5,10.5H13.5V4.5H16.5V19.5H13.5V13.5H10.5V19.5H7.5V4.5H10.5V10.5Z"" />");
