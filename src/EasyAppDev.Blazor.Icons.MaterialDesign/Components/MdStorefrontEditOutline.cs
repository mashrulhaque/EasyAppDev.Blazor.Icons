...
{
    /// <summary>
    /// MdStorefrontEditOutline icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class MdStorefrontEditOutline : ComponentBase
    {
        /// <summary>
