...
{
    /// <summary>
    /// MdPeanutOutline icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class MdPeanutOutline : ComponentBase
    {
        /// <summary>
