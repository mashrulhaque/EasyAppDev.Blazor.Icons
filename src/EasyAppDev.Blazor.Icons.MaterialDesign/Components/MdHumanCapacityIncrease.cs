...
{
    /// <summary>
    /// MdHumanCapacityIncrease icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class MdHumanCapacityIncrease : ComponentBase
    {
        /// <summary>
