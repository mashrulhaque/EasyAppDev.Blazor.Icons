...
{
    /// <summary>
    /// MdTransitionMasked icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class MdTransitionMasked : ComponentBase
    {
        /// <summary>
