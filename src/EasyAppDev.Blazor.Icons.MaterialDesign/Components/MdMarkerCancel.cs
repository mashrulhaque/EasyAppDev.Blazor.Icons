...
{
    /// <summary>
    /// MdMarkerCancel icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class MdMarkerCancel : ComponentBase
    {
        /// <summary>
