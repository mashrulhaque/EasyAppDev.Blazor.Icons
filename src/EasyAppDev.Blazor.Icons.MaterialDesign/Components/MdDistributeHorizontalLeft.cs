...
{
    /// <summary>
    /// MdDistributeHorizontalLeft icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class MdDistributeHorizontalLeft : ComponentBase
    {
        /// <summary>
        ...
        protected override void BuildRenderTree(RenderTreeBuilder builder)
        {
            ...
            // Inline SVG content
            builder.AddMarkupContent(13, @"<path d=""M21 7V17H16V22H14V2H16V7H21M5 2H3V22H5V19H10V5H5V2Z"" />");
