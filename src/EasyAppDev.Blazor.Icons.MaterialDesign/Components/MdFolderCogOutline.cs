...
{
    /// <summary>
    /// MdFolderCogOutline icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class MdFolderCogOutline : ComponentBase
    {
        /// <summary>
