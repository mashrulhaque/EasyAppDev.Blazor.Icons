...
{
    /// <summary>
    /// MdThermostat icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class MdThermostat : ComponentBase
    {
        /// <summary>
