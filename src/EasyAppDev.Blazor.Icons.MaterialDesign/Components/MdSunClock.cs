...
{
    /// <summary>
    /// MdSunClock icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class MdSunClock : ComponentBase
    {
        /// <summary>
