...
{
    /// <summary>
    /// MdLockPercentOpenOutline icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class MdLockPercentOpenOutline : ComponentBase
    {
        /// <summary>
