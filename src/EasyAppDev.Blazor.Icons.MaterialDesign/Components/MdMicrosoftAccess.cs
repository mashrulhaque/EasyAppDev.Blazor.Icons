...
{
    /// <summary>
    /// MdMicrosoftAccess icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class MdMicrosoftAccess : ComponentBase
    {
        /// <summary>
