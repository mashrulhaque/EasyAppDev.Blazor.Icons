...
{
    /// <summary>
    /// MdNotebookRemoveOutline icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class MdNotebookRemoveOutline : ComponentBase
    {
        /// <summary>
