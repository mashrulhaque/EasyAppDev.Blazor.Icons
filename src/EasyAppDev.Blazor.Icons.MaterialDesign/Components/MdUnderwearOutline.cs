...
{
    /// <summary>
    /// MdUnderwearOutline icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class MdUnderwearOutline : ComponentBase
    {
        /// <summary>
