...
{
    /// <summary>
    /// MdCogOffOutline icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class MdCogOffOutline : ComponentBase
    {
        /// <summary>
