...
{
    /// <summary>
    /// MdAlertRemoveOutline icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class MdAlertRemoveOutline : ComponentBase
    {
        /// <summary>
