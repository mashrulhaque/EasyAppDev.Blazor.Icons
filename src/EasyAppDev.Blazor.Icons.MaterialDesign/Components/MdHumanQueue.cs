...
{
    /// <summary>
    /// MdHumanQueue icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class MdHumanQueue : ComponentBase
    {
        /// <summary>
