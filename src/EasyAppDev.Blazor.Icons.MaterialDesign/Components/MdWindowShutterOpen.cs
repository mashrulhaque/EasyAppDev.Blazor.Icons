...
{
    /// <summary>
    /// MdWindowShutterOpen icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class MdWindowShutterOpen : ComponentBase
    {
        /// <summary>
        ...
        protected override void BuildRenderTree(RenderTreeBuilder builder)
        {
            ...
            // Inline SVG content
            builder.AddMarkupContent(13, @"<path d=""M3 4H21V8H19V20H17V8H7V20H5V8H3V4M8 9H16V11H8V9Z"" />");
