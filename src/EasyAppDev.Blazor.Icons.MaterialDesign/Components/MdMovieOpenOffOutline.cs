...
{
    /// <summary>
    /// MdMovieOpenOffOutline icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class MdMovieOpenOffOutline : ComponentBase
    {
        /// <summary>
