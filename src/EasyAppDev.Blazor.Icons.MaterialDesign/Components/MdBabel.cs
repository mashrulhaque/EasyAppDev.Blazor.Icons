...
{
    /// <summary>
    /// MdBabel icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class MdBabel : ComponentBase
    {
        /// <summary>
