...
{
    /// <summary>
    /// MdHumanDolly icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class MdHumanDolly : ComponentBase
    {
        /// <summary>
