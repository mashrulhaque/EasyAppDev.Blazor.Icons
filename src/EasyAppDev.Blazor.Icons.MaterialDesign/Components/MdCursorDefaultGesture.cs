...
{
    /// <summary>
    /// MdCursorDefaultGesture icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class MdCursorDefaultGesture : ComponentBase
    {
        /// <summary>
