...
{
    /// <summary>
    /// MdReply icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class MdReply : ComponentBase
    {
        /// <summary>
        ...
        protected override void BuildRenderTree(RenderTreeBuilder builder)
        {
            ...
            // Inline SVG content
            builder.AddMarkupContent(13, @"<path d=""M10,9V5L3,12L10,19V14.9C15,14.9 18.5,16.5 21,20C20,15 17,10 10,9Z"" />");
