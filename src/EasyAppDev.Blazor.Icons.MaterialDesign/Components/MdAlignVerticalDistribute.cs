...
{
    /// <summary>
    /// MdAlignVerticalDistribute icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class MdAlignVerticalDistribute : ComponentBase
    {
        /// <summary>
        ...
        protected override void BuildRenderTree(RenderTreeBuilder builder)
        {
            ...
            // Inline SVG content
            builder.AddMarkupContent(13, @"<path d=""M22 2V4H2V2H22M7 10.5V13.5H17V10.5H7M2 20V22H22V20H2Z"" />");
