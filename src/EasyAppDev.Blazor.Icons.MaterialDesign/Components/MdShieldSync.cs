...
{
    /// <summary>
    /// MdShieldSync icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class MdShieldSync : ComponentBase
    {
        /// <summary>
