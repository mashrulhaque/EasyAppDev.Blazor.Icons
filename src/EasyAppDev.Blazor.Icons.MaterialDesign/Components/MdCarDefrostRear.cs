...
{
    /// <summary>
    /// MdCarDefrostRear icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class MdCarDefrostRear : ComponentBase
    {
        /// <summary>
