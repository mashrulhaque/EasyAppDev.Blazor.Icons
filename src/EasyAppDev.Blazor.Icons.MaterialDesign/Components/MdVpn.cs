...
{
    /// <summary>
    /// MdVpn icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class MdVpn : ComponentBase
    {
        /// <summary>
