...
{
    /// <summary>
    /// MdMoonWaxingGibbous icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class MdMoonWaxingGibbous : ComponentBase
    {
        /// <summary>
        ...
        protected override void BuildRenderTree(RenderTreeBuilder builder)
        {
            ...
            // Inline SVG content
            builder.AddMarkupContent(13, @"<path d=""M6 12C6 7.5 7.93 3.26 12 2A10 10 0 0 1 12 22C7.93 20.74 6 16.5 6 12Z"" />");
