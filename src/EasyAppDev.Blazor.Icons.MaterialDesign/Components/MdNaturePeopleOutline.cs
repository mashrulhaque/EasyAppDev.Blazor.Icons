...
{
    /// <summary>
    /// MdNaturePeopleOutline icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class MdNaturePeopleOutline : ComponentBase
    {
        /// <summary>
