...
{
    /// <summary>
    /// MdFolderLock icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class MdFolderLock : ComponentBase
    {
        /// <summary>
