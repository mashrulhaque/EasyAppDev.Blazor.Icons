...
{
    /// <summary>
    /// MdLightbulbMultipleOutline icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class MdLightbulbMultipleOutline : ComponentBase
    {
        /// <summary>
