...
{
    /// <summary>
    /// MdAccountChildOutline icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class MdAccountChildOutline : ComponentBase
    {
        /// <summary>
