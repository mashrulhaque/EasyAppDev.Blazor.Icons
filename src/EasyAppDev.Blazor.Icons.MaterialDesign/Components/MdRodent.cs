...
{
    /// <summary>
    /// MdRodent icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class MdRodent : ComponentBase
    {
        /// <summary>
