...
{
    /// <summary>
    /// MdLightbulbGroupOffOutline icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class MdLightbulbGroupOffOutline : ComponentBase
    {
        /// <summary>
