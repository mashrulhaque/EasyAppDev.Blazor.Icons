...
{
    /// <summary>
    /// MdHubOutline icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class MdHubOutline : ComponentBase
    {
        /// <summary>
