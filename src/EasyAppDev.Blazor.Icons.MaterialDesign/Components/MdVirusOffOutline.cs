...
{
    /// <summary>
    /// MdVirusOffOutline icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class MdVirusOffOutline : ComponentBase
    {
        /// <summary>
