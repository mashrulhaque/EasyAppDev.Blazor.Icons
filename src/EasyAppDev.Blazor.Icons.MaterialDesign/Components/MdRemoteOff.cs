...
{
    /// <summary>
    /// MdRemoteOff icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class MdRemoteOff : ComponentBase
    {
        /// <summary>
