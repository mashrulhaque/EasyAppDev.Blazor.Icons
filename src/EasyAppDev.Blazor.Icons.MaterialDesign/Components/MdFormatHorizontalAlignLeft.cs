...
{
    /// <summary>
    /// MdFormatHorizontalAlignLeft icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class MdFormatHorizontalAlignLeft : ComponentBase
    {
        /// <summary>
        ...
        protected override void BuildRenderTree(RenderTreeBuilder builder)
        {
            ...
            // Inline SVG content
            builder.AddMarkupContent(13, @"<path d=""M11,16V13H21V11H11V8L7,12L11,16M3,20H5V4H3V20Z"" />");
