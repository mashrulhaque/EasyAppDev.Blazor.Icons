...
{
    /// <summary>
    /// MdDistributeHorizontalCenter icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class MdDistributeHorizontalCenter : ComponentBase
    {
        /// <summary>
        ...
        protected override void BuildRenderTree(RenderTreeBuilder builder)
        {
            ...
            // Inline SVG content
            builder.AddMarkupContent(13, @"<path d=""M8 2V5H10V19H8V22H6V19H4V5H6V2H8M16 2V7H14V17H16V22H18V17H20V7H18V2H16Z"" />");
