...
{
    /// <summary>
    /// MdRotate3d icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class MdRotate3d : ComponentBase
    {
        /// <summary>
