...
{
    /// <summary>
    /// MdSendClockOutline icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class MdSendClockOutline : ComponentBase
    {
        /// <summary>
