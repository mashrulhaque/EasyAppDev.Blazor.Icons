...
{
    /// <summary>
    /// MdRadioactive icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class MdRadioactive : ComponentBase
    {
        /// <summary>
