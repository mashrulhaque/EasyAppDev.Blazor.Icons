...
{
    /// <summary>
    /// MdLiquidSpot icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class MdLiquidSpot : ComponentBase
    {
        /// <summary>
