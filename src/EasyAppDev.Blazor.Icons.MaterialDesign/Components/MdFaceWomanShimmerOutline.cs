...
{
    /// <summary>
    /// MdFaceWomanShimmerOutline icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class MdFaceWomanShimmerOutline : ComponentBase
    {
        /// <summary>
