...
{
    /// <summary>
    /// MdWindowRestore icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class MdWindowRestore : ComponentBase
    {
        /// <summary>
        ...
        protected override void BuildRenderTree(RenderTreeBuilder builder)
        {
            ...
            // Inline SVG content
            builder.AddMarkupContent(13, @"<path d=""M4,8H8V4H20V16H16V20H4V8M16,8V14H18V6H10V8H16M6,12V18H14V12H6Z"" />");
