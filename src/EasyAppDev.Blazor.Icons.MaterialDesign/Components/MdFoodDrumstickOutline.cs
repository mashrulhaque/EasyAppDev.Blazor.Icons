...
{
    /// <summary>
    /// MdFoodDrumstickOutline icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class MdFoodDrumstickOutline : ComponentBase
    {
        /// <summary>
