...
{
    /// <summary>
    /// MdSubwayVariant icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class MdSubwayVariant : ComponentBase
    {
        /// <summary>
