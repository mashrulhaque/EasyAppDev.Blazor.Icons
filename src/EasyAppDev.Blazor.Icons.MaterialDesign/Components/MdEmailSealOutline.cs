...
{
    /// <summary>
    /// MdEmailSealOutline icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class MdEmailSealOutline : ComponentBase
    {
        /// <summary>
