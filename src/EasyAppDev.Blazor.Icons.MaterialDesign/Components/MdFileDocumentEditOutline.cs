...
{
    /// <summary>
    /// MdFileDocumentEditOutline icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class MdFileDocumentEditOutline : ComponentBase
    {
        /// <summary>
