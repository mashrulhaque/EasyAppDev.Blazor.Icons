...
{
    /// <summary>
    /// MdTimerLockOpen icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class MdTimerLockOpen : ComponentBase
    {
        /// <summary>
