...
{
    /// <summary>
    /// MdAccessPointOff icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class MdAccessPointOff : ComponentBase
    {
        /// <summary>
