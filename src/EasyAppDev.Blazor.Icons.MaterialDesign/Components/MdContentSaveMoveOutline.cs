...
{
    /// <summary>
    /// MdContentSaveMoveOutline icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class MdContentSaveMoveOutline : ComponentBase
    {
        /// <summary>
