...
{
    /// <summary>
    /// MdEmoticonMinusOutline icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class MdEmoticonMinusOutline : ComponentBase
    {
        /// <summary>
