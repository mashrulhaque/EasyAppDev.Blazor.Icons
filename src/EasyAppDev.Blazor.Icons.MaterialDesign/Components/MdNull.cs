...
{
    /// <summary>
    /// MdNull icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class MdNull : ComponentBase
    {
        /// <summary>
