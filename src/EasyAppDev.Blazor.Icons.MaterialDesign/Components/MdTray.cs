...
{
    /// <summary>
    /// MdTray icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class MdTray : ComponentBase
    {
        /// <summary>
        ...
        protected override void BuildRenderTree(RenderTreeBuilder builder)
        {
            ...
            // Inline SVG content
            builder.AddMarkupContent(13, @"<path d=""M2 12H4V17H20V12H22V17A2 2 0 0 1 20 19H4A2 2 0 0 1 2 17Z"" />");
