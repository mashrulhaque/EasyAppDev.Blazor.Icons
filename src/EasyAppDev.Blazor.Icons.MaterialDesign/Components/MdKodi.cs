...
{
    /// <summary>
    /// MdKodi icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class MdKodi : ComponentBase
    {
        /// <summary>
