...
{
    /// <summary>
    /// MdWiperWashAlert icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class MdWiperWashAlert : ComponentBase
    {
        /// <summary>
