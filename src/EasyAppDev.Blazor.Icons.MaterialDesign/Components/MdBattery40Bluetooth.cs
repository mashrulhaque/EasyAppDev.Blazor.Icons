...
{
    /// <summary>
    /// MdBattery40Bluetooth icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class MdBattery40Bluetooth : ComponentBase
    {
        /// <summary>
