...
{
    /// <summary>
    /// MdSmoke icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class MdSmoke : ComponentBase
    {
        /// <summary>
