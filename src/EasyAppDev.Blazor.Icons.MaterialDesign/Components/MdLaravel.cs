...
{
    /// <summary>
    /// MdLaravel icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class MdLaravel : ComponentBase
    {
        /// <summary>
