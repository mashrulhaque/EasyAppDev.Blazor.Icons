...
{
    /// <summary>
    /// MdSeatReclineNormal icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class MdSeatReclineNormal : ComponentBase
    {
        /// <summary>
