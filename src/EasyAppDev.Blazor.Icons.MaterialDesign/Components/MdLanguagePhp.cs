...
{
    /// <summary>
    /// MdLanguagePhp icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class MdLanguagePhp : ComponentBase
    {
        /// <summary>
