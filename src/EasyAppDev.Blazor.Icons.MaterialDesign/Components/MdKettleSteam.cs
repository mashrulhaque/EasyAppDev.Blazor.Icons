...
{
    /// <summary>
    /// MdKettleSteam icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class MdKettleSteam : ComponentBase
    {
        /// <summary>
