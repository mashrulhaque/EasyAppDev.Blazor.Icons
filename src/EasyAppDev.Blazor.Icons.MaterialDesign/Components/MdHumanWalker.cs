...
{
    /// <summary>
    /// MdHumanWalker icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class MdHumanWalker : ComponentBase
    {
        /// <summary>
