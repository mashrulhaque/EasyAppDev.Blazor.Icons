...
{
    /// <summary>
    /// MdFoodDrumstick icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class MdFoodDrumstick : ComponentBase
    {
        /// <summary>
