...
{
    /// <summary>
    /// MdVideo3dVariant icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class MdVideo3dVariant : ComponentBase
    {
        /// <summary>
