...
{
    /// <summary>
    /// MdDistributeVerticalTop icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class MdDistributeVerticalTop : ComponentBase
    {
        /// <summary>
        ...
        protected override void BuildRenderTree(RenderTreeBuilder builder)
        {
            ...
            // Inline SVG content
            builder.AddMarkupContent(13, @"<path d=""M17 21H7V16H2V14H22V16H17V21M22 5V3H2V5H5V10H19V5H22Z"" />");
