...
{
    /// <summary>
    /// MdQuadcopter icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class MdQuadcopter : ComponentBase
    {
        /// <summary>
