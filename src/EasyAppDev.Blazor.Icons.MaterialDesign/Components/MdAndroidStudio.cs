...
{
    /// <summary>
    /// MdAndroidStudio icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class MdAndroidStudio : ComponentBase
    {
        /// <summary>
