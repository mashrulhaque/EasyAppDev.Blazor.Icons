...
{
    /// <summary>
    /// MdFolderWrench icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class MdFolderWrench : ComponentBase
    {
        /// <summary>
