...
{
    /// <summary>
    /// MdCommentEyeOutline icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class MdCommentEyeOutline : ComponentBase
    {
        /// <summary>
