...
{
    /// <summary>
    /// MdForumRemoveOutline icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class MdForumRemoveOutline : ComponentBase
    {
        /// <summary>
