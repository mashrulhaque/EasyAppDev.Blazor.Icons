...
{
    /// <summary>
    /// MdBattery80Bluetooth icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class MdBattery80Bluetooth : ComponentBase
    {
        /// <summary>
