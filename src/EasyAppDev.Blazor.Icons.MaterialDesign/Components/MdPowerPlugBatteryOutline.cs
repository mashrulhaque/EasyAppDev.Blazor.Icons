...
{
    /// <summary>
    /// MdPowerPlugBatteryOutline icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class MdPowerPlugBatteryOutline : ComponentBase
    {
        /// <summary>
