...
{
    /// <summary>
    /// MdWifiStrength1Alert icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class MdWifiStrength1Alert : ComponentBase
    {
        /// <summary>
