...
{
    /// <summary>
    /// MdSharkOff icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class MdSharkOff : ComponentBase
    {
        /// <summary>
