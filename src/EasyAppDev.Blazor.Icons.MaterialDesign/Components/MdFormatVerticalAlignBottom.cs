...
{
    /// <summary>
    /// MdFormatVerticalAlignBottom icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class MdFormatVerticalAlignBottom : ComponentBase
    {
        /// <summary>
        ...
        protected override void BuildRenderTree(RenderTreeBuilder builder)
        {
            ...
            // Inline SVG content
            builder.AddMarkupContent(13, @"<path d=""M16,13H13V3H11V13H8L12,17L16,13M4,19V21H20V19H4Z"" />");
