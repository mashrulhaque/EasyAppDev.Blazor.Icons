...
{
    /// <summary>
    /// MdFileDocumentRefresh icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class MdFileDocumentRefresh : ComponentBase
    {
        /// <summary>
