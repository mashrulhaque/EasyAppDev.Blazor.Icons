...
{
    /// <summary>
    /// MdFishbowl icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class MdFishbowl : ComponentBase
    {
        /// <summary>
