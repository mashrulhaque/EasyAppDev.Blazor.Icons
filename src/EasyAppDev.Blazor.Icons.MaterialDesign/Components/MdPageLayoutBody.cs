...
{
    /// <summary>
    /// MdPageLayoutBody icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class MdPageLayoutBody : ComponentBase
    {
        /// <summary>
        ...
        protected override void BuildRenderTree(RenderTreeBuilder builder)
        {
            ...
            // Inline SVG content
            builder.AddMarkupContent(13, @"<path d=""M6,2H18A2,2 0 0,1 20,4V20A2,2 0 0,1 18,22H6A2,2 0 0,1 4,20V4A2,2 0 0,1 6,2M6,8V16H18V8H6Z"" />");
