...
{
    /// <summary>
    /// MdBeekeeper icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class MdBeekeeper : ComponentBase
    {
        /// <summary>
