...
{
    /// <summary>
    /// MdNumericPositive1 icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class MdNumericPositive1 : ComponentBase
    {
        /// <summary>
        ...
        protected override void BuildRenderTree(RenderTreeBuilder builder)
        {
            ...
            // Inline SVG content
            builder.AddMarkupContent(13, @"<path d=""M13 7V9H15V17H17V7H13M11 13H9V15H7V13H5V11H7V9H9V11H11V13Z"" />");
