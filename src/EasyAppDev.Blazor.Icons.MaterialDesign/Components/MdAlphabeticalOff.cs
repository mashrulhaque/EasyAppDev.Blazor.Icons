...
{
    /// <summary>
    /// MdAlphabeticalOff icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class MdAlphabeticalOff : ComponentBase
    {
        /// <summary>
