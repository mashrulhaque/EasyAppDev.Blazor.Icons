...
{
    /// <summary>
    /// MdFormatFloatCenter icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class MdFormatFloatCenter : ComponentBase
    {
        /// <summary>
        ...
        protected override void BuildRenderTree(RenderTreeBuilder builder)
        {
            ...
            // Inline SVG content
            builder.AddMarkupContent(13, @"<path d=""M9,7H15V13H9V7M3,3H21V5H3V3M3,15H21V17H3V15M3,19H17V21H3V19Z"" />");
