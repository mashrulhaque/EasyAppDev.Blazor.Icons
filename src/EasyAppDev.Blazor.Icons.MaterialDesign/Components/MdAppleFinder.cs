...
{
    /// <summary>
    /// MdAppleFinder icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class MdAppleFinder : ComponentBase
    {
        /// <summary>
