...
{
    /// <summary>
    /// MdAccountQuestionOutline icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class MdAccountQuestionOutline : ComponentBase
    {
        /// <summary>
