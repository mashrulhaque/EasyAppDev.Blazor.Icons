...
{
    /// <summary>
    /// MdRewind60 icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class MdRewind60 : ComponentBase
    {
        /// <summary>
