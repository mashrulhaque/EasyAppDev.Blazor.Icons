...
{
    /// <summary>
    /// MdBasketPlusOutline icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class MdBasketPlusOutline : ComponentBase
    {
        /// <summary>
