...
{
    /// <summary>
    /// MdCookieClock icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class MdCookieClock : ComponentBase
    {
        /// <summary>
