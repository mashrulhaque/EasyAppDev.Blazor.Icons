...
{
    /// <summary>
    /// MdNumeric8BoxOutline icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class MdNumeric8BoxOutline : ComponentBase
    {
        /// <summary>
