...
{
    /// <summary>
    /// MdShuffleDisabled icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class MdShuffleDisabled : ComponentBase
    {
        /// <summary>
        ...
        protected override void BuildRenderTree(RenderTreeBuilder builder)
        {
            ...
            // Inline SVG content
            builder.AddMarkupContent(13, @"<path d=""M16,4.5V7H5V9H16V11.5L19.5,8M16,12.5V15H5V17H16V19.5L19.5,16"" />");
