...
{
    /// <summary>
    /// MdFormatQuoteClose icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class MdFormatQuoteClose : ComponentBase
    {
        /// <summary>
        ...
        protected override void BuildRenderTree(RenderTreeBuilder builder)
        {
            ...
            // Inline SVG content
            builder.AddMarkupContent(13, @"<path d=""M14,17H17L19,13V7H13V13H16M6,17H9L11,13V7H5V13H8L6,17Z"" />");
