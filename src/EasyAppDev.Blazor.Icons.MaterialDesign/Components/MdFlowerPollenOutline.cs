...
{
    /// <summary>
    /// MdFlowerPollenOutline icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class MdFlowerPollenOutline : ComponentBase
    {
        /// <summary>
