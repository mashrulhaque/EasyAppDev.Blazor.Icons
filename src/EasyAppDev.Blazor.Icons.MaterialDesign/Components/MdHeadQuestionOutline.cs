...
{
    /// <summary>
    /// MdHeadQuestionOutline icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class MdHeadQuestionOutline : ComponentBase
    {
        /// <summary>
