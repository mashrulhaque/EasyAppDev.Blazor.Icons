...
{
    /// <summary>
    /// MdKeyboardSettings icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class MdKeyboardSettings : ComponentBase
    {
        /// <summary>
