...
{
    /// <summary>
    /// MdFilterSettingsOutline icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class MdFilterSettingsOutline : ComponentBase
    {
        /// <summary>
