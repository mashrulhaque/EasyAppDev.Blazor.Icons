...
{
    /// <summary>
    /// MdWifiStrength3Lock icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class MdWifiStrength3Lock : ComponentBase
    {
        /// <summary>
