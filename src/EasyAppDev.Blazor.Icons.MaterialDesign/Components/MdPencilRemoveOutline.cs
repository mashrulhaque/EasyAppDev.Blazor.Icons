...
{
    /// <summary>
    /// MdPencilRemoveOutline icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class MdPencilRemoveOutline : ComponentBase
    {
        /// <summary>
