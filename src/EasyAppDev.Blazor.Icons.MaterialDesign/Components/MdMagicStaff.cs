...
{
    /// <summary>
    /// MdMagicStaff icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class MdMagicStaff : ComponentBase
    {
        /// <summary>
