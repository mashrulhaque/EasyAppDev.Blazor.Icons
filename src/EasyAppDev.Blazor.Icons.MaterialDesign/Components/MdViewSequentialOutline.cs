...
{
    /// <summary>
    /// MdViewSequentialOutline icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class MdViewSequentialOutline : ComponentBase
    {
        /// <summary>
        ...
        protected override void BuildRenderTree(RenderTreeBuilder builder)
        {
            ...
            // Inline SVG content
            builder.AddMarkupContent(13, @"<path d=""M3 5V19H21V5H3M19 7V9H5V7H19M19 11V13H5V11H19M5 17V15H19V17H5Z"" />");
