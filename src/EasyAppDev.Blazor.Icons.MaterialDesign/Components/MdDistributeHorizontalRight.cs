...
{
    /// <summary>
    /// MdDistributeHorizontalRight icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class MdDistributeHorizontalRight : ComponentBase
    {
        /// <summary>
        ...
        protected override void BuildRenderTree(RenderTreeBuilder builder)
        {
            ...
            // Inline SVG content
            builder.AddMarkupContent(13, @"<path d=""M3 17V7H8V2H10V22H8V17H3M19 22H21V2H19V5H14V19H19V22Z"" />");
