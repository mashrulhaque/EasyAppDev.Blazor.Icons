...
{
    /// <summary>
    /// MdArrowTopRightBottomLeft icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class MdArrowTopRightBottomLeft : ComponentBase
    {
        /// <summary>
        ...
        protected override void BuildRenderTree(RenderTreeBuilder builder)
        {
            ...
            // Inline SVG content
            builder.AddMarkupContent(13, @"<path d=""M11,21H3V13H5V17.59L17.59,5H13V3H21V11H19V6.41L6.41,19H11V21Z"" />");
