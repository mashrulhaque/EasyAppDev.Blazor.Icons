...
{
    /// <summary>
    /// MdChartAreasplineVariant icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class MdChartAreasplineVariant : ComponentBase
    {
        /// <summary>
        ...
        protected override void BuildRenderTree(RenderTreeBuilder builder)
        {
            ...
            // Inline SVG content
            builder.AddMarkupContent(13, @"<path d=""M22,21H2V3H4V15.54L9.5,6L16,9.78L20.24,2.45L21.97,3.45L22,21Z"" />");
