...
{
    /// <summary>
    /// MdCreditCardRefresh icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class MdCreditCardRefresh : ComponentBase
    {
        /// <summary>
