...
{
    /// <summary>
    /// MdBicycle icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class MdBicycle : ComponentBase
    {
        /// <summary>
