...
{
    /// <summary>
    /// MdContactlessPayment icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class MdContactlessPayment : ComponentBase
    {
        /// <summary>
