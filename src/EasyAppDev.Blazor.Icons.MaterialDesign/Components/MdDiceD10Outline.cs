...
{
    /// <summary>
    /// MdDiceD10Outline icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class MdDiceD10Outline : ComponentBase
    {
        /// <summary>
