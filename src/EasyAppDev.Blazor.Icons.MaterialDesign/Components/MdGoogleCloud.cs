...
{
    /// <summary>
    /// MdGoogleCloud icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class MdGoogleCloud : ComponentBase
    {
        /// <summary>
