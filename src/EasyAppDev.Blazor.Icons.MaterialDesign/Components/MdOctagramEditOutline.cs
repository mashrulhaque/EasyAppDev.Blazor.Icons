...
{
    /// <summary>
    /// MdOctagramEditOutline icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class MdOctagramEditOutline : ComponentBase
    {
        /// <summary>
