...
{
    /// <summary>
    /// MdApplicationCogOutline icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class MdApplicationCogOutline : ComponentBase
    {
        /// <summary>
