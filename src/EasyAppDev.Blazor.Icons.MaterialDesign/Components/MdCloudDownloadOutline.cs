...
{
    /// <summary>
    /// MdCloudDownloadOutline icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class MdCloudDownloadOutline : ComponentBase
    {
        /// <summary>
