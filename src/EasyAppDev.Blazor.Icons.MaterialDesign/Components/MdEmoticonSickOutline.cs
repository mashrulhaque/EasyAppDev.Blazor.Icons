...
{
    /// <summary>
    /// MdEmoticonSickOutline icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class MdEmoticonSickOutline : ComponentBase
    {
        /// <summary>
