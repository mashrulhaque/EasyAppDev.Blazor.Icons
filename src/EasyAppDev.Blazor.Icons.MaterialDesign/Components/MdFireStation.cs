...
{
    /// <summary>
    /// MdFireStation icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class MdFireStation : ComponentBase
    {
        /// <summary>
