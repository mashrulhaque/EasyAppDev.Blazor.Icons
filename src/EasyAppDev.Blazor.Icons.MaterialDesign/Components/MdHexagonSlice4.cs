...
{
    /// <summary>
    /// MdHexagonSlice4 icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class MdHexagonSlice4 : ComponentBase
    {
        /// <summary>
