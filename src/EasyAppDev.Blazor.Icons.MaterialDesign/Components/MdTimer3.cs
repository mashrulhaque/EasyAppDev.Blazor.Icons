...
{
    /// <summary>
    /// MdTimer3 icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class MdTimer3 : ComponentBase
    {
        /// <summary>
