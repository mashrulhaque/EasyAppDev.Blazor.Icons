...
{
    /// <summary>
    /// MdFingerprintOff icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class MdFingerprintOff : ComponentBase
    {
        /// <summary>
