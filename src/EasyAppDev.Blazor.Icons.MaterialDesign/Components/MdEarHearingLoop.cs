...
{
    /// <summary>
    /// MdEarHearingLoop icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class MdEarHearingLoop : ComponentBase
    {
        /// <summary>
