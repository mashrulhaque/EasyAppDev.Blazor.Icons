...
{
    /// <summary>
    /// MdFoodTurkey icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class MdFoodTurkey : ComponentBase
    {
        /// <summary>
