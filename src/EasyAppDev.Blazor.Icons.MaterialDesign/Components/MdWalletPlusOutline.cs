...
{
    /// <summary>
    /// MdWalletPlusOutline icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class MdWalletPlusOutline : ComponentBase
    {
        /// <summary>
