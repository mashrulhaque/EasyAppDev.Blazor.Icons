...
{
    /// <summary>
    /// MdMenorahFire icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class MdMenorahFire : ComponentBase
    {
        /// <summary>
