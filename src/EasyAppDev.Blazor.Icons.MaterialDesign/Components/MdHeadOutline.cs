...
{
    /// <summary>
    /// MdHeadOutline icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class MdHeadOutline : ComponentBase
    {
        /// <summary>
