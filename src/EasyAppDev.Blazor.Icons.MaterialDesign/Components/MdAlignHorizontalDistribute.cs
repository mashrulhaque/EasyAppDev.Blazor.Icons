...
{
    /// <summary>
    /// MdAlignHorizontalDistribute icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class MdAlignHorizontalDistribute : ComponentBase
    {
        /// <summary>
        ...
        protected override void BuildRenderTree(RenderTreeBuilder builder)
        {
            ...
            // Inline SVG content
            builder.AddMarkupContent(13, @"<path d=""M4 22H2V2H4V22M22 2H20V22H22V2M13.5 7H10.5V17H13.5V7Z"" />");
