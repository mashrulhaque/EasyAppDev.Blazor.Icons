...
{
    /// <summary>
    /// MdCarBrakeWornLinings icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class MdCarBrakeWornLinings : ComponentBase
    {
        /// <summary>
