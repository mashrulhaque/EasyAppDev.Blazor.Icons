...
{
    /// <summary>
    /// MdWifiStrength2LockOpen icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class MdWifiStrength2LockOpen : ComponentBase
    {
        /// <summary>
