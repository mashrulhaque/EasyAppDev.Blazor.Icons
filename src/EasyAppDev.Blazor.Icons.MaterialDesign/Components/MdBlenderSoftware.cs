...
{
    /// <summary>
    /// MdBlenderSoftware icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class MdBlenderSoftware : ComponentBase
    {
        /// <summary>
