...
{
    /// <summary>
    /// MdStoreCogOutline icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class MdStoreCogOutline : ComponentBase
    {
        /// <summary>
