...
{
    /// <summary>
    /// MdMeteor icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class MdMeteor : ComponentBase
    {
        /// <summary>
