...
{
    /// <summary>
    /// MdMagazineRifle icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class MdMagazineRifle : ComponentBase
    {
        /// <summary>
        ...
        protected override void BuildRenderTree(RenderTreeBuilder builder)
        {
            ...
            // Inline SVG content
            builder.AddMarkupContent(13, @"<path d=""M7 1V3H8V13L5 19L14 23L18 13V3H19V1M10 3H16V5H11.88V13.45L9.6 18.14L8 17.5L10 13.5Z"" />");
