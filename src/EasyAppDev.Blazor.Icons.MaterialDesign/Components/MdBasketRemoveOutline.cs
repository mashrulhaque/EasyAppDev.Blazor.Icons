...
{
    /// <summary>
    /// MdBasketRemoveOutline icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class MdBasketRemoveOutline : ComponentBase
    {
        /// <summary>
