...
{
    /// <summary>
    /// MdMathCos icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class MdMathCos : ComponentBase
    {
        /// <summary>
