...
{
    /// <summary>
    /// MdUnicorn icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class MdUnicorn : ComponentBase
    {
        /// <summary>
