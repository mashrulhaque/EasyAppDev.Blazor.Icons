...
{
    /// <summary>
    /// LuMicrowave icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class LuMicrowave : ComponentBase
    {
        /// <summary>
        ...
        protected override void BuildRenderTree(RenderTreeBuilder builder)
        {
            ...
            // Inline SVG content
            builder.AddMarkupContent(13, @"<rect width=""20"" height=""15"" x=""2"" y=""4"" rx=""2"" /> <rect width=""8"" height=""7"" x=""6"" y=""8"" rx=""1"" /> <path d=""M18 8v7"" /> <path d=""M6 19v2"" /> <path d=""M18 19v2"" />");
