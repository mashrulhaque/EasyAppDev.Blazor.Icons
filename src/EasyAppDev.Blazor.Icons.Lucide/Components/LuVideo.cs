...
{
    /// <summary>
    /// LuVideo icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class LuVideo : ComponentBase
    {
        /// <summary>
        ...
        protected override void BuildRenderTree(RenderTreeBuilder builder)
        {
            ...
            // Inline SVG content
            builder.AddMarkupContent(13, @"<path d=""m16 13 5.223 3.482a.5.5 0 0 0 .777-.416V7.87a.5.5 0 0 0-.752-.432L16 10.5"" /> <rect x=""2"" y=""6"" width=""14"" height=""12"" rx=""2"" />");
