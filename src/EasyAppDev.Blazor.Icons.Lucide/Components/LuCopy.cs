...
{
    /// <summary>
    /// LuCopy icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class LuCopy : ComponentBase
    {
        /// <summary>
        ...
        protected override void BuildRenderTree(RenderTreeBuilder builder)
        {
            ...
            // Inline SVG content
            builder.AddMarkupContent(13, @"<rect width=""14"" height=""14"" x=""8"" y=""8"" rx=""2"" ry=""2"" /> <path d=""M4 16c-1.1 0-2-.9-2-2V4c0-1.1.9-2 2-2h10c1.1 0 2 .9 2 2"" />");
