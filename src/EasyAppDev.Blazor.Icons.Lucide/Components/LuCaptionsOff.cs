...
{
    /// <summary>
    /// LuCaptionsOff icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class LuCaptionsOff : ComponentBase
    {
        /// <summary>
        ...
        protected override void BuildRenderTree(RenderTreeBuilder builder)
        {
            ...
            // Inline SVG content
            builder.AddMarkupContent(13, @"<path d=""M10.5 5H19a2 2 0 0 1 2 2v8.5"" /> <path d=""M17 11h-.5"" /> <path d=""M19 19H5a2 2 0 0 1-2-2V7a2 2 0 0 1 2-2"" /> <path d=""m2 2 20 20"" /> <path d=""M7 11h4"" /> <path d=""M7 15h2.5"" />");
