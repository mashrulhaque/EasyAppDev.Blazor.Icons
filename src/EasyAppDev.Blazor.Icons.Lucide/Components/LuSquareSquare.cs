...
{
    /// <summary>
    /// LuSquareSquare icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class LuSquareSquare : ComponentBase
    {
        /// <summary>
        ...
        protected override void BuildRenderTree(RenderTreeBuilder builder)
        {
            ...
            // Inline SVG content
            builder.AddMarkupContent(13, @"<rect x=""3"" y=""3"" width=""18"" height=""18"" rx=""2"" /> <rect x=""8"" y=""8"" width=""8"" height=""8"" rx=""1"" />");
