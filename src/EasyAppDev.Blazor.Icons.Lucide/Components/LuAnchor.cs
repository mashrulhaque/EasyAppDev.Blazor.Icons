...
{
    /// <summary>
    /// LuAnchor icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class LuAnchor : ComponentBase
    {
        /// <summary>
        ...
        protected override void BuildRenderTree(RenderTreeBuilder builder)
        {
            ...
            // Inline SVG content
            builder.AddMarkupContent(13, @"<path d=""M12 22V8"" /> <path d=""M5 12H2a10 10 0 0 0 20 0h-3"" /> <circle cx=""12"" cy=""5"" r=""3"" />");
