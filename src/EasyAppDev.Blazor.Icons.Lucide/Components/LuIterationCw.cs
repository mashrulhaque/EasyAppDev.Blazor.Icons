...
{
    /// <summary>
    /// LuIterationCw icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class LuIterationCw : ComponentBase
    {
        /// <summary>
        ...
        protected override void BuildRenderTree(RenderTreeBuilder builder)
        {
            ...
            // Inline SVG content
            builder.AddMarkupContent(13, @"<path d=""M4 10c0-4.4 3.6-8 8-8s8 3.6 8 8-3.6 8-8 8H4"" /> <polyline points=""8 22 4 18 8 14"" />");
