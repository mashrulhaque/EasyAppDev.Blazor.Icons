...
{
    /// <summary>
    /// LuAlarmClockCheck icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class LuAlarmClockCheck : ComponentBase
    {
        /// <summary>
        ...
        protected override void BuildRenderTree(RenderTreeBuilder builder)
        {
            ...
            // Inline SVG content
            builder.AddMarkupContent(13, @"<circle cx=""12"" cy=""13"" r=""8"" /> <path d=""M5 3 2 6"" /> <path d=""m22 6-3-3"" /> <path d=""M6.38 18.7 4 21"" /> <path d=""M17.64 18.67 20 21"" /> <path d=""m9 13 2 2 4-4"" />");
