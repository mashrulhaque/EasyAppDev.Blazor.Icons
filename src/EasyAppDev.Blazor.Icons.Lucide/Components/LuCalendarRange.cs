...
{
    /// <summary>
    /// LuCalendarRange icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class LuCalendarRange : ComponentBase
    {
        /// <summary>
        ...
        protected override void BuildRenderTree(RenderTreeBuilder builder)
        {
            ...
            // Inline SVG content
            builder.AddMarkupContent(13, @"<rect width=""18"" height=""18"" x=""3"" y=""4"" rx=""2"" /> <path d=""M16 2v4"" /> <path d=""M3 10h18"" /> <path d=""M8 2v4"" /> <path d=""M17 14h-6"" /> <path d=""M13 18H7"" /> <path d=""M7 14h.01"" /> <path d=""M17 18h.01"" />");
