...
{
    /// <summary>
    /// LuSquareArrowUp icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class LuSquareArrowUp : ComponentBase
    {
        /// <summary>
        ...
        protected override void BuildRenderTree(RenderTreeBuilder builder)
        {
            ...
            // Inline SVG content
            builder.AddMarkupContent(13, @"<rect width=""18"" height=""18"" x=""3"" y=""3"" rx=""2"" /> <path d=""m16 12-4-4-4 4"" /> <path d=""M12 16V8"" />");
