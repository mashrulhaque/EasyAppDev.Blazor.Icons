...
{
    /// <summary>
    /// LuAppWindow icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class LuAppWindow : ComponentBase
    {
        /// <summary>
        ...
        protected override void BuildRenderTree(RenderTreeBuilder builder)
        {
            ...
            // Inline SVG content
            builder.AddMarkupContent(13, @"<rect x=""2"" y=""4"" width=""20"" height=""16"" rx=""2"" /> <path d=""M10 4v4"" /> <path d=""M2 8h20"" /> <path d=""M6 4v4"" />");
