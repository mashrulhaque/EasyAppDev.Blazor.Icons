...
{
    /// <summary>
    /// LuCircleUserRound icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class LuCircleUserRound : ComponentBase
    {
        /// <summary>
        ...
        protected override void BuildRenderTree(RenderTreeBuilder builder)
        {
            ...
            // Inline SVG content
            builder.AddMarkupContent(13, @"<path d=""M18 20a6 6 0 0 0-12 0"" /> <circle cx=""12"" cy=""10"" r=""4"" /> <circle cx=""12"" cy=""12"" r=""10"" />");
