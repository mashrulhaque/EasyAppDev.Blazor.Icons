...
{
    /// <summary>
    /// LuListVideo icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class LuListVideo : ComponentBase
    {
        /// <summary>
        ...
        protected override void BuildRenderTree(RenderTreeBuilder builder)
        {
            ...
            // Inline SVG content
            builder.AddMarkupContent(13, @"<path d=""M12 12H3"" /> <path d=""M16 6H3"" /> <path d=""M12 18H3"" /> <path d=""m16 12 5 3-5 3v-6Z"" />");
