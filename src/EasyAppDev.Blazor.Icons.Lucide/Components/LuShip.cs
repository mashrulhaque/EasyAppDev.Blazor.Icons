...
{
    /// <summary>
    /// LuShip icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class LuShip : ComponentBase
    {
        /// <summary>
        ...
        protected override void BuildRenderTree(RenderTreeBuilder builder)
        {
            ...
            // Inline SVG content
            builder.AddMarkupContent(13, @"<path d=""M2 21c.6.5 1.2 1 2.5 1 2.5 0 2.5-2 5-2 1.3 0 1.9.5 2.5 1 .6.5 1.2 1 2.5 1 2.5 0 2.5-2 5-2 1.3 0 1.9.5 2.5 1"" /> <path d=""M19.38 20A11.6 11.6 0 0 0 21 14l-9-4-9 4c0 2.9.94 5.34 2.81 7.76"" /> <path d=""M19 13V7a2 2 0 0 0-2-2H7a2 2 0 0 0-2 2v6"" /> <path d=""M12 10v4"" /> <path d=""M12 2v3"" />");
