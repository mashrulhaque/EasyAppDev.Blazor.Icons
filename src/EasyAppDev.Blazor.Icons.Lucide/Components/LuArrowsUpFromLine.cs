...
{
    /// <summary>
    /// LuArrowsUpFromLine icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class LuArrowsUpFromLine : ComponentBase
    {
        /// <summary>
        ...
        protected override void BuildRenderTree(RenderTreeBuilder builder)
        {
            ...
            // Inline SVG content
            builder.AddMarkupContent(13, @"<path d=""m4 6 3-3 3 3"" /> <path d=""M7 17V3"" /> <path d=""m14 6 3-3 3 3"" /> <path d=""M17 17V3"" /> <path d=""M4 21h16"" />");
