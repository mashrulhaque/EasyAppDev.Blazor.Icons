...
{
    /// <summary>
    /// LuGalleryVerticalEnd icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class LuGalleryVerticalEnd : ComponentBase
    {
        /// <summary>
        ...
        protected override void BuildRenderTree(RenderTreeBuilder builder)
        {
            ...
            // Inline SVG content
            builder.AddMarkupContent(13, @"<path d=""M7 2h10"" /> <path d=""M5 6h14"" /> <rect width=""18"" height=""12"" x=""3"" y=""10"" rx=""2"" />");
