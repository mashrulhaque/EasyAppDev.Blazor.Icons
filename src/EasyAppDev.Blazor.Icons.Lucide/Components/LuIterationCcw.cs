...
{
    /// <summary>
    /// LuIterationCcw icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class LuIterationCcw : ComponentBase
    {
        /// <summary>
        ...
        protected override void BuildRenderTree(RenderTreeBuilder builder)
        {
            ...
            // Inline SVG content
            builder.AddMarkupContent(13, @"<path d=""M20 10c0-4.4-3.6-8-8-8s-8 3.6-8 8 3.6 8 8 8h8"" /> <polyline points=""16 14 20 18 16 22"" />");
