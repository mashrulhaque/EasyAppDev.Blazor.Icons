...
{
    /// <summary>
    /// LuEqualApproximately icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class LuEqualApproximately : ComponentBase
    {
        /// <summary>
        ...
        protected override void BuildRenderTree(RenderTreeBuilder builder)
        {
            ...
            // Inline SVG content
            builder.AddMarkupContent(13, @"<path d=""M5 15a6.5 6.5 0 0 1 7 0 6.5 6.5 0 0 0 7 0"" /> <path d=""M5 9a6.5 6.5 0 0 1 7 0 6.5 6.5 0 0 0 7 0"" />");
