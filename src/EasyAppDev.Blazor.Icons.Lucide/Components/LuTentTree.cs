...
{
    /// <summary>
    /// LuTentTree icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class LuTentTree : ComponentBase
    {
        /// <summary>
        ...
        protected override void BuildRenderTree(RenderTreeBuilder builder)
        {
            ...
            // Inline SVG content
            builder.AddMarkupContent(13, @"<circle cx=""4"" cy=""4"" r=""2"" /> <path d=""m14 5 3-3 3 3"" /> <path d=""m14 10 3-3 3 3"" /> <path d=""M17 14V2"" /> <path d=""M17 14H7l-5 8h20Z"" /> <path d=""M8 14v8"" /> <path d=""m9 14 5 8"" />");
