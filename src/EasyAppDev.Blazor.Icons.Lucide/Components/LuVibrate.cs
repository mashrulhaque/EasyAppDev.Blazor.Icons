...
{
    /// <summary>
    /// LuVibrate icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class LuVibrate : ComponentBase
    {
        /// <summary>
        ...
        protected override void BuildRenderTree(RenderTreeBuilder builder)
        {
            ...
            // Inline SVG content
            builder.AddMarkupContent(13, @"<path d=""m2 8 2 2-2 2 2 2-2 2"" /> <path d=""m22 8-2 2 2 2-2 2 2 2"" /> <rect width=""8"" height=""14"" x=""8"" y=""5"" rx=""1"" />");
