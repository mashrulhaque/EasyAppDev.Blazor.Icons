...
{
    /// <summary>
    /// LuGripHorizontal icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class LuGripHorizontal : ComponentBase
    {
        /// <summary>
        ...
        protected override void BuildRenderTree(RenderTreeBuilder builder)
        {
            ...
            // Inline SVG content
            builder.AddMarkupContent(13, @"<circle cx=""12"" cy=""9"" r=""1"" /> <circle cx=""19"" cy=""9"" r=""1"" /> <circle cx=""5"" cy=""9"" r=""1"" /> <circle cx=""12"" cy=""15"" r=""1"" /> <circle cx=""19"" cy=""15"" r=""1"" /> <circle cx=""5"" cy=""15"" r=""1"" />");
