...
{
    /// <summary>
    /// LuFileMusic icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class LuFileMusic : ComponentBase
    {
        /// <summary>
        ...
        protected override void BuildRenderTree(RenderTreeBuilder builder)
        {
            ...
            // Inline SVG content
            builder.AddMarkupContent(13, @"<path d=""M10.5 22H18a2 2 0 0 0 2-2V7l-5-5H6a2 2 0 0 0-2 2v8.4"" /> <path d=""M8 18v-7.7L16 9v7"" /> <circle cx=""14"" cy=""16"" r=""2"" /> <circle cx=""6"" cy=""18"" r=""2"" />");
