...
{
    /// <summary>
    /// LuTrainTrack icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class LuTrainTrack : ComponentBase
    {
        /// <summary>
        ...
        protected override void BuildRenderTree(RenderTreeBuilder builder)
        {
            ...
            // Inline SVG content
            builder.AddMarkupContent(13, @"<path d=""M2 17 17 2"" /> <path d=""m2 14 8 8"" /> <path d=""m5 11 8 8"" /> <path d=""m8 8 8 8"" /> <path d=""m11 5 8 8"" /> <path d=""m14 2 8 8"" /> <path d=""M7 22 22 7"" />");
