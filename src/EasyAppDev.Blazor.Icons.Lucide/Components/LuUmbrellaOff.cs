...
{
    /// <summary>
    /// LuUmbrellaOff icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class LuUmbrellaOff : ComponentBase
    {
        /// <summary>
        ...
        protected override void BuildRenderTree(RenderTreeBuilder builder)
        {
            ...
            // Inline SVG content
            builder.AddMarkupContent(13, @"<path d=""M12 2v1"" /> <path d=""M15.5 21a1.85 1.85 0 0 1-3.5-1v-8H2a10 10 0 0 1 3.428-6.575"" /> <path d=""M17.5 12H22A10 10 0 0 0 9.004 3.455"" /> <path d=""m2 2 20 20"" />");
