...
{
    /// <summary>
    /// LuUserCheck icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class LuUserCheck : ComponentBase
    {
        /// <summary>
        ...
        protected override void BuildRenderTree(RenderTreeBuilder builder)
        {
            ...
            // Inline SVG content
            builder.AddMarkupContent(13, @"<path d=""M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2"" /> <circle cx=""9"" cy=""7"" r=""4"" /> <polyline points=""16 11 18 13 22 9"" />");
