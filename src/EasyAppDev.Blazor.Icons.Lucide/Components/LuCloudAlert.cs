...
{
    /// <summary>
    /// LuCloudAlert icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class LuCloudAlert : ComponentBase
    {
        /// <summary>
        ...
        protected override void BuildRenderTree(RenderTreeBuilder builder)
        {
            ...
            // Inline SVG content
            builder.AddMarkupContent(13, @"<path d=""M12 12v4"" /> <path d=""M12 20h.01"" /> <path d=""M17 18h.5a1 1 0 0 0 0-9h-1.79A7 7 0 1 0 7 17.708"" />");
