...
{
    /// <summary>
    /// LuAnnoyed icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class LuAnnoyed : ComponentBase
    {
        /// <summary>
        ...
        protected override void BuildRenderTree(RenderTreeBuilder builder)
        {
            ...
            // Inline SVG content
            builder.AddMarkupContent(13, @"<circle cx=""12"" cy=""12"" r=""10"" /> <path d=""M8 15h8"" /> <path d=""M8 9h2"" /> <path d=""M14 9h2"" />");
