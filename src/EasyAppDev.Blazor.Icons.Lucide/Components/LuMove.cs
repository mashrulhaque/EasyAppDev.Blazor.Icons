...
{
    /// <summary>
    /// LuMove icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class LuMove : ComponentBase
    {
        /// <summary>
        ...
        protected override void BuildRenderTree(RenderTreeBuilder builder)
        {
            ...
            // Inline SVG content
            builder.AddMarkupContent(13, @"<path d=""M12 2v20"" /> <path d=""m15 19-3 3-3-3"" /> <path d=""m19 9 3 3-3 3"" /> <path d=""M2 12h20"" /> <path d=""m5 9-3 3 3 3"" /> <path d=""m9 5 3-3 3 3"" />");
