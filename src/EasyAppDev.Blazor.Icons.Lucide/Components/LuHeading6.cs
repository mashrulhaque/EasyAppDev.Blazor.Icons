...
{
    /// <summary>
    /// LuHeading6 icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class LuHeading6 : ComponentBase
    {
        /// <summary>
        ...
        protected override void BuildRenderTree(RenderTreeBuilder builder)
        {
            ...
            // Inline SVG content
            builder.AddMarkupContent(13, @"<path d=""M4 12h8"" /> <path d=""M4 18V6"" /> <path d=""M12 18V6"" /> <circle cx=""19"" cy=""16"" r=""2"" /> <path d=""M20 10c-2 2-3 3.5-3 6"" />");
