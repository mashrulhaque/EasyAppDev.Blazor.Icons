...
{
    /// <summary>
    /// LuCamera icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class LuCamera : ComponentBase
    {
        /// <summary>
        ...
        protected override void BuildRenderTree(RenderTreeBuilder builder)
        {
            ...
            // Inline SVG content
            builder.AddMarkupContent(13, @"<path d=""M14.5 4h-5L7 7H4a2 2 0 0 0-2 2v9a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2V9a2 2 0 0 0-2-2h-3l-2.5-3z"" /> <circle cx=""12"" cy=""13"" r=""3"" />");
