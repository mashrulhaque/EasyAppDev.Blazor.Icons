...
{
    /// <summary>
    /// LuListCheck icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class LuListCheck : ComponentBase
    {
        /// <summary>
        ...
        protected override void BuildRenderTree(RenderTreeBuilder builder)
        {
            ...
            // Inline SVG content
            builder.AddMarkupContent(13, @"<path d=""M11 18H3"" /> <path d=""m15 18 2 2 4-4"" /> <path d=""M16 12H3"" /> <path d=""M16 6H3"" />");
