...
{
    /// <summary>
    /// LuSignal icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class LuSignal : ComponentBase
    {
        /// <summary>
        ...
        protected override void BuildRenderTree(RenderTreeBuilder builder)
        {
            ...
            // Inline SVG content
            builder.AddMarkupContent(13, @"<path d=""M2 20h.01"" /> <path d=""M7 20v-4"" /> <path d=""M12 20v-8"" /> <path d=""M17 20V8"" /> <path d=""M22 4v16"" />");
