...
{
    /// <summary>
    /// LuSquareTerminal icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class LuSquareTerminal : ComponentBase
    {
        /// <summary>
        ...
        protected override void BuildRenderTree(RenderTreeBuilder builder)
        {
            ...
            // Inline SVG content
            builder.AddMarkupContent(13, @"<path d=""m7 11 2-2-2-2"" /> <path d=""M11 13h4"" /> <rect width=""18"" height=""18"" x=""3"" y=""3"" rx=""2"" ry=""2"" />");
