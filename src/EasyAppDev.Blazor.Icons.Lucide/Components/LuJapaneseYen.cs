...
{
    /// <summary>
    /// LuJapaneseYen icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class LuJapaneseYen : ComponentBase
    {
        /// <summary>
        ...
        protected override void BuildRenderTree(RenderTreeBuilder builder)
        {
            ...
            // Inline SVG content
            builder.AddMarkupContent(13, @"<path d=""M12 9.5V21m0-11.5L6 3m6 6.5L18 3"" /> <path d=""M6 15h12"" /> <path d=""M6 11h12"" />");
