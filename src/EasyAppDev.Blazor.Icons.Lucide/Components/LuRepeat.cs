...
{
    /// <summary>
    /// LuRepeat icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class LuRepeat : ComponentBase
    {
        /// <summary>
        ...
        protected override void BuildRenderTree(RenderTreeBuilder builder)
        {
            ...
            // Inline SVG content
            builder.AddMarkupContent(13, @"<path d=""m17 2 4 4-4 4"" /> <path d=""M3 11v-1a4 4 0 0 1 4-4h14"" /> <path d=""m7 22-4-4 4-4"" /> <path d=""M21 13v1a4 4 0 0 1-4 4H3"" />");
