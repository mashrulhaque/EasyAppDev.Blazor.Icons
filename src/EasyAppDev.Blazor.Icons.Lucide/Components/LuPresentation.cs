...
{
    /// <summary>
    /// LuPresentation icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class LuPresentation : ComponentBase
    {
        /// <summary>
        ...
        protected override void BuildRenderTree(RenderTreeBuilder builder)
        {
            ...
            // Inline SVG content
            builder.AddMarkupContent(13, @"<path d=""M2 3h20"" /> <path d=""M21 3v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V3"" /> <path d=""m7 21 5-5 5 5"" />");
