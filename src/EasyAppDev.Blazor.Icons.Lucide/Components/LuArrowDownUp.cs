...
{
    /// <summary>
    /// LuArrowDownUp icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class LuArrowDownUp : ComponentBase
    {
        /// <summary>
        ...
        protected override void BuildRenderTree(RenderTreeBuilder builder)
        {
            ...
            // Inline SVG content
            builder.AddMarkupContent(13, @"<path d=""m3 16 4 4 4-4"" /> <path d=""M7 20V4"" /> <path d=""m21 8-4-4-4 4"" /> <path d=""M17 4v16"" />");
