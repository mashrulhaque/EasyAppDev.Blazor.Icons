...
{
    /// <summary>
    /// LuArrowDownNarrowWide icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class LuArrowDownNarrowWide : ComponentBase
    {
        /// <summary>
        ...
        protected override void BuildRenderTree(RenderTreeBuilder builder)
        {
            ...
            // Inline SVG content
            builder.AddMarkupContent(13, @"<path d=""m3 16 4 4 4-4"" /> <path d=""M7 20V4"" /> <path d=""M11 4h4"" /> <path d=""M11 8h7"" /> <path d=""M11 12h10"" />");
