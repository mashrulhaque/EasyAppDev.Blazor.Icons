...
{
    /// <summary>
    /// LuMessageCircleCode icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class LuMessageCircleCode : ComponentBase
    {
        /// <summary>
        ...
        protected override void BuildRenderTree(RenderTreeBuilder builder)
        {
            ...
            // Inline SVG content
            builder.AddMarkupContent(13, @"<path d=""M10 9.5 8 12l2 2.5"" /> <path d=""m14 9.5 2 2.5-2 2.5"" /> <path d=""M7.9 20A9 9 0 1 0 4 16.1L2 22z"" />");
