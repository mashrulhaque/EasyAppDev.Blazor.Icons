...
{
    /// <summary>
    /// LuCaseUpper icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class LuCaseUpper : ComponentBase
    {
        /// <summary>
        ...
        protected override void BuildRenderTree(RenderTreeBuilder builder)
        {
            ...
            // Inline SVG content
            builder.AddMarkupContent(13, @"<path d=""m3 15 4-8 4 8"" /> <path d=""M4 13h6"" /> <path d=""M15 11h4.5a2 2 0 0 1 0 4H15V7h4a2 2 0 0 1 0 4"" />");
