...
{
    /// <summary>
    /// LuUserSearch icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class LuUserSearch : ComponentBase
    {
        /// <summary>
        ...
        protected override void BuildRenderTree(RenderTreeBuilder builder)
        {
            ...
            // Inline SVG content
            builder.AddMarkupContent(13, @"<circle cx=""10"" cy=""7"" r=""4"" /> <path d=""M10.3 15H7a4 4 0 0 0-4 4v2"" /> <circle cx=""17"" cy=""17"" r=""3"" /> <path d=""m21 21-1.9-1.9"" />");
