...
{
    /// <summary>
    /// LuChevronsLeftRightEllipsis icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class LuChevronsLeftRightEllipsis : ComponentBase
    {
        /// <summary>
        ...
        protected override void BuildRenderTree(RenderTreeBuilder builder)
        {
            ...
            // Inline SVG content
            builder.AddMarkupContent(13, @"<path d=""m18 8 4 4-4 4"" /> <path d=""m6 8-4 4 4 4"" /> <path d=""M8 12h.01"" /> <path d=""M12 12h.01"" /> <path d=""M16 12h.01"" />");
