...
{
    /// <summary>
    /// LuPlug icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class LuPlug : ComponentBase
    {
        /// <summary>
        ...
        protected override void BuildRenderTree(RenderTreeBuilder builder)
        {
            ...
            // Inline SVG content
            builder.AddMarkupContent(13, @"<path d=""M12 22v-5"" /> <path d=""M9 8V2"" /> <path d=""M15 8V2"" /> <path d=""M18 8v5a4 4 0 0 1-4 4h-4a4 4 0 0 1-4-4V8Z"" />");
