...
{
    /// <summary>
    /// LuRadius icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class LuRadius : ComponentBase
    {
        /// <summary>
        ...
        protected override void BuildRenderTree(RenderTreeBuilder builder)
        {
            ...
            // Inline SVG content
            builder.AddMarkupContent(13, @"<path d=""M20.34 17.52a10 10 0 1 0-2.82 2.82"" /> <circle cx=""19"" cy=""19"" r=""2"" /> <path d=""m13.41 13.41 4.18 4.18"" /> <circle cx=""12"" cy=""12"" r=""2"" />");
