...
{
    /// <summary>
    /// LuSpline icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class LuSpline : ComponentBase
    {
        /// <summary>
        ...
        protected override void BuildRenderTree(RenderTreeBuilder builder)
        {
            ...
            // Inline SVG content
            builder.AddMarkupContent(13, @"<circle cx=""19"" cy=""5"" r=""2"" /> <circle cx=""5"" cy=""19"" r=""2"" /> <path d=""M5 17A12 12 0 0 1 17 5"" />");
