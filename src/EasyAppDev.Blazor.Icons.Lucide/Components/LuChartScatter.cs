...
{
    /// <summary>
    /// LuChartScatter icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class LuChartScatter : ComponentBase
    {
        /// <summary>
        ...
        protected override void BuildRenderTree(RenderTreeBuilder builder)
        {
            ...
            // Inline SVG content
            builder.AddMarkupContent(13, @"<circle cx=""7.5"" cy=""7.5"" r="".5"" fill=""currentColor"" /> <circle cx=""18.5"" cy=""5.5"" r="".5"" fill=""currentColor"" /> <circle cx=""11.5"" cy=""11.5"" r="".5"" fill=""currentColor"" /> <circle cx=""7.5"" cy=""16.5"" r="".5"" fill=""currentColor"" /> <circle cx=""17.5"" cy=""14.5"" r="".5"" fill=""currentColor"" /> <path d=""M3 3v16a2 2 0 0 0 2 2h16"" />");
