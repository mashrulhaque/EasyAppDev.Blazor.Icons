...
{
    /// <summary>
    /// LuMessageCircleX icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class LuMessageCircleX : ComponentBase
    {
        /// <summary>
        ...
        protected override void BuildRenderTree(RenderTreeBuilder builder)
        {
            ...
            // Inline SVG content
            builder.AddMarkupContent(13, @"<path d=""M7.9 20A9 9 0 1 0 4 16.1L2 22Z"" /> <path d=""m15 9-6 6"" /> <path d=""m9 9 6 6"" />");
