...
{
    /// <summary>
    /// LuListRestart icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class LuListRestart : ComponentBase
    {
        /// <summary>
        ...
        protected override void BuildRenderTree(RenderTreeBuilder builder)
        {
            ...
            // Inline SVG content
            builder.AddMarkupContent(13, @"<path d=""M21 6H3"" /> <path d=""M7 12H3"" /> <path d=""M7 18H3"" /> <path d=""M12 18a5 5 0 0 0 9-3 4.5 4.5 0 0 0-4.5-4.5c-1.33 0-2.54.54-3.41 1.41L11 14"" /> <path d=""M11 10v4h4"" />");
