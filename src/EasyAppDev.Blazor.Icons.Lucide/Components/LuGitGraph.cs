...
{
    /// <summary>
    /// LuGitGraph icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class LuGitGraph : ComponentBase
    {
        /// <summary>
        ...
        protected override void BuildRenderTree(RenderTreeBuilder builder)
        {
            ...
            // Inline SVG content
            builder.AddMarkupContent(13, @"<circle cx=""5"" cy=""6"" r=""3"" /> <path d=""M5 9v6"" /> <circle cx=""5"" cy=""18"" r=""3"" /> <path d=""M12 3v18"" /> <circle cx=""19"" cy=""6"" r=""3"" /> <path d=""M16 15.7A9 9 0 0 0 19 9"" />");
