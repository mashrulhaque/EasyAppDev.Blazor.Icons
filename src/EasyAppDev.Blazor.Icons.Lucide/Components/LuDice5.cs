...
{
    /// <summary>
    /// LuDice5 icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class LuDice5 : ComponentBase
    {
        /// <summary>
        ...
        protected override void BuildRenderTree(RenderTreeBuilder builder)
        {
            ...
            // Inline SVG content
            builder.AddMarkupContent(13, @"<rect width=""18"" height=""18"" x=""3"" y=""3"" rx=""2"" ry=""2"" /> <path d=""M16 8h.01"" /> <path d=""M8 8h.01"" /> <path d=""M8 16h.01"" /> <path d=""M16 16h.01"" /> <path d=""M12 12h.01"" />");
