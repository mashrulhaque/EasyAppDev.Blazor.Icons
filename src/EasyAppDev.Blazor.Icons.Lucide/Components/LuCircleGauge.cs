...
{
    /// <summary>
    /// LuCircleGauge icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class LuCircleGauge : ComponentBase
    {
        /// <summary>
        ...
        protected override void BuildRenderTree(RenderTreeBuilder builder)
        {
            ...
            // Inline SVG content
            builder.AddMarkupContent(13, @"<path d=""M15.6 2.7a10 10 0 1 0 5.7 5.7"" /> <circle cx=""12"" cy=""12"" r=""2"" /> <path d=""M13.4 10.6 19 5"" />");
