...
{
    /// <summary>
    /// LuMonitorCheck icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class LuMonitorCheck : ComponentBase
    {
        /// <summary>
        ...
        protected override void BuildRenderTree(RenderTreeBuilder builder)
        {
            ...
            // Inline SVG content
            builder.AddMarkupContent(13, @"<path d=""m9 10 2 2 4-4"" /> <rect width=""20"" height=""14"" x=""2"" y=""3"" rx=""2"" /> <path d=""M12 17v4"" /> <path d=""M8 21h8"" />");
