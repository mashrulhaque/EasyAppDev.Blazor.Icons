...
{
    /// <summary>
    /// LuTent icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class LuTent : ComponentBase
    {
        /// <summary>
        ...
        protected override void BuildRenderTree(RenderTreeBuilder builder)
        {
            ...
            // Inline SVG content
            builder.AddMarkupContent(13, @"<path d=""M3.5 21 14 3"" /> <path d=""M20.5 21 10 3"" /> <path d=""M15.5 21 12 15l-3.5 6"" /> <path d=""M2 21h20"" />");
