...
{
    /// <summary>
    /// LuLampCeiling icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class LuLampCeiling : ComponentBase
    {
        /// <summary>
        ...
        protected override void BuildRenderTree(RenderTreeBuilder builder)
        {
            ...
            // Inline SVG content
            builder.AddMarkupContent(13, @"<path d=""M12 2v5"" /> <path d=""M6 7h12l4 9H2l4-9Z"" /> <path d=""M9.17 16a3 3 0 1 0 5.66 0"" />");
