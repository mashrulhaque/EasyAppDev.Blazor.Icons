...
{
    /// <summary>
    /// LuArrowUpFromDot icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class LuArrowUpFromDot : ComponentBase
    {
        /// <summary>
        ...
        protected override void BuildRenderTree(RenderTreeBuilder builder)
        {
            ...
            // Inline SVG content
            builder.AddMarkupContent(13, @"<path d=""m5 9 7-7 7 7"" /> <path d=""M12 16V2"" /> <circle cx=""12"" cy=""21"" r=""1"" />");
