...
{
    /// <summary>
    /// LuRemoveFormatting icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class LuRemoveFormatting : ComponentBase
    {
        /// <summary>
        ...
        protected override void BuildRenderTree(RenderTreeBuilder builder)
        {
            ...
            // Inline SVG content
            builder.AddMarkupContent(13, @"<path d=""M4 7V4h16v3"" /> <path d=""M5 20h6"" /> <path d=""M13 4 8 20"" /> <path d=""m15 15 5 5"" /> <path d=""m20 15-5 5"" />");
