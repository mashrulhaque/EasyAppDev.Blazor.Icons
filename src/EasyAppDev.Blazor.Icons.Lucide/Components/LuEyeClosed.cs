...
{
    /// <summary>
    /// LuEyeClosed icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class LuEyeClosed : ComponentBase
    {
        /// <summary>
        ...
        protected override void BuildRenderTree(RenderTreeBuilder builder)
        {
            ...
            // Inline SVG content
            builder.AddMarkupContent(13, @"<path d=""m15 18-.722-3.25"" /> <path d=""M2 8a10.645 10.645 0 0 0 20 0"" /> <path d=""m20 15-1.726-2.05"" /> <path d=""m4 15 1.726-2.05"" /> <path d=""m9 18 .722-3.25"" />");
