...
{
    /// <summary>
    /// LuListCollapse icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class LuListCollapse : ComponentBase
    {
        /// <summary>
        ...
        protected override void BuildRenderTree(RenderTreeBuilder builder)
        {
            ...
            // Inline SVG content
            builder.AddMarkupContent(13, @"<path d=""m3 10 2.5-2.5L3 5"" /> <path d=""m3 19 2.5-2.5L3 14"" /> <path d=""M10 6h11"" /> <path d=""M10 12h11"" /> <path d=""M10 18h11"" />");
