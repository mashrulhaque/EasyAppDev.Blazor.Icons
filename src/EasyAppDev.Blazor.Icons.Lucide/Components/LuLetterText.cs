...
{
    /// <summary>
    /// LuLetterText icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class LuLetterText : ComponentBase
    {
        /// <summary>
        ...
        protected override void BuildRenderTree(RenderTreeBuilder builder)
        {
            ...
            // Inline SVG content
            builder.AddMarkupContent(13, @"<path d=""M15 12h6"" /> <path d=""M15 6h6"" /> <path d=""m3 13 3.553-7.724a.5.5 0 0 1 .894 0L11 13"" /> <path d=""M3 18h18"" /> <path d=""M4 11h6"" />");
