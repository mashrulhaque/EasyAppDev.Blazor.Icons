...
{
    /// <summary>
    /// LuDisc3 icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class LuDisc3 : ComponentBase
    {
        /// <summary>
        ...
        protected override void BuildRenderTree(RenderTreeBuilder builder)
        {
            ...
            // Inline SVG content
            builder.AddMarkupContent(13, @"<circle cx=""12"" cy=""12"" r=""10"" /> <path d=""M6 12c0-1.7.7-3.2 1.8-4.2"" /> <circle cx=""12"" cy=""12"" r=""2"" /> <path d=""M18 12c0 1.7-.7 3.2-1.8 4.2"" />");
