...
{
    /// <summary>
    /// LuSearchX icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class LuSearchX : ComponentBase
    {
        /// <summary>
        ...
        protected override void BuildRenderTree(RenderTreeBuilder builder)
        {
            ...
            // Inline SVG content
            builder.AddMarkupContent(13, @"<path d=""m13.5 8.5-5 5"" /> <path d=""m8.5 8.5 5 5"" /> <circle cx=""11"" cy=""11"" r=""8"" /> <path d=""m21 21-4.3-4.3"" />");
