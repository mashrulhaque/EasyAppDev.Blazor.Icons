...
{
    /// <summary>
    /// LuListX icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class LuListX : ComponentBase
    {
        /// <summary>
        ...
        protected override void BuildRenderTree(RenderTreeBuilder builder)
        {
            ...
            // Inline SVG content
            builder.AddMarkupContent(13, @"<path d=""M11 12H3"" /> <path d=""M16 6H3"" /> <path d=""M16 18H3"" /> <path d=""m19 10-4 4"" /> <path d=""m15 10 4 4"" />");
