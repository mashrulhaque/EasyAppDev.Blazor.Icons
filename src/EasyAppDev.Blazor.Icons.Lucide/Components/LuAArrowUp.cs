...
{
    /// <summary>
    /// LuAArrowUp icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class LuAArrowUp : ComponentBase
    {
        /// <summary>
        ...
        protected override void BuildRenderTree(RenderTreeBuilder builder)
        {
            ...
            // Inline SVG content
            builder.AddMarkupContent(13, @"<path d=""M3.5 13h6"" /> <path d=""m2 16 4.5-9 4.5 9"" /> <path d=""M18 16V7"" /> <path d=""m14 11 4-4 4 4"" />");
