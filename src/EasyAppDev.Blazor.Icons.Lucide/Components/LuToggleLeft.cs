...
{
    /// <summary>
    /// LuToggleLeft icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class LuToggleLeft : ComponentBase
    {
        /// <summary>
        ...
        protected override void BuildRenderTree(RenderTreeBuilder builder)
        {
            ...
            // Inline SVG content
            builder.AddMarkupContent(13, @"<rect width=""20"" height=""12"" x=""2"" y=""6"" rx=""6"" ry=""6"" /> <circle cx=""8"" cy=""12"" r=""2"" />");
