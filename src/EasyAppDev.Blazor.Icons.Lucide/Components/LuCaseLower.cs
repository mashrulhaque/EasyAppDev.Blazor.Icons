...
{
    /// <summary>
    /// LuCaseLower icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class LuCaseLower : ComponentBase
    {
        /// <summary>
        ...
        protected override void BuildRenderTree(RenderTreeBuilder builder)
        {
            ...
            // Inline SVG content
            builder.AddMarkupContent(13, @"<circle cx=""7"" cy=""12"" r=""3"" /> <path d=""M10 9v6"" /> <circle cx=""17"" cy=""12"" r=""3"" /> <path d=""M14 7v8"" />");
