...
{
    /// <summary>
    /// LuSquarePercent icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class LuSquarePercent : ComponentBase
    {
        /// <summary>
        ...
        protected override void BuildRenderTree(RenderTreeBuilder builder)
        {
            ...
            // Inline SVG content
            builder.AddMarkupContent(13, @"<rect width=""18"" height=""18"" x=""3"" y=""3"" rx=""2"" /> <path d=""m15 9-6 6"" /> <path d=""M9 9h.01"" /> <path d=""M15 15h.01"" />");
