...
{
    /// <summary>
    /// LuImagePlay icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class LuImagePlay : ComponentBase
    {
        /// <summary>
        ...
        protected override void BuildRenderTree(RenderTreeBuilder builder)
        {
            ...
            // Inline SVG content
            builder.AddMarkupContent(13, @"<path d=""m11 16-5 5"" /> <path d=""M11 21H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2v6.5"" /> <path d=""M15.765 22a.5.5 0 0 1-.765-.424V13.38a.5.5 0 0 1 .765-.424l5.878 3.674a1 1 0 0 1 0 1.696z"" /> <circle cx=""9"" cy=""9"" r=""2"" />");
