...
{
    /// <summary>
    /// LuTornado icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class LuTornado : ComponentBase
    {
        /// <summary>
        ...
        protected override void BuildRenderTree(RenderTreeBuilder builder)
        {
            ...
            // Inline SVG content
            builder.AddMarkupContent(13, @"<path d=""M21 4H3"" /> <path d=""M18 8H6"" /> <path d=""M19 12H9"" /> <path d=""M16 16h-6"" /> <path d=""M11 20H9"" />");
