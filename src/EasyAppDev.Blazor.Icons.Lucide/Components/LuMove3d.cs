...
{
    /// <summary>
    /// LuMove3d icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class LuMove3d : ComponentBase
    {
        /// <summary>
        ...
        protected override void BuildRenderTree(RenderTreeBuilder builder)
        {
            ...
            // Inline SVG content
            builder.AddMarkupContent(13, @"<path d=""M5 3v16h16"" /> <path d=""m5 19 6-6"" /> <path d=""m2 6 3-3 3 3"" /> <path d=""m18 16 3 3-3 3"" />");
