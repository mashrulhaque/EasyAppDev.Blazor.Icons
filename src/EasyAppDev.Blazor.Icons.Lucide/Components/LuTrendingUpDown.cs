...
{
    /// <summary>
    /// LuTrendingUpDown icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class LuTrendingUpDown : ComponentBase
    {
        /// <summary>
        ...
        protected override void BuildRenderTree(RenderTreeBuilder builder)
        {
            ...
            // Inline SVG content
            builder.AddMarkupContent(13, @"<path d=""M14.828 14.828 21 21"" /> <path d=""M21 16v5h-5"" /> <path d=""m21 3-9 9-4-4-6 6"" /> <path d=""M21 8V3h-5"" />");
