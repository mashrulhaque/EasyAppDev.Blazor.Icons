...
{
    /// <summary>
    /// LuList icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class LuList : ComponentBase
    {
        /// <summary>
        ...
        protected override void BuildRenderTree(RenderTreeBuilder builder)
        {
            ...
            // Inline SVG content
            builder.AddMarkupContent(13, @"<path d=""M3 12h.01"" /> <path d=""M3 18h.01"" /> <path d=""M3 6h.01"" /> <path d=""M8 12h13"" /> <path d=""M8 18h13"" /> <path d=""M8 6h13"" />");
