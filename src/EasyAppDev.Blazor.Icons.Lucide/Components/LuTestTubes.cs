...
{
    /// <summary>
    /// LuTestTubes icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class LuTestTubes : ComponentBase
    {
        /// <summary>
        ...
        protected override void BuildRenderTree(RenderTreeBuilder builder)
        {
            ...
            // Inline SVG content
            builder.AddMarkupContent(13, @"<path d=""M9 2v17.5A2.5 2.5 0 0 1 6.5 22A2.5 2.5 0 0 1 4 19.5V2"" /> <path d=""M20 2v17.5a2.5 2.5 0 0 1-2.5 2.5a2.5 2.5 0 0 1-2.5-2.5V2"" /> <path d=""M3 2h7"" /> <path d=""M14 2h7"" /> <path d=""M9 16H4"" /> <path d=""M20 16h-5"" />");
