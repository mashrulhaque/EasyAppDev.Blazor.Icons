...
{
    /// <summary>
    /// LuGripVertical icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class LuGripVertical : ComponentBase
    {
        /// <summary>
        ...
        protected override void BuildRenderTree(RenderTreeBuilder builder)
        {
            ...
            // Inline SVG content
            builder.AddMarkupContent(13, @"<circle cx=""9"" cy=""12"" r=""1"" /> <circle cx=""9"" cy=""5"" r=""1"" /> <circle cx=""9"" cy=""19"" r=""1"" /> <circle cx=""15"" cy=""12"" r=""1"" /> <circle cx=""15"" cy=""5"" r=""1"" /> <circle cx=""15"" cy=""19"" r=""1"" />");
