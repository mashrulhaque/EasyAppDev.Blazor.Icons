...
{
    /// <summary>
    /// LuFilterX icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class LuFilterX : ComponentBase
    {
        /// <summary>
        ...
        protected override void BuildRenderTree(RenderTreeBuilder builder)
        {
            ...
            // Inline SVG content
            builder.AddMarkupContent(13, @"<path d=""M13.013 3H2l8 9.46V19l4 2v-8.54l.9-1.055"" /> <path d=""m22 3-5 5"" /> <path d=""m17 3 5 5"" />");
