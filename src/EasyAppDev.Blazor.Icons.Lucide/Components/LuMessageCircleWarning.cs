...
{
    /// <summary>
    /// LuMessageCircleWarning icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class LuMessageCircleWarning : ComponentBase
    {
        /// <summary>
        ...
        protected override void BuildRenderTree(RenderTreeBuilder builder)
        {
            ...
            // Inline SVG content
            builder.AddMarkupContent(13, @"<path d=""M7.9 20A9 9 0 1 0 4 16.1L2 22Z"" /> <path d=""M12 8v4"" /> <path d=""M12 16h.01"" />");
