...
{
    /// <summary>
    /// LuUtilityPole icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class LuUtilityPole : ComponentBase
    {
        /// <summary>
        ...
        protected override void BuildRenderTree(RenderTreeBuilder builder)
        {
            ...
            // Inline SVG content
            builder.AddMarkupContent(13, @"<path d=""M12 2v20"" /> <path d=""M2 5h20"" /> <path d=""M3 3v2"" /> <path d=""M7 3v2"" /> <path d=""M17 3v2"" /> <path d=""M21 3v2"" /> <path d=""m19 5-7 7-7-7"" />");
