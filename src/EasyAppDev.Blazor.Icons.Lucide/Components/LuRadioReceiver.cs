...
{
    /// <summary>
    /// LuRadioReceiver icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class LuRadioReceiver : ComponentBase
    {
        /// <summary>
        ...
        protected override void BuildRenderTree(RenderTreeBuilder builder)
        {
            ...
            // Inline SVG content
            builder.AddMarkupContent(13, @"<path d=""M5 16v2"" /> <path d=""M19 16v2"" /> <rect width=""20"" height=""8"" x=""2"" y=""8"" rx=""2"" /> <path d=""M18 12h.01"" />");
