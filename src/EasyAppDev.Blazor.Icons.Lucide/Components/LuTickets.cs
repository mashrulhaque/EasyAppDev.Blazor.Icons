...
{
    /// <summary>
    /// LuTickets icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class LuTickets : ComponentBase
    {
        /// <summary>
        ...
        protected override void BuildRenderTree(RenderTreeBuilder builder)
        {
            ...
            // Inline SVG content
            builder.AddMarkupContent(13, @"<path d=""m4.5 8 10.58-5.06a1 1 0 0 1 1.342.488L18.5 8"" /> <path d=""M6 10V8"" /> <path d=""M6 14v1"" /> <path d=""M6 19v2"" /> <rect x=""2"" y=""8"" width=""20"" height=""13"" rx=""2"" />");
