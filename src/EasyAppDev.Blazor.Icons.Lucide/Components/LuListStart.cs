...
{
    /// <summary>
    /// LuListStart icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class LuListStart : ComponentBase
    {
        /// <summary>
        ...
        protected override void BuildRenderTree(RenderTreeBuilder builder)
        {
            ...
            // Inline SVG content
            builder.AddMarkupContent(13, @"<path d=""M16 12H3"" /> <path d=""M16 18H3"" /> <path d=""M10 6H3"" /> <path d=""M21 18V8a2 2 0 0 0-2-2h-5"" /> <path d=""m16 8-2-2 2-2"" />");
