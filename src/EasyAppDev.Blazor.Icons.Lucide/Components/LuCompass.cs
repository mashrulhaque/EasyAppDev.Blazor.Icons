...
{
    /// <summary>
    /// LuCompass icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class LuCompass : ComponentBase
    {
        /// <summary>
        ...
        protected override void BuildRenderTree(RenderTreeBuilder builder)
        {
            ...
            // Inline SVG content
            builder.AddMarkupContent(13, @"<path d=""m16.24 7.76-1.804 5.411a2 2 0 0 1-1.265 1.265L7.76 16.24l1.804-5.411a2 2 0 0 1 1.265-1.265z"" /> <circle cx=""12"" cy=""12"" r=""10"" />");
