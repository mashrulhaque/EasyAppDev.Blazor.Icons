...
{
    /// <summary>
    /// LuMessageSquareOff icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class LuMessageSquareOff : ComponentBase
    {
        /// <summary>
        ...
        protected override void BuildRenderTree(RenderTreeBuilder builder)
        {
            ...
            // Inline SVG content
            builder.AddMarkupContent(13, @"<path d=""M21 15V5a2 2 0 0 0-2-2H9"" /> <path d=""m2 2 20 20"" /> <path d=""M3.6 3.6c-.4.3-.6.8-.6 1.4v16l4-4h10"" />");
