...
{
    /// <summary>
    /// LuPercent icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class LuPercent : ComponentBase
    {
        /// <summary>
        ...
        protected override void BuildRenderTree(RenderTreeBuilder builder)
        {
            ...
            // Inline SVG content
            builder.AddMarkupContent(13, @"<line x1=""19"" x2=""5"" y1=""5"" y2=""19"" /> <circle cx=""6.5"" cy=""6.5"" r=""2.5"" /> <circle cx=""17.5"" cy=""17.5"" r=""2.5"" />");
