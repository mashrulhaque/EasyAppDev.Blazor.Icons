...
{
    /// <summary>
    /// LuCylinder icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class LuCylinder : ComponentBase
    {
        /// <summary>
        ...
        protected override void BuildRenderTree(RenderTreeBuilder builder)
        {
            ...
            // Inline SVG content
            builder.AddMarkupContent(13, @"<ellipse cx=""12"" cy=""5"" rx=""9"" ry=""3"" /> <path d=""M3 5v14a9 3 0 0 0 18 0V5"" />");
