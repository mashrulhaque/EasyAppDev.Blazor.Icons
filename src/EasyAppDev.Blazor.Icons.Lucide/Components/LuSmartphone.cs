...
{
    /// <summary>
    /// LuSmartphone icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class LuSmartphone : ComponentBase
    {
        /// <summary>
        ...
        protected override void BuildRenderTree(RenderTreeBuilder builder)
        {
            ...
            // Inline SVG content
            builder.AddMarkupContent(13, @"<rect width=""14"" height=""20"" x=""5"" y=""2"" rx=""2"" ry=""2"" /> <path d=""M12 18h.01"" />");
