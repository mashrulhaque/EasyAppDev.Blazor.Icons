...
{
    /// <summary>
    /// LuSquareArrowOutDownLeft icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class LuSquareArrowOutDownLeft : ComponentBase
    {
        /// <summary>
        ...
        protected override void BuildRenderTree(RenderTreeBuilder builder)
        {
            ...
            // Inline SVG content
            builder.AddMarkupContent(13, @"<path d=""M13 21h6a2 2 0 0 0 2-2V5a2 2 0 0 0-2-2H5a2 2 0 0 0-2 2v6"" /> <path d=""m3 21 9-9"" /> <path d=""M9 21H3v-6"" />");
