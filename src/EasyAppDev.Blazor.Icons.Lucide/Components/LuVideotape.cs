...
{
    /// <summary>
    /// LuVideotape icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class LuVideotape : ComponentBase
    {
        /// <summary>
        ...
        protected override void BuildRenderTree(RenderTreeBuilder builder)
        {
            ...
            // Inline SVG content
            builder.AddMarkupContent(13, @"<rect width=""20"" height=""16"" x=""2"" y=""4"" rx=""2"" /> <path d=""M2 8h20"" /> <circle cx=""8"" cy=""14"" r=""2"" /> <path d=""M8 12h8"" /> <circle cx=""16"" cy=""14"" r=""2"" />");
