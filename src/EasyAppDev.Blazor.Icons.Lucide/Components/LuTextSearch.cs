...
{
    /// <summary>
    /// LuTextSearch icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class LuTextSearch : ComponentBase
    {
        /// <summary>
        ...
        protected override void BuildRenderTree(RenderTreeBuilder builder)
        {
            ...
            // Inline SVG content
            builder.AddMarkupContent(13, @"<path d=""M21 6H3"" /> <path d=""M10 12H3"" /> <path d=""M10 18H3"" /> <circle cx=""17"" cy=""15"" r=""3"" /> <path d=""m21 19-1.9-1.9"" />");
