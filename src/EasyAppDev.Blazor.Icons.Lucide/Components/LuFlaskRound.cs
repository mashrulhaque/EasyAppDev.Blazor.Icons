...
{
    /// <summary>
    /// LuFlaskRound icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class LuFlaskRound : ComponentBase
    {
        /// <summary>
        ...
        protected override void BuildRenderTree(RenderTreeBuilder builder)
        {
            ...
            // Inline SVG content
            builder.AddMarkupContent(13, @"<path d=""M10 2v7.31"" /> <path d=""M14 9.3V1.99"" /> <path d=""M8.5 2h7"" /> <path d=""M14 9.3a6.5 6.5 0 1 1-4 0"" /> <path d=""M5.52 16h12.96"" />");
