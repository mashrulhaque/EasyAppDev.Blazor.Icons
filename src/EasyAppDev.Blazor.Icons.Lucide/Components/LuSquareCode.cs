...
{
    /// <summary>
    /// LuSquareCode icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class LuSquareCode : ComponentBase
    {
        /// <summary>
        ...
        protected override void BuildRenderTree(RenderTreeBuilder builder)
        {
            ...
            // Inline SVG content
            builder.AddMarkupContent(13, @"<path d=""M10 9.5 8 12l2 2.5"" /> <path d=""m14 9.5 2 2.5-2 2.5"" /> <rect width=""18"" height=""18"" x=""3"" y=""3"" rx=""2"" />");
