...
{
    /// <summary>
    /// LuTrendingDown icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class LuTrendingDown : ComponentBase
    {
        /// <summary>
        ...
        protected override void BuildRenderTree(RenderTreeBuilder builder)
        {
            ...
            // Inline SVG content
            builder.AddMarkupContent(13, @"<polyline points=""22 17 13.5 8.5 8.5 13.5 2 7"" /> <polyline points=""16 17 22 17 22 11"" />");
