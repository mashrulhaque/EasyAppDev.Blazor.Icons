...
{
    /// <summary>
    /// LuPcCase icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class LuPcCase : ComponentBase
    {
        /// <summary>
        ...
        protected override void BuildRenderTree(RenderTreeBuilder builder)
        {
            ...
            // Inline SVG content
            builder.AddMarkupContent(13, @"<rect width=""14"" height=""20"" x=""5"" y=""2"" rx=""2"" /> <path d=""M15 14h.01"" /> <path d=""M9 6h6"" /> <path d=""M9 10h6"" />");
