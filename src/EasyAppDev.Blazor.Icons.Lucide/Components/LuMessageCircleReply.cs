...
{
    /// <summary>
    /// LuMessageCircleReply icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class LuMessageCircleReply : ComponentBase
    {
        /// <summary>
        ...
        protected override void BuildRenderTree(RenderTreeBuilder builder)
        {
            ...
            // Inline SVG content
            builder.AddMarkupContent(13, @"<path d=""M7.9 20A9 9 0 1 0 4 16.1L2 22Z"" /> <path d=""m10 15-3-3 3-3"" /> <path d=""M7 12h7a2 2 0 0 1 2 2v1"" />");
