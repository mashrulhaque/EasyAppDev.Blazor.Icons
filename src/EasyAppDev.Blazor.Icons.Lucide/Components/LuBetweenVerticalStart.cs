...
{
    /// <summary>
    /// LuBetweenVerticalStart icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class LuBetweenVerticalStart : ComponentBase
    {
        /// <summary>
        ...
        protected override void BuildRenderTree(RenderTreeBuilder builder)
        {
            ...
            // Inline SVG content
            builder.AddMarkupContent(13, @"<rect width=""7"" height=""13"" x=""3"" y=""8"" rx=""1"" /> <path d=""m15 2-3 3-3-3"" /> <rect width=""7"" height=""13"" x=""14"" y=""8"" rx=""1"" />");
