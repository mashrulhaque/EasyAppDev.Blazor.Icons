...
{
    /// <summary>
    /// LuBriefcase icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class LuBriefcase : ComponentBase
    {
        /// <summary>
        ...
        protected override void BuildRenderTree(RenderTreeBuilder builder)
        {
            ...
            // Inline SVG content
            builder.AddMarkupContent(13, @"<path d=""M16 20V4a2 2 0 0 0-2-2h-4a2 2 0 0 0-2 2v16"" /> <rect width=""20"" height=""14"" x=""2"" y=""6"" rx=""2"" />");
