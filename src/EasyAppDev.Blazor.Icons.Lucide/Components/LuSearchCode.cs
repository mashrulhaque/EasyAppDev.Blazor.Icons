...
{
    /// <summary>
    /// LuSearchCode icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class LuSearchCode : ComponentBase
    {
        /// <summary>
        ...
        protected override void BuildRenderTree(RenderTreeBuilder builder)
        {
            ...
            // Inline SVG content
            builder.AddMarkupContent(13, @"<path d=""m13 13.5 2-2.5-2-2.5"" /> <path d=""m21 21-4.3-4.3"" /> <path d=""M9 8.5 7 11l2 2.5"" /> <circle cx=""11"" cy=""11"" r=""8"" />");
