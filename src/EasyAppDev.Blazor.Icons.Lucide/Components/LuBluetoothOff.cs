...
{
    /// <summary>
    /// LuBluetoothOff icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class LuBluetoothOff : ComponentBase
    {
        /// <summary>
        ...
        protected override void BuildRenderTree(RenderTreeBuilder builder)
        {
            ...
            // Inline SVG content
            builder.AddMarkupContent(13, @"<path d=""m17 17-5 5V12l-5 5"" /> <path d=""m2 2 20 20"" /> <path d=""M14.5 9.5 17 7l-5-5v4.5"" />");
