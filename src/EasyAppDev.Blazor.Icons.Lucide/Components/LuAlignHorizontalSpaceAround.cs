...
{
    /// <summary>
    /// LuAlignHorizontalSpaceAround icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class LuAlignHorizontalSpaceAround : ComponentBase
    {
        /// <summary>
        ...
        protected override void BuildRenderTree(RenderTreeBuilder builder)
        {
            ...
            // Inline SVG content
            builder.AddMarkupContent(13, @"<rect width=""6"" height=""10"" x=""9"" y=""7"" rx=""2"" /> <path d=""M4 22V2"" /> <path d=""M20 22V2"" />");
