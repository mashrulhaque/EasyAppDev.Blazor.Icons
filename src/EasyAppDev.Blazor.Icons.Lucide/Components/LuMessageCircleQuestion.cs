...
{
    /// <summary>
    /// LuMessageCircleQuestion icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class LuMessageCircleQuestion : ComponentBase
    {
        /// <summary>
        ...
        protected override void BuildRenderTree(RenderTreeBuilder builder)
        {
            ...
            // Inline SVG content
            builder.AddMarkupContent(13, @"<path d=""M7.9 20A9 9 0 1 0 4 16.1L2 22Z"" /> <path d=""M9.09 9a3 3 0 0 1 5.83 1c0 2-3 3-3 3"" /> <path d=""M12 17h.01"" />");
