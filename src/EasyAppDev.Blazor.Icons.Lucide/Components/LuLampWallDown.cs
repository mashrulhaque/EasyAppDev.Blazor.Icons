...
{
    /// <summary>
    /// LuLampWallDown icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class LuLampWallDown : ComponentBase
    {
        /// <summary>
        ...
        protected override void BuildRenderTree(RenderTreeBuilder builder)
        {
            ...
            // Inline SVG content
            builder.AddMarkupContent(13, @"<path d=""M11 13h6l3 7H8l3-7Z"" /> <path d=""M14 13V8a2 2 0 0 0-2-2H8"" /> <path d=""M4 9h2a2 2 0 0 0 2-2V5a2 2 0 0 0-2-2H4v6Z"" />");
