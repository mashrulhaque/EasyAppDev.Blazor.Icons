...
{
    /// <summary>
    /// LuLampDesk icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class LuLampDesk : ComponentBase
    {
        /// <summary>
        ...
        protected override void BuildRenderTree(RenderTreeBuilder builder)
        {
            ...
            // Inline SVG content
            builder.AddMarkupContent(13, @"<path d=""m14 5-3 3 2 7 8-8-7-2Z"" /> <path d=""m14 5-3 3-3-3 3-3 3 3Z"" /> <path d=""M9.5 6.5 4 12l3 6"" /> <path d=""M3 22v-2c0-1.1.9-2 2-2h4a2 2 0 0 1 2 2v2H3Z"" />");
