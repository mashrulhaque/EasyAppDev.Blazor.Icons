...
{
    /// <summary>
    /// LuArrowRightLeft icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class LuArrowRightLeft : ComponentBase
    {
        /// <summary>
        ...
        protected override void BuildRenderTree(RenderTreeBuilder builder)
        {
            ...
            // Inline SVG content
            builder.AddMarkupContent(13, @"<path d=""m16 3 4 4-4 4"" /> <path d=""M20 7H4"" /> <path d=""m8 21-4-4 4-4"" /> <path d=""M4 17h16"" />");
