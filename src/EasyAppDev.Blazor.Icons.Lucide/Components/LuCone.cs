...
{
    /// <summary>
    /// LuCone icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class LuCone : ComponentBase
    {
        /// <summary>
        ...
        protected override void BuildRenderTree(RenderTreeBuilder builder)
        {
            ...
            // Inline SVG content
            builder.AddMarkupContent(13, @"<path d=""m20.9 18.55-8-15.98a1 1 0 0 0-1.8 0l-8 15.98"" /> <ellipse cx=""12"" cy=""19"" rx=""9"" ry=""3"" />");
