...
{
    /// <summary>
    /// LuTableOfContents icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class LuTableOfContents : ComponentBase
    {
        /// <summary>
        ...
        protected override void BuildRenderTree(RenderTreeBuilder builder)
        {
            ...
            // Inline SVG content
            builder.AddMarkupContent(13, @"<path d=""M16 12H3"" /> <path d=""M16 18H3"" /> <path d=""M16 6H3"" /> <path d=""M21 12h.01"" /> <path d=""M21 18h.01"" /> <path d=""M21 6h.01"" />");
