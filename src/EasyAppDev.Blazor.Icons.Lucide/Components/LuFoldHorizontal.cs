...
{
    /// <summary>
    /// LuFoldHorizontal icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class LuFoldHorizontal : ComponentBase
    {
        /// <summary>
        ...
        protected override void BuildRenderTree(RenderTreeBuilder builder)
        {
            ...
            // Inline SVG content
            builder.AddMarkupContent(13, @"<path d=""M2 12h6"" /> <path d=""M22 12h-6"" /> <path d=""M12 2v2"" /> <path d=""M12 8v2"" /> <path d=""M12 14v2"" /> <path d=""M12 20v2"" /> <path d=""m19 9-3 3 3 3"" /> <path d=""m5 15 3-3-3-3"" />");
