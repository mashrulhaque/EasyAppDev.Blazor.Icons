...
{
    /// <summary>
    /// LuGalleryVertical icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class LuGalleryVertical : ComponentBase
    {
        /// <summary>
        ...
        protected override void BuildRenderTree(RenderTreeBuilder builder)
        {
            ...
            // Inline SVG content
            builder.AddMarkupContent(13, @"<path d=""M3 2h18"" /> <rect width=""18"" height=""12"" x=""3"" y=""6"" rx=""2"" /> <path d=""M3 22h18"" />");
