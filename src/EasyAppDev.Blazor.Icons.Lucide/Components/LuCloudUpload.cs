...
{
    /// <summary>
    /// LuCloudUpload icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class LuCloudUpload : ComponentBase
    {
        /// <summary>
        ...
        protected override void BuildRenderTree(RenderTreeBuilder builder)
        {
            ...
            // Inline SVG content
            builder.AddMarkupContent(13, @"<path d=""M12 13v8"" /> <path d=""M4 14.899A7 7 0 1 1 15.71 8h1.79a4.5 4.5 0 0 1 2.5 8.242"" /> <path d=""m8 17 4-4 4 4"" />");
