...
{
    /// <summary>
    /// LuBookmarkX icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class LuBookmarkX : ComponentBase
    {
        /// <summary>
        ...
        protected override void BuildRenderTree(RenderTreeBuilder builder)
        {
            ...
            // Inline SVG content
            builder.AddMarkupContent(13, @"<path d=""m19 21-7-4-7 4V5a2 2 0 0 1 2-2h10a2 2 0 0 1 2 2Z"" /> <path d=""m14.5 7.5-5 5"" /> <path d=""m9.5 7.5 5 5"" />");
