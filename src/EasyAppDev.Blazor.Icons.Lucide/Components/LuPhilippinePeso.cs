...
{
    /// <summary>
    /// LuPhilippinePeso icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class LuPhilippinePeso : ComponentBase
    {
        /// <summary>
        ...
        protected override void BuildRenderTree(RenderTreeBuilder builder)
        {
            ...
            // Inline SVG content
            builder.AddMarkupContent(13, @"<path d=""M20 11H4"" /> <path d=""M20 7H4"" /> <path d=""M7 21V4a1 1 0 0 1 1-1h4a1 1 0 0 1 0 12H7"" />");
