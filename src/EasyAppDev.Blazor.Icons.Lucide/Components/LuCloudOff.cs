...
{
    /// <summary>
    /// LuCloudOff icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class LuCloudOff : ComponentBase
    {
        /// <summary>
        ...
        protected override void BuildRenderTree(RenderTreeBuilder builder)
        {
            ...
            // Inline SVG content
            builder.AddMarkupContent(13, @"<path d=""m2 2 20 20"" /> <path d=""M5.782 5.782A7 7 0 0 0 9 19h8.5a4.5 4.5 0 0 0 1.307-.193"" /> <path d=""M21.532 16.5A4.5 4.5 0 0 0 17.5 10h-1.79A7.008 7.008 0 0 0 10 5.07"" />");
