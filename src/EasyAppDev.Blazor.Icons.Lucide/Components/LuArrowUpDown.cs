...
{
    /// <summary>
    /// LuArrowUpDown icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class LuArrowUpDown : ComponentBase
    {
        /// <summary>
        ...
        protected override void BuildRenderTree(RenderTreeBuilder builder)
        {
            ...
            // Inline SVG content
            builder.AddMarkupContent(13, @"<path d=""m21 16-4 4-4-4"" /> <path d=""M17 20V4"" /> <path d=""m3 8 4-4 4 4"" /> <path d=""M7 4v16"" />");
