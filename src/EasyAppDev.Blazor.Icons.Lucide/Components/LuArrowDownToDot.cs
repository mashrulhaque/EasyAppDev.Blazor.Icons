...
{
    /// <summary>
    /// LuArrowDownToDot icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class LuArrowDownToDot : ComponentBase
    {
        /// <summary>
        ...
        protected override void BuildRenderTree(RenderTreeBuilder builder)
        {
            ...
            // Inline SVG content
            builder.AddMarkupContent(13, @"<path d=""M12 2v14"" /> <path d=""m19 9-7 7-7-7"" /> <circle cx=""12"" cy=""21"" r=""1"" />");
