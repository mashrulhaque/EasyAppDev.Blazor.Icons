...
{
    /// <summary>
    /// LuRectangleEllipsis icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class LuRectangleEllipsis : ComponentBase
    {
        /// <summary>
        ...
        protected override void BuildRenderTree(RenderTreeBuilder builder)
        {
            ...
            // Inline SVG content
            builder.AddMarkupContent(13, @"<rect width=""20"" height=""12"" x=""2"" y=""6"" rx=""2"" /> <path d=""M12 12h.01"" /> <path d=""M17 12h.01"" /> <path d=""M7 12h.01"" />");
