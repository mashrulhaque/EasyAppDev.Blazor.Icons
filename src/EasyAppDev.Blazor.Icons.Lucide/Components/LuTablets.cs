...
{
    /// <summary>
    /// LuTablets icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class LuTablets : ComponentBase
    {
        /// <summary>
        ...
        protected override void BuildRenderTree(RenderTreeBuilder builder)
        {
            ...
            // Inline SVG content
            builder.AddMarkupContent(13, @"<circle cx=""7"" cy=""7"" r=""5"" /> <circle cx=""17"" cy=""17"" r=""5"" /> <path d=""M12 17h10"" /> <path d=""m3.46 10.54 7.08-7.08"" />");
