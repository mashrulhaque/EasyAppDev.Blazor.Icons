...
{
    /// <summary>
    /// LuSettings2 icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class LuSettings2 : ComponentBase
    {
        /// <summary>
        ...
        protected override void BuildRenderTree(RenderTreeBuilder builder)
        {
            ...
            // Inline SVG content
            builder.AddMarkupContent(13, @"<path d=""M20 7h-9"" /> <path d=""M14 17H5"" /> <circle cx=""17"" cy=""17"" r=""3"" /> <circle cx=""7"" cy=""7"" r=""3"" />");
