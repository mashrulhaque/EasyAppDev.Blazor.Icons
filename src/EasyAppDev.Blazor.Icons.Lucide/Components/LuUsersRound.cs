...
{
    /// <summary>
    /// LuUsersRound icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class LuUsersRound : ComponentBase
    {
        /// <summary>
        ...
        protected override void BuildRenderTree(RenderTreeBuilder builder)
        {
            ...
            // Inline SVG content
            builder.AddMarkupContent(13, @"<path d=""M18 21a8 8 0 0 0-16 0"" /> <circle cx=""10"" cy=""8"" r=""5"" /> <path d=""M22 20c0-3.37-2-6.5-4-8a5 5 0 0 0-.45-8.3"" />");
