...
{
    /// <summary>
    /// LuCaseSensitive icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class LuCaseSensitive : ComponentBase
    {
        /// <summary>
        ...
        protected override void BuildRenderTree(RenderTreeBuilder builder)
        {
            ...
            // Inline SVG content
            builder.AddMarkupContent(13, @"<path d=""m3 15 4-8 4 8"" /> <path d=""M4 13h6"" /> <circle cx=""18"" cy=""12"" r=""3"" /> <path d=""M21 9v6"" />");
