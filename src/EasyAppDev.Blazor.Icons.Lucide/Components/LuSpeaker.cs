...
{
    /// <summary>
    /// LuSpeaker icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class LuSpeaker : ComponentBase
    {
        /// <summary>
        ...
        protected override void BuildRenderTree(RenderTreeBuilder builder)
        {
            ...
            // Inline SVG content
            builder.AddMarkupContent(13, @"<rect width=""16"" height=""20"" x=""4"" y=""2"" rx=""2"" /> <path d=""M12 6h.01"" /> <circle cx=""12"" cy=""14"" r=""4"" /> <path d=""M12 14h.01"" />");
