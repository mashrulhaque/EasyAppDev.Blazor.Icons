...
{
    /// <summary>
    /// LuMessageSquareShare icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class LuMessageSquareShare : ComponentBase
    {
        /// <summary>
        ...
        protected override void BuildRenderTree(RenderTreeBuilder builder)
        {
            ...
            // Inline SVG content
            builder.AddMarkupContent(13, @"<path d=""M21 12v3a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h7"" /> <path d=""M16 3h5v5"" /> <path d=""m16 8 5-5"" />");
