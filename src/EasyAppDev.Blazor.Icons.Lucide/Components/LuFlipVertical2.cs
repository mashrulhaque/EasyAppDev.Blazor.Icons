...
{
    /// <summary>
    /// LuFlipVertical2 icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class LuFlipVertical2 : ComponentBase
    {
        /// <summary>
        ...
        protected override void BuildRenderTree(RenderTreeBuilder builder)
        {
            ...
            // Inline SVG content
            builder.AddMarkupContent(13, @"<path d=""m17 3-5 5-5-5h10"" /> <path d=""m17 21-5-5-5 5h10"" /> <path d=""M4 12H2"" /> <path d=""M10 12H8"" /> <path d=""M16 12h-2"" /> <path d=""M22 12h-2"" />");
