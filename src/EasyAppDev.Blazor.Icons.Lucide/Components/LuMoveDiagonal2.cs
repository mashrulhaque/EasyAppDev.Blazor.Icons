...
{
    /// <summary>
    /// LuMoveDiagonal2 icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class LuMoveDiagonal2 : ComponentBase
    {
        /// <summary>
        ...
        protected override void BuildRenderTree(RenderTreeBuilder builder)
        {
            ...
            // Inline SVG content
            builder.AddMarkupContent(13, @"<path d=""M19 13v6h-6"" /> <path d=""M5 11V5h6"" /> <path d=""m5 5 14 14"" />");
