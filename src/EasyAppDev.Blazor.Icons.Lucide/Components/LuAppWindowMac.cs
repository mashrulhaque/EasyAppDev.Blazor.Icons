...
{
    /// <summary>
    /// LuAppWindowMac icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class LuAppWindowMac : ComponentBase
    {
        /// <summary>
        ...
        protected override void BuildRenderTree(RenderTreeBuilder builder)
        {
            ...
            // Inline SVG content
            builder.AddMarkupContent(13, @"<rect width=""20"" height=""16"" x=""2"" y=""4"" rx=""2"" /> <path d=""M6 8h.01"" /> <path d=""M10 8h.01"" /> <path d=""M14 8h.01"" />");
