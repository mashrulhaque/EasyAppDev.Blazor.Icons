...
{
    /// <summary>
    /// LuUserRoundCheck icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class LuUserRoundCheck : ComponentBase
    {
        /// <summary>
        ...
        protected override void BuildRenderTree(RenderTreeBuilder builder)
        {
            ...
            // Inline SVG content
            builder.AddMarkupContent(13, @"<path d=""M2 21a8 8 0 0 1 13.292-6"" /> <circle cx=""10"" cy=""8"" r=""5"" /> <path d=""m16 19 2 2 4-4"" />");
