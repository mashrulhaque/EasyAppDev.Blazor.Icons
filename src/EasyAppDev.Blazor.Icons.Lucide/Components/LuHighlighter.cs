...
{
    /// <summary>
    /// LuHighlighter icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class LuHighlighter : ComponentBase
    {
        /// <summary>
        ...
        protected override void BuildRenderTree(RenderTreeBuilder builder)
        {
            ...
            // Inline SVG content
            builder.AddMarkupContent(13, @"<path d=""m9 11-6 6v3h9l3-3"" /> <path d=""m22 12-4.6 4.6a2 2 0 0 1-2.8 0l-5.2-5.2a2 2 0 0 1 0-2.8L14 4"" />");
