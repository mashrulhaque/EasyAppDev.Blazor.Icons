...
{
    /// <summary>
    /// LuTorus icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class LuTorus : ComponentBase
    {
        /// <summary>
        ...
        protected override void BuildRenderTree(RenderTreeBuilder builder)
        {
            ...
            // Inline SVG content
            builder.AddMarkupContent(13, @"<ellipse cx=""12"" cy=""11"" rx=""3"" ry=""2"" /> <ellipse cx=""12"" cy=""12.5"" rx=""10"" ry=""8.5"" />");
