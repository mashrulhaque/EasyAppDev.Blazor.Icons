...
{
    /// <summary>
    /// LuFlipHorizontal2 icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class LuFlipHorizontal2 : ComponentBase
    {
        /// <summary>
        ...
        protected override void BuildRenderTree(RenderTreeBuilder builder)
        {
            ...
            // Inline SVG content
            builder.AddMarkupContent(13, @"<path d=""m3 7 5 5-5 5V7"" /> <path d=""m21 7-5 5 5 5V7"" /> <path d=""M12 20v2"" /> <path d=""M12 14v2"" /> <path d=""M12 8v2"" /> <path d=""M12 2v2"" />");
