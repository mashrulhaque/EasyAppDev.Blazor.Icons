...
{
    /// <summary>
    /// LuLaptopMinimalCheck icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class LuLaptopMinimalCheck : ComponentBase
    {
        /// <summary>
        ...
        protected override void BuildRenderTree(RenderTreeBuilder builder)
        {
            ...
            // Inline SVG content
            builder.AddMarkupContent(13, @"<path d=""M2 20h20"" /> <path d=""m9 10 2 2 4-4"" /> <rect x=""3"" y=""4"" width=""18"" height=""12"" rx=""2"" />");
