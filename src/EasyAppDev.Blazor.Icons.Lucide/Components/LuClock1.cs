...
{
    /// <summary>
    /// LuClock1 icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class LuClock1 : ComponentBase
    {
        /// <summary>
        ...
        protected override void BuildRenderTree(RenderTreeBuilder builder)
        {
            ...
            // Inline SVG content
            builder.AddMarkupContent(13, @"<circle cx=""12"" cy=""12"" r=""10"" /> <polyline points=""12 6 12 12 14.5 8"" />");
