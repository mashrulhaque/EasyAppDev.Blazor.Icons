...
{
    /// <summary>
    /// LuChevronsDownUp icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class LuChevronsDownUp : ComponentBase
    {
        /// <summary>
        ...
        protected override void BuildRenderTree(RenderTreeBuilder builder)
        {
            ...
            // Inline SVG content
            builder.AddMarkupContent(13, @"<path d=""m7 20 5-5 5 5"" /> <path d=""m7 4 5 5 5-5"" />");
