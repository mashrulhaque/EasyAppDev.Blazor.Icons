...
{
    /// <summary>
    /// LuScale3d icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class LuScale3d : ComponentBase
    {
        /// <summary>
        ...
        protected override void BuildRenderTree(RenderTreeBuilder builder)
        {
            ...
            // Inline SVG content
            builder.AddMarkupContent(13, @"<circle cx=""19"" cy=""19"" r=""2"" /> <circle cx=""5"" cy=""5"" r=""2"" /> <path d=""M5 7v12h12"" /> <path d=""m5 19 6-6"" />");
