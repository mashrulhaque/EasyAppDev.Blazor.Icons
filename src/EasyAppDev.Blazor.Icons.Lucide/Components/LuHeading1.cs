...
{
    /// <summary>
    /// LuHeading1 icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class LuHeading1 : ComponentBase
    {
        /// <summary>
        ...
        protected override void BuildRenderTree(RenderTreeBuilder builder)
        {
            ...
            // Inline SVG content
            builder.AddMarkupContent(13, @"<path d=""M4 12h8"" /> <path d=""M4 18V6"" /> <path d=""M12 18V6"" /> <path d=""m17 12 3-2v8"" />");
