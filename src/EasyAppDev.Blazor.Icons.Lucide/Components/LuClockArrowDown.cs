...
{
    /// <summary>
    /// LuClockArrowDown icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class LuClockArrowDown : ComponentBase
    {
        /// <summary>
        ...
        protected override void BuildRenderTree(RenderTreeBuilder builder)
        {
            ...
            // Inline SVG content
            builder.AddMarkupContent(13, @"<path d=""M12.338 21.994A10 10 0 1 1 21.925 13.227"" /> <path d=""M12 6v6l2 1"" /> <path d=""m14 18 4 4 4-4"" /> <path d=""M18 14v8"" />");
