...
{
    /// <summary>
    /// LuWindArrowDown icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class LuWindArrowDown : ComponentBase
    {
        /// <summary>
        ...
        protected override void BuildRenderTree(RenderTreeBuilder builder)
        {
            ...
            // Inline SVG content
            builder.AddMarkupContent(13, @"<path d=""M10 2v8"" /> <path d=""M12.8 21.6A2 2 0 1 0 14 18H2"" /> <path d=""M17.5 10a2.5 2.5 0 1 1 2 4H2"" /> <path d=""m6 6 4 4 4-4"" />");
