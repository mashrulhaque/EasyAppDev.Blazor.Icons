...
{
    /// <summary>
    /// LuReplyAll icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class LuReplyAll : ComponentBase
    {
        /// <summary>
        ...
        protected override void BuildRenderTree(RenderTreeBuilder builder)
        {
            ...
            // Inline SVG content
            builder.AddMarkupContent(13, @"<polyline points=""7 17 2 12 7 7"" /> <polyline points=""12 17 7 12 12 7"" /> <path d=""M22 18v-2a4 4 0 0 0-4-4H7"" />");
