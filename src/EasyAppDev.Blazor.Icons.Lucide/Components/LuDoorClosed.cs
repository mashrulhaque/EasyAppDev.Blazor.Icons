...
{
    /// <summary>
    /// LuDoorClosed icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class LuDoorClosed : ComponentBase
    {
        /// <summary>
        ...
        protected override void BuildRenderTree(RenderTreeBuilder builder)
        {
            ...
            // Inline SVG content
            builder.AddMarkupContent(13, @"<path d=""M18 20V6a2 2 0 0 0-2-2H8a2 2 0 0 0-2 2v14"" /> <path d=""M2 20h20"" /> <path d=""M14 12v.01"" />");
