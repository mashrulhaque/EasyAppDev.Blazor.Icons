...
{
    /// <summary>
    /// LuWaypoints icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class LuWaypoints : ComponentBase
    {
        /// <summary>
        ...
        protected override void BuildRenderTree(RenderTreeBuilder builder)
        {
            ...
            // Inline SVG content
            builder.AddMarkupContent(13, @"<circle cx=""12"" cy=""4.5"" r=""2.5"" /> <path d=""m10.2 6.3-3.9 3.9"" /> <circle cx=""4.5"" cy=""12"" r=""2.5"" /> <path d=""M7 12h10"" /> <circle cx=""19.5"" cy=""12"" r=""2.5"" /> <path d=""m13.8 17.7 3.9-3.9"" /> <circle cx=""12"" cy=""19.5"" r=""2.5"" />");
