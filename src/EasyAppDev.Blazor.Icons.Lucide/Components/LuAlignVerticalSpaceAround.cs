...
{
    /// <summary>
    /// LuAlignVerticalSpaceAround icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class LuAlignVerticalSpaceAround : ComponentBase
    {
        /// <summary>
        ...
        protected override void BuildRenderTree(RenderTreeBuilder builder)
        {
            ...
            // Inline SVG content
            builder.AddMarkupContent(13, @"<rect width=""10"" height=""6"" x=""7"" y=""9"" rx=""2"" /> <path d=""M22 20H2"" /> <path d=""M22 4H2"" />");
