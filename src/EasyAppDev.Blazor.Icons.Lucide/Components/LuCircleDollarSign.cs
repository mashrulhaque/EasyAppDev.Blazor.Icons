...
{
    /// <summary>
    /// LuCircleDollarSign icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class LuCircleDollarSign : ComponentBase
    {
        /// <summary>
        ...
        protected override void BuildRenderTree(RenderTreeBuilder builder)
        {
            ...
            // Inline SVG content
            builder.AddMarkupContent(13, @"<circle cx=""12"" cy=""12"" r=""10"" /> <path d=""M16 8h-6a2 2 0 1 0 0 4h4a2 2 0 1 1 0 4H8"" /> <path d=""M12 18V6"" />");
