...
{
    /// <summary>
    /// LuHeading2 icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class LuHeading2 : ComponentBase
    {
        /// <summary>
        ...
        protected override void BuildRenderTree(RenderTreeBuilder builder)
        {
            ...
            // Inline SVG content
            builder.AddMarkupContent(13, @"<path d=""M4 12h8"" /> <path d=""M4 18V6"" /> <path d=""M12 18V6"" /> <path d=""M21 18h-4c0-4 4-3 4-6 0-1.5-2-2.5-4-1"" />");
