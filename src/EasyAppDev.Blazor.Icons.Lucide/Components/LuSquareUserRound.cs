...
{
    /// <summary>
    /// LuSquareUserRound icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class LuSquareUserRound : ComponentBase
    {
        /// <summary>
        ...
        protected override void BuildRenderTree(RenderTreeBuilder builder)
        {
            ...
            // Inline SVG content
            builder.AddMarkupContent(13, @"<path d=""M18 21a6 6 0 0 0-12 0"" /> <circle cx=""12"" cy=""11"" r=""4"" /> <rect width=""18"" height=""18"" x=""3"" y=""3"" rx=""2"" />");
