...
{
    /// <summary>
    /// LuUserRoundX icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class LuUserRoundX : ComponentBase
    {
        /// <summary>
        ...
        protected override void BuildRenderTree(RenderTreeBuilder builder)
        {
            ...
            // Inline SVG content
            builder.AddMarkupContent(13, @"<path d=""M2 21a8 8 0 0 1 11.873-7"" /> <circle cx=""10"" cy=""8"" r=""5"" /> <path d=""m17 17 5 5"" /> <path d=""m22 17-5 5"" />");
