...
{
    /// <summary>
    /// LuSquareRadical icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class LuSquareRadical : ComponentBase
    {
        /// <summary>
        ...
        protected override void BuildRenderTree(RenderTreeBuilder builder)
        {
            ...
            // Inline SVG content
            builder.AddMarkupContent(13, @"<path d=""M7 12h2l2 5 2-10h4"" /> <rect x=""3"" y=""3"" width=""18"" height=""18"" rx=""2"" />");
