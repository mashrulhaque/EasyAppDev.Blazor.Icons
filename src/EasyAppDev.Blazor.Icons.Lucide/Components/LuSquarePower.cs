...
{
    /// <summary>
    /// LuSquarePower icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class LuSquarePower : ComponentBase
    {
        /// <summary>
        ...
        protected override void BuildRenderTree(RenderTreeBuilder builder)
        {
            ...
            // Inline SVG content
            builder.AddMarkupContent(13, @"<path d=""M12 7v4"" /> <path d=""M7.998 9.003a5 5 0 1 0 8-.005"" /> <rect x=""3"" y=""3"" width=""18"" height=""18"" rx=""2"" />");
