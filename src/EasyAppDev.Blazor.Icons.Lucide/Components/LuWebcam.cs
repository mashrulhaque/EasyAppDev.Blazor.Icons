...
{
    /// <summary>
    /// LuWebcam icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class LuWebcam : ComponentBase
    {
        /// <summary>
        ...
        protected override void BuildRenderTree(RenderTreeBuilder builder)
        {
            ...
            // Inline SVG content
            builder.AddMarkupContent(13, @"<circle cx=""12"" cy=""10"" r=""8"" /> <circle cx=""12"" cy=""10"" r=""3"" /> <path d=""M7 22h10"" /> <path d=""M12 22v-4"" />");
