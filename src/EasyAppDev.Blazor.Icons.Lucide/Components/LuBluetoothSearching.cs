...
{
    /// <summary>
    /// LuBluetoothSearching icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class LuBluetoothSearching : ComponentBase
    {
        /// <summary>
        ...
        protected override void BuildRenderTree(RenderTreeBuilder builder)
        {
            ...
            // Inline SVG content
            builder.AddMarkupContent(13, @"<path d=""m7 7 10 10-5 5V2l5 5L7 17"" /> <path d=""M20.83 14.83a4 4 0 0 0 0-5.66"" /> <path d=""M18 12h.01"" />");
