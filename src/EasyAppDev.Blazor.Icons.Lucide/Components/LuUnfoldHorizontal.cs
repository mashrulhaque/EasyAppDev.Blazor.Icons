...
{
    /// <summary>
    /// LuUnfoldHorizontal icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class LuUnfoldHorizontal : ComponentBase
    {
        /// <summary>
        ...
        protected override void BuildRenderTree(RenderTreeBuilder builder)
        {
            ...
            // Inline SVG content
            builder.AddMarkupContent(13, @"<path d=""M16 12h6"" /> <path d=""M8 12H2"" /> <path d=""M12 2v2"" /> <path d=""M12 8v2"" /> <path d=""M12 14v2"" /> <path d=""M12 20v2"" /> <path d=""m19 15 3-3-3-3"" /> <path d=""m5 9-3 3 3 3"" />");
