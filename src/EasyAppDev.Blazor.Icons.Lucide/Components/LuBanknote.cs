...
{
    /// <summary>
    /// LuBanknote icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class LuBanknote : ComponentBase
    {
        /// <summary>
        ...
        protected override void BuildRenderTree(RenderTreeBuilder builder)
        {
            ...
            // Inline SVG content
            builder.AddMarkupContent(13, @"<rect width=""20"" height=""12"" x=""2"" y=""6"" rx=""2"" /> <circle cx=""12"" cy=""12"" r=""2"" /> <path d=""M6 12h.01M18 12h.01"" />");
