...
{
    /// <summary>
    /// LuDatabase icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class LuDatabase : ComponentBase
    {
        /// <summary>
        ...
        protected override void BuildRenderTree(RenderTreeBuilder builder)
        {
            ...
            // Inline SVG content
            builder.AddMarkupContent(13, @"<ellipse cx=""12"" cy=""5"" rx=""9"" ry=""3"" /> <path d=""M3 5V19A9 3 0 0 0 21 19V5"" /> <path d=""M3 12A9 3 0 0 0 21 12"" />");
