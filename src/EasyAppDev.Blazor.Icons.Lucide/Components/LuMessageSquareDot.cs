...
{
    /// <summary>
    /// LuMessageSquareDot icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class LuMessageSquareDot : ComponentBase
    {
        /// <summary>
        ...
        protected override void BuildRenderTree(RenderTreeBuilder builder)
        {
            ...
            // Inline SVG content
            builder.AddMarkupContent(13, @"<path d=""M11.7 3H5a2 2 0 0 0-2 2v16l4-4h12a2 2 0 0 0 2-2v-2.7"" /> <circle cx=""18"" cy=""6"" r=""3"" />");
