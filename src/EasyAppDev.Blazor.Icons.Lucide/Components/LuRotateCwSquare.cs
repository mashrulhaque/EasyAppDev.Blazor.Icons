...
{
    /// <summary>
    /// LuRotateCwSquare icon from icon library.
    /// This component is fully embedded and trimmable.
    /// </summary>
    public sealed class LuRotateCwSquare : ComponentBase
    {
        /// <summary>
        ...
        protected override void BuildRenderTree(RenderTreeBuilder builder)
        {
            ...
            // Inline SVG content
            builder.AddMarkupContent(13, @"<path d=""M12 5H6a2 2 0 0 0-2 2v3"" /> <path d=""m9 8 3-3-3-3"" /> <path d=""M4 14v4a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V7a2 2 0 0 0-2-2h-2"" />");
